...
return i}({1:[function(t,e,n){var r=t("levelup"),i=t("localstorage-down"),o=function(t){return new i(t)}
e.exports={clearCache:function(){var t=r("noddity-content",{db:o})
t.createKeyStream().on("data",function(e){t.del(e)})}}},{levelup:26,"localstorage-down":50}],2:[function(t,e,n){{var r=t("noddity-butler"),i=t("levelup"),o=t("noddity-linkifier"),s=t("localstorage-down"),a=t("./routing"),u=t("./mainViewModel"),c=t("level-sublevel"),h=noddityConfig,f=function(t){return new s(t)},l=c(i("noddity-content-2",{db:f})),p=h.title.replace(/[^\w]+/g,""),d=h.debug?{refreshEvery:3e4}:{cacheCheckIntervalMs:6e4},g=new r(h.noddityRoot,l.sublevel(p),d),v=new o(h.pathPrefix+h.pagePathPrefix),m=a()
new u(g,v,m)}h.debug&&(window.debug=t("./debug"))},{"./debug":1,"./mainViewModel":3,"./routing":4,"level-sublevel":12,levelup:26,"localstorage-down":50,"noddity-butler":61,"noddity-linkifier":73}],3:[function(t,e,n){function r(){}var i=t("ractive"),o=noddityConfig,s=t("noddity-renderer")
e.exports=function(t,e,n){function a(t){console.log(t)}function u(){t.getPosts(function(t,e){t?a(t):v.set("postList",e.reverse().filter(function(t){return"string"==typeof t.metadata.title}).map(function(t){return{title:t.metadata.title,filename:t.filename}}))})}function c(e){t.getPost(e,function(t,r){t?(d.set("html",t.message),p.set("page",null),e!==o.errorPage&&n.emit("404")):(p.set("page",r.metadata.title),l?l(r):l=f.populateRootRactive(r,d),v.get("postList")||u())}),t.refreshPost(e)}function h(t,e,n){function r(n){return n.filename===t&&n.title!==e.metadata.title}var i=v.get("postList")
i&&i.some(r)&&u()}var f=new s(t,e.linkify),l=null,p=new i({el:"title",template:"{{title}}{{#page}} | {{page}}{{/page}}",data:{title:o.title}}),d=new i({el:"main",template:"#template-main",data:Object.create(o)}),g=o.sidebar?"{{{html}}}":"#template-menu",v=new i({el:"sidebar",template:g,data:Object.create(o)})
o.sidebar&&t.getPost(o.sidebar,function(t,e){t?v.set("html",t.message):f.populateRootRactive(e,v)}),e.on("link",function(e){t.getPost(e,r)}),t.on("post changed",h),t.on("index changed",u),n.on("current",c)}},{"noddity-renderer":74,ractive:84}],4:[function(t,e,n){var r=noddityConfig,i=t("events").EventEmitter,o=t("hash-brown-router")
e.exports=function(){var t=o(),e=new i
return e.on("404",function(){t.replace("!/"+r.pagePathPrefix+r.errorPage)}),e.on("current",function(){window.scrollTo(0,0)}),t.add("!/",function(){e.emit("current","index.md")}),t.add("!/"+r.pagePathPrefix+":name",function(t){e.emit("current",t.name)}),t.setDefault(function(t){e.emit("404",t)}),setTimeout(t.evaluateCurrent.bind(null,"!/"),0),e}},{events:90,"hash-brown-router":6}],5:[function(t,e,n){function r(t,e){t.location.replace(t.location.origin+t.location.pathname+"#"+e)}function i(t,e){t.location.hash=e}function o(t){return s(t.location.hash)}function s(t){return t&&"#"===t[0]?t.substr(1):t}var a=t("events").EventEmitter
e.exports=function(t){var e=new a,n=""
return t.addEventListener("hashchange",function(){n!==e.get()&&(n=e.get(),e.emit("hashchange"))}),e.go=i.bind(null,t),e.replace=r.bind(null,t),e.get=o.bind(null,t),e}},{events:90}],6:[function(t,e,n){function r(t,e){o(t,e.get())}function i(t){var e=t.split("?")
return{path:e.shift(),queryString:f.parse(e.join(""))}}function o(t,e){var n=i(e)
e=n.path
var r=n.queryString,o=t.find("".match,e)
if(o){var a=o.exec(e),u=s(o.keys,a),c=l(r,u)
o.fn(c)}else t.defaultFn&&t.defaultFn(e,r)}function s(t,e){return t.reduce(function(t,n,r){return t[n.name]=e[r+1],t},{})}function a(t,e,n){if("function"!=typeof n)throw new Error("The router add function must be passed a callback function")
var r=h(e)
r.fn=n,t.push(r)}function u(t,e,n){e.get()?r(t,e):e.go(n)}function c(t,e){t.defaultFn=e}var h=t("path-to-regexp-with-reversible-keys"),f=t("querystring"),l=t("xtend"),p=t("./hash-location.js")
t("array.prototype.find"),e.exports=function(t){function e(){t.removeListener("hashchange",i)}t||(t=p(window))
var n=[],i=r.bind(null,n,t)
return t.on("hashchange",i),{add:a.bind(null,n),stop:e,evaluateCurrent:u.bind(null,n,t),setDefault:c.bind(null,n),replace:t.replace,go:t.go}}},{"./hash-location.js":5,"array.prototype.find":7,"path-to-regexp-with-reversible-keys":8,querystring:100,xtend:10}],7:[function(t,e,n){!function(t){if(!Array.prototype.find){var e=function(t){var e=Object(this),n=e.length<0?0:e.length>>>0
...
return void 0}
if(Object.defineProperty)try{Object.defineProperty(Array.prototype,"find",{value:e,configurable:!0,enumerable:!1,writable:!0})}catch(n){}Array.prototype.find||(Array.prototype.find=e)}}(this)},{}],8:[function(t,e,n){function r(t){return t.replace(/([=!:$\/()])/g,"\\$1")}function i(t,e,n){return t.keys=e,t.allTokens=n,t}function o(t){return t.sensitive?"":"i"}function s(t,e,n){var r=t.source.match(/\((?!\?)/g)
if(r)for(var o=0;o<r.length;o++)e.push({name:o,delimiter:null,optional:!1,repeat:!1})
return i(t,e,n)}function a(t,e,n,r){for(var s=[],a=0;a<t.length;a++)s.push(c(t[a],e,n,r).source)
var u=new RegExp("(?:"+s.join("|")+")",o(n))
return i(u,e,r)}function u(t,e,n){function i(t){0===a&&"/"!==t[0]&&(t="/"+t),n.push({string:t})}function o(o,u,c,h,f,l,p,d,g){if(u)return u
if(d)return"\\"+d
var v="+"===p||"*"===p,m="?"===p||"*"===p
g>a&&i(t.substring(a,g)),a=g+o.length
var y={name:h||s++,delimiter:c||"/",optional:m,repeat:v}
return e.push(y),n.push(y),c=c?"\\"+c:"",f=r(f||l||"[^"+(c||"\\/")+"]+?"),v&&(f=f+"(?:"+c+f+")*"),m?"(?:"+c+"("+f+"))?":c+"("+f+")"}var s=0,a=0,u=t.replace(f,o)
return a<t.length&&i(t.substring(a)),u}function c(t,e,n,r){if(e=e||[],r=r||[],h(e)?n||(n={}):(n=e,e=[]),t instanceof RegExp)return s(t,e,n,r)
if(h(t))return a(t,e,n,r)
var c=n.strict,f=n.end!==!1,l=u(t,e,r),p="/"===t.charAt(t.length-1)
return c||(l=(p?l.slice(0,-2):l)+"(?:\\/(?=$))?"),l+=f?"$":c&&p?"":"(?=\\/|$)",i(new RegExp("^"+l,o(n)),e,r)}var h=t("isarray")
e.exports=c
var f=new RegExp(["(\\\\.)","([\\/.])?(?:\\:(\\w+)(?:\\(((?:\\\\.|[^)])*)\\))?|\\(((?:\\\\.|[^)])*)\\))([+*?])?","([.+*?=^!:${}()[\\]|\\/])"].join("|"),"g")},{isarray:9}],9:[function(t,e,n){e.exports=Array.isArray||function(t){return"[object Array]"==Object.prototype.toString.call(t)}},{}],10:[function(t,e,n){function r(){for(var t={},e=0;e<arguments.length;e++){var n=arguments[e]
for(var r in n)n.hasOwnProperty(r)&&(t[r]=n[r])}return t}e.exports=r},{}],11:[function(t,e,n){function r(t,e,n,r){var i={type:t,key:e,value:n,options:r}
return r&&r.prefix&&(i.prefix=r.prefix,delete r.prefix),this._operations.push(i),this}function i(t){this._operations=[],this._sdb=t,this.put=r.bind(this,"put"),this.del=r.bind(this,"del")}var o=i.prototype
o.clear=function(){this._operations=[]},o.write=function(t){this._sdb.batch(this._operations,t)},e.exports=i},{}],12:[function(t,e,n){(function(n){var r=(t("events").EventEmitter,n.nextTick,t("./sub")),i=t("./batch"),o=t("level-fix-range"),s=t("level-hooks")
...
var h=u.batch
return u.batch=function(t,e,n){return Array.isArray(t)?(t.forEach(function(t){t.prefix&&("function"==typeof t.prefix.prefix?t.key=t.prefix.prefix(t.key):"string"==typeof t.prefix&&(t.key=t.prefix+t.key))}),void h.call(u,t,e,n)):new i(u)},u}}).call(this,t("Kii323"))},{"./batch":11,"./sub":23,Kii323:96,events:90,"level-fix-range":13,"level-hooks":15}],13:[function(t,e,n){var r=t("clone")
e.exports=function(t){t=r(t)
var e=t.reverse,n=t.max||t.end,i=t.min||t.start,o=[i,n]
return null!=i&&null!=n&&o.sort(),e&&(o=o.reverse()),t.start=o[0],t.end=o[1],delete t.min,delete t.max,t}},{clone:14}],14:[function(t,e,n){(function(t){"use strict"
...
var e=function(){}
return e.prototype=t,new e}}).call(this,t("buffer").Buffer)},{buffer:86}],15:[function(t,e,n){var r=t("string-range")
e.exports=function(t){function e(t){return t&&("string"==typeof t?t:"string"==typeof t.prefix?t.prefix:"function"==typeof t.prefix?t.prefix():"")}function n(t){return t&&t._getKeyEncoding?t._getKeyEncoding(t):void 0}function i(t){return t&&t._getValueEncoding?t._getValueEncoding(t):void 0}function o(t,e){return function(){var n=t.indexOf(e)
return~n?(t.splice(n,1),!0):!1}}function s(t){t&&t.type&&u.forEach(function(e){e.test(t.key)&&e.hook(t)})}function a(r,o,s,a){try{o.forEach(function d(t,r){c.forEach(function(s){if(s.test(String(t.key))){var a={add:function(t,a){if("undefined"==typeof t)return this
if(t===!1)return delete o[r]
...
var c=t.keyEncoding||n(t.prefix),h=t.valueEncoding||i(t.prefix)
...
s.hook.call(a,t,a.add,o)}})})}catch(u){return(a||s)(u)}if(o=o.filter(function(t){return t&&t.type}),1==o.length&&!r){var p=o[0]
...
var n={test:r.checker(t),hook:e}
return u.push(n),o(u,n)},pre:function(t,e){e||(e=t,t="")
var n={test:r.checker(t),hook:e,safe:!1!==t.safe}
return c.push(n),o(c,n)},posthooks:u,prehooks:c},t.on("put",function(t,e){s({type:"put",key:t,value:e})}),t.on("del",function(t,e){s({type:"del",key:t,value:e})}),t.on("batch",function(t){t.forEach(s)})
...
n.satisfies=function(t,e){return i(e)(t)}}},{}],17:[function(t,e,n){function r(t){return null!==t&&("object"==typeof t||"function"==typeof t)}e.exports=r},{}],18:[function(t,e,n){function r(){for(var t={},e=0;e<arguments.length;e++){var n=arguments[e]
if(o(n))for(var r=i(n),s=0;s<r.length;s++){var a=r[s]
t[a]=n[a]}}return t}var i=t("object-keys"),o=t("./has-keys")
e.exports=r},{"./has-keys":17,"object-keys":19}],19:[function(t,e,n){e.exports=Object.keys||t("./shim")},{"./shim":22}],20:[function(t,e,n){var r=Object.prototype.hasOwnProperty,i=Object.prototype.toString
e.exports=function(t,e,n){if("[object Function]"!==i.call(e))throw new TypeError("iterator must be a function")
var o=t.length
if(o===+o)for(var s=0;o>s;s++)e.call(n,t[s],s,t)
else for(var a in t)r.call(t,a)&&e.call(n,t[a],a,t)}},{}],21:[function(t,e,n){var r=Object.prototype,i=r.hasOwnProperty,o=r.toString,s=function(t){return t!==t},a={"boolean":1,number:1,string:1,undefined:1},u=e.exports={}
u.a=u.type=function(t,e){return typeof t===e},u.defined=function(t){return void 0!==t},u.empty=function(t){var e,n=o.call(t)
if("[object Array]"===n||"[object Arguments]"===n)return 0===t.length
if("[object Object]"===n){for(e in t)if(i.call(t,e))return!1
return!0}return"[object String]"===n?""===t:!1},u.equal=function(t,e){var n,r=o.call(t)
if(r!==o.call(e))return!1
if("[object Object]"===r){for(n in t)if(!u.equal(t[n],e[n]))return!1
return!0}if("[object Array]"===r){if(n=t.length,n!==e.length)return!1
for(;--n;)if(!u.equal(t[n],e[n]))return!1
return!0}return"[object Function]"===r?t.prototype===e.prototype:"[object Date]"===r?t.getTime()===e.getTime():t===e},u.hosted=function(t,e){var n=typeof e[t]
return"object"===n?!!e[t]:!a[n]},u.instance=u["instanceof"]=function(t,e){return t instanceof e},u["null"]=function(t){return null===t},u.undefined=function(t){return void 0===t},u.arguments=function(t){var e="[object Arguments]"===o.call(t),n=!u.array(t)&&u.arraylike(t)&&u.object(t)&&u.fn(t.callee)
return e||n},u.array=function(t){return"[object Array]"===o.call(t)},u.arguments.empty=function(t){return u.arguments(t)&&0===t.length},u.array.empty=function(t){return u.array(t)&&0===t.length},u.arraylike=function(t){return!!t&&!u["boolean"](t)&&i.call(t,"length")&&isFinite(t.length)&&u.number(t.length)&&t.length>=0},u["boolean"]=function(t){return"[object Boolean]"===o.call(t)},u["false"]=function(t){return u["boolean"](t)&&(t===!1||t.valueOf()===!1)},u["true"]=function(t){return u["boolean"](t)&&(t===!0||t.valueOf()===!0)},u.date=function(t){return"[object Date]"===o.call(t)},u.element=function(t){return void 0!==t&&"undefined"!=typeof HTMLElement&&t instanceof HTMLElement&&1===t.nodeType},u.error=function(t){return"[object Error]"===o.call(t)},u.fn=u["function"]=function(t){var e="undefined"!=typeof window&&t===window.alert
return e||"[object Function]"===o.call(t)},u.number=function(t){return"[object Number]"===o.call(t)},u.infinite=function(t){return t===1/0||t===-(1/0)},u.decimal=function(t){return u.number(t)&&!s(t)&&!u.infinite(t)&&t%1!==0},u.divisibleBy=function(t,e){var n=u.infinite(t),r=u.infinite(e),i=u.number(t)&&!s(t)&&u.number(e)&&!s(e)&&0!==e
return n||r||i&&t%e===0},u["int"]=function(t){return u.number(t)&&!s(t)&&t%1===0},u.maximum=function(t,e){if(s(t))throw new TypeError("NaN is not a valid value")
if(!u.arraylike(e))throw new TypeError("second argument must be array-like")
for(var n=e.length;--n>=0;)if(t<e[n])return!1
return!0},u.minimum=function(t,e){if(s(t))throw new TypeError("NaN is not a valid value")
if(!u.arraylike(e))throw new TypeError("second argument must be array-like")
for(var n=e.length;--n>=0;)if(t>e[n])return!1
return!0},u.nan=function(t){return!u.number(t)||t!==t},u.even=function(t){return u.infinite(t)||u.number(t)&&t===t&&t%2===0},u.odd=function(t){return u.infinite(t)||u.number(t)&&t===t&&t%2!==0},u.ge=function(t,e){if(s(t)||s(e))throw new TypeError("NaN is not a valid value")
return!u.infinite(t)&&!u.infinite(e)&&t>=e},u.gt=function(t,e){if(s(t)||s(e))throw new TypeError("NaN is not a valid value")
return!u.infinite(t)&&!u.infinite(e)&&t>e},u.le=function(t,e){if(s(t)||s(e))throw new TypeError("NaN is not a valid value")
return!u.infinite(t)&&!u.infinite(e)&&e>=t},u.lt=function(t,e){if(s(t)||s(e))throw new TypeError("NaN is not a valid value")
return!u.infinite(t)&&!u.infinite(e)&&e>t},u.within=function(t,e,n){if(s(t)||s(e)||s(n))throw new TypeError("NaN is not a valid value")
if(!u.number(t)||!u.number(e)||!u.number(n))throw new TypeError("all arguments must be numbers")
var r=u.infinite(t)||u.infinite(e)||u.infinite(n)
return r||t>=e&&n>=t},u.object=function(t){return t&&"[object Object]"===o.call(t)},u.hash=function(t){return u.object(t)&&t.constructor===Object&&!t.nodeType&&!t.setInterval},u.regexp=function(t){return"[object RegExp]"===o.call(t)},u.string=function(t){return"[object String]"===o.call(t)}},{}],22:[function(t,e,n){!function(){"use strict"
...
return s&&o(a,function(e){r.call(t,e)&&n.push(e)}),n},e.exports=n}()},{foreach:20,is:21}],23:[function(t,e,n){function r(t,e,n){if("string"==typeof n&&(console.error("db.sublevel(name, seperator<string>) is depreciated"),console.error("use db.sublevel(name, {sep: separator})) if you must"),n={sep:n}),!(this instanceof r))return new r(t,e,n)
if(!t)throw new Error("must provide db")
if(!e)throw new Error("must provide prefix")
n=n||{},n.sep=n.sep||"ÿ",this._parent=t,this._options=n,this.options=n,this._prefix=e,this._root=o(this),t.sublevels[e]=this,this.sublevels={},this.methods={}
var i=this
this.hooks={pre:function(){return i.pre.apply(i,arguments)},post:function(){return i.post.apply(i,arguments)}}}function i(t,e){["valueEncoding","encoding","keyEncoding","reverse","values","keys","limit","fillCache"].forEach(function(n){e.hasOwnProperty(n)&&(t[n]=e[n])})}function o(t){return t._parent?o(t._parent):t}var s=t("events").EventEmitter,a=t("util").inherits,u=t("string-range"),c=t("level-fix-range"),h=t("xtend"),f=t("./batch")
a(r,s)
var l=r.prototype
l._key=function(t){var e=this._options.sep
return e+this._prefix+e+t},l._getOptsAndCb=function(t,e){return"function"==typeof t&&(e=t,t={}),{opts:h(t,this._options),cb:e}},l.sublevel=function(t,e){return this.sublevels[t]?this.sublevels[t]:new r(this,t,e||this._options)},l.put=function(t,e,n,r){var i=this._getOptsAndCb(n,r)
...
this._root.del(this.prefix(t),r.opts,r.cb)},l.batch=function(t,e,n){if(!Array.isArray(t))return new f(this)
...
var e=o(this),n=this.prefix(),r=u.prefix(t,n)
i(r,h(t,this._options))
var s=e.createReadStream(r)
if(r.values===!1){var a=s.read
if(a)s.read=function(t){var e=a.call(this,t)
return e&&(e=e.substring(n.length)),e}
else{var c=s.emit
s.emit=function(t,e){"data"===t?c.call(this,"data",e.substring(n.length)):c.call(this,t,e)}}return s}if(r.keys===!1)return s
var a=s.read
return a?s.read=function(t){var e=a.call(this,t)
return e&&(e.key=e.key.substring(n.length)),e}:s.on("data",function(t){t.key=t.key.substring(n.length)}),s},l.writeStream=l.createWriteStream=function(){var t=o(this),e=this.prefix(),n=t.createWriteStream.apply(t,arguments),r=n.write,i=this._options.encoding,s=this._options.valueEncoding,a=this._options.keyEncoding,u=!i&&!s&&!a
return n.write=u?function(t){return t.key=e+t.key,r.call(n,t)}:function(t){return t.key=e+t.key,i&&"undefined"==typeof t.encoding&&(t.encoding=i),s&&"undefined"==typeof t.valueEncoding&&(t.valueEncoding=s),a&&"undefined"==typeof t.keyEncoding&&(t.keyEncoding=a),r.call(n,t)},n},l.approximateSize=function(){var t=o(db)
return t.approximateSize.apply(t,arguments)},l.pre=function(t,e){e||(e=t,t=null),t=u.prefix(t,this.prefix(),this._options.sep)
var n=o(this._parent),r=this.prefix()
return n.hooks.pre(c(t),function(t,n,i){e({key:t.key.substring(r.length),value:t.value,type:t.type},function(t,e){n(t,t.prefix?e:e||r)},i)})},l.post=function(t,e){e||(e=t,t=null)
var n=o(this._parent),r=this.prefix()
return t=u.prefix(t,r,this._options.sep),n.hooks.post(c(t),function(t){e({key:t.key.substring(r.length),value:t.value,type:t.type})})}
e.exports=r},{"./batch":11,events:90,"level-fix-range":13,"string-range":16,util:117,xtend:18}],24:[function(t,e,n){function r(t){this._levelup=t,this.batch=t.db.batch(),this.ops=[]}var i=t("./util"),o=t("./errors").WriteError,s=i.getOptions,a=i.dispatchError
r.prototype.put=function(t,e,n){n=s(this._levelup,n)
var r=i.encodeKey(t,n),a=i.encodeValue(e,n)
try{this.batch.put(r,a)}catch(u){throw new o(u)}return this.ops.push({type:"put",key:r,value:a}),this},r.prototype.del=function(t,e){e=s(this._levelup,e)
var n=i.encodeKey(t,e)
try{this.batch.del(n)}catch(r){throw new o(r)}return this.ops.push({type:"del",key:n}),this},r.prototype.clear=function(){try{this.batch.clear()}catch(t){throw new o(t)}return this.ops=[],this},r.prototype.write=function(t){var e=this._levelup,n=this.ops
try{this.batch.write(function(r){return r?a(e,new o(r),t):(e.emit("batch",n),void(t&&t()))})}catch(r){throw new o(r)}},e.exports=r},{"./errors":25,"./util":28}],25:[function(t,e,n){var r=t("errno").create,i=r("LevelUPError"),o=r("NotFoundError",i)
o.prototype.notFound=!0,o.prototype.status=404,e.exports={LevelUPError:i,InitializationError:r("InitializationError",i),OpenError:r("OpenError",i),ReadError:r("ReadError",i),WriteError:r("WriteError",i),NotFoundError:o,EncodingError:r("EncodingError",i)}},{errno:36}],26:[function(t,e,n){(function(n){function r(t,e){return"function"==typeof t?t:e}function i(t,e,r){if(!(this instanceof i))return new i(t,e,r)
var o
...
return t=u(this.options,t),new m(t,this,function(t){return e.db.iterator(t)})},i.prototype.keyStream=i.prototype.createKeyStream=function(t){return this.createReadStream(u(t,{keys:!0,values:!1}))},i.prototype.valueStream=i.prototype.createValueStream=function(t){return this.createReadStream(u(t,{keys:!1,values:!0}))},i.prototype.writeStream=i.prototype.createWriteStream=function(t){return new y(u(t),this)},i.prototype.toString=function(){return"LevelUP"},e.exports=i,e.exports.copy=b.copy,e.exports.destroy=o("destroy"),e.exports.repair=o("repair")}).call(this,t("Kii323"))},{"./batch":24,"./errors":25,"./read-stream":27,"./util":28,"./write-stream":29,Kii323:96,"deferred-leveldown":31,events:90,prr:37,util:117,xtend:48}],27:[function(t,e,n){function r(t,e,n){if(!(this instanceof r))return new r(t,e,n)
i.call(this,{objectMode:!0,highWaterMark:t.highWaterMark}),this._db=e,t=this._options=s(c,t),this._keyEncoding=t.keyEncoding||t.encoding,this._valueEncoding=t.valueEncoding||t.encoding,"undefined"!=typeof this._options.start&&(this._options.start=u.encodeKey(this._options.start,this._options)),"undefined"!=typeof this._options.end&&(this._options.end=u.encodeKey(this._options.end,this._options)),"number"!=typeof this._options.limit&&(this._options.limit=-1),this._options.keyAsBuffer=u.isKeyAsBuffer(this._options),this._options.valueAsBuffer=u.isValueAsBuffer(this._options),this._makeData=this._options.keys&&this._options.values?h:this._options.keys?f:this._options.values?l:p
var o=this
this._db.isOpen()?this._iterator=n(this._options):this._db.once("ready",function(){o._destroyed||(o._iterator=n(o._options))})}var i=t("readable-stream").Readable,o=t("util").inherits,s=t("xtend"),a=t("./errors").EncodingError,u=t("./util"),c={keys:!0,values:!0},h=function(t,e){return{key:u.decodeKey(t,this._options),value:u.decodeValue(e,this._options)}},f=function(t){return u.decodeKey(t,this._options)},l=function(t,e){return u.decodeValue(e,this._options)},p=function(){return null}
o(r,i),r.prototype._read=function d(){var t=this
...
try{r=t._makeData(n,r)}catch(i){return t._cleanup(new a(i))}t._destroyed||t.push(r)})):t._db.once("ready",function(){d.call(t)})},r.prototype._cleanup=function(t){if(!this._destroyed){this._destroyed=!0
var e=this
t&&e.emit("error",t),e._iterator?e._iterator.end(function(){e._iterator=null,e.emit("close")}):e.emit("close")}},r.prototype.destroy=function(){this._cleanup()},r.prototype.toString=function(){return"LevelUP.ReadStream"},e.exports=r},{"./errors":25,"./util":28,"readable-stream":47,util:117,xtend:48}],28:[function(t,e,n){(function(n,r){function i(t,e,n){t.readStream().pipe(e.writeStream()).on("close",n?n:function(){}).on("error",n?n:function(t){throw t})}function o(t,e){var n="string"==typeof e
...
e.exports={defaultOptions:w,copy:i,getOptions:o,getLevelDOWN:s,dispatchError:a,encodeKey:h,encodeValue:f,isValueAsBuffer:d,isKeyAsBuffer:g,decodeValue:p,decodeKey:l}}).call(this,t("Kii323"),t("buffer").Buffer)},{"../package.json":49,"./errors":25,Kii323:96,buffer:86,leveldown:85,"leveldown/package":85,semver:85,xtend:48}],29:[function(t,e,n){(function(n,r){function i(t,e){if(!(this instanceof i))return new i(t,e)
...
e&&t.pipe(u(function(t,r){return t?(n.writable=!1,n.emit("error",t)):(n._options.fstreamRoot&&e.indexOf(n._options.fstreamRoot)>-1&&(e=e.substr(n._options.fstreamRoot.length+1)),void n.write({key:e,value:r.slice(0)}))}))},i.prototype.toString=function(){return"LevelUP.WriteStream"},e.exports=i}).call(this,t("Kii323"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./util":28,Kii323:96,bl:30,stream:114,util:117,xtend:48}],30:[function(t,e,n){(function(n){function r(t){if(!(this instanceof r))return new r(t)
...
return"object"!=typeof e&&(e={}),this._written=!0,"function"==typeof this._write?this._write(n):"function"==typeof this._db._batch?this._db._batch(this._operations,e,n):void t.nextTick(n)},e.exports=n}).call(this,t("Kii323"))},{Kii323:96}],33:[function(t,e,n){(function(t){function n(t){this.db=t,this._ended=!1,this._nexting=!1}n.prototype.next=function(e){var n=this
...
return this._ended?e(new Error("end() already called on iterator")):(this._ended=!0,"function"==typeof this._end?this._end(e):void t.nextTick(e))},e.exports=n}).call(this,t("Kii323"))},{Kii323:96}],34:[function(t,e,n){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
...
return n})},{}],38:[function(t,e,n){(function(n){function r(t){return this instanceof r?(u.call(this,t),c.call(this,t),t&&t.readable===!1&&(this.readable=!1),t&&t.writable===!1&&(this.writable=!1),this.allowHalfOpen=!0,t&&t.allowHalfOpen===!1&&(this.allowHalfOpen=!1),void this.once("end",i)):new r(t)}function i(){this.allowHalfOpen||this._writableState.ended||n.nextTick(this.end.bind(this))}function o(t,e){for(var n=0,r=t.length;r>n;n++)e(t[n],n)}e.exports=r
...
a.inherits(r,u),o(s(c.prototype),function(t){r.prototype[t]||(r.prototype[t]=c.prototype[t])})}).call(this,t("Kii323"))},{"./_stream_readable":40,"./_stream_writable":42,Kii323:96,"core-util-is":43,inherits:44}],39:[function(t,e,n){function r(t){return this instanceof r?void i.call(this,t):new r(t)}e.exports=r
var i=t("./_stream_transform"),o=t("core-util-is")
o.inherits=t("inherits"),o.inherits(r,i),r.prototype._transform=function(t,e,n){n(null,t)}},{"./_stream_transform":41,"core-util-is":43,inherits:44}],40:[function(t,e,n){(function(n){function r(e,n){e=e||{}
...
e.awaitDrain--,0===e.awaitDrain&&v(t)}}function v(t){function e(t,e,i){var o=t.write(n)
!1===o&&r.awaitDrain++}var n,r=t._readableState
...
return E(o,function(e){t.on(e,r.emit.bind(r,e))}),r._read=function(e){n&&(n=!1,t.resume())},r},i._fromList=b}).call(this,t("Kii323"))},{Kii323:96,buffer:86,"core-util-is":43,events:90,inherits:44,isarray:45,stream:114,"string_decoder/":46}],41:[function(t,e,n){function r(t,e){this.afterTransform=function(t,n){return i(e,t,n)},this.needTransform=!1,this.transforming=!1,this.writecb=null,this.writechunk=null}function i(t,e,n){var r=t._transformState
r.transforming=!1
var i=r.writecb
...
this._readableState.needReadable=!0,this._readableState.sync=!1,this.once("finish",function(){"function"==typeof this._flush?this._flush(function(t){s(e,t)}):s(e)})}function s(t,e){if(e)return t.emit("error",e)
...
u.inherits=t("inherits"),u.inherits(o,a),o.prototype.push=function(t,e){return this._transformState.needTransform=!1,a.prototype.push.call(this,t,e)},o.prototype._transform=function(t,e,n){throw new Error("not implemented")},o.prototype._write=function(t,e,n){var r=this._transformState
if(r.writecb=n,r.writechunk=t,r.writeencoding=e,!r.transforming){var i=this._readableState;(r.needTransform||i.needReadable||i.length<i.highWaterMark)&&this._read(i.highWaterMark)}},o.prototype._read=function(t){var e=this._transformState
null!==e.writechunk&&e.writecb&&!e.transforming?(e.transforming=!0,this._transform(e.writechunk,e.writeencoding,e.afterTransform)):e.needTransform=!0}},{"./_stream_duplex":38,"core-util-is":43,inherits:44}],42:[function(t,e,n){(function(n){function r(t,e,n){this.chunk=t,this.encoding=e,this.callback=n}function i(t,e){t=t||{}
...
"function"==typeof t?(n=t,t=null,e=null):"function"==typeof e&&(n=e,e=null),"undefined"!=typeof t&&null!==t&&this.write(t,e),r.ending||r.finished||b(this,r,n)}}).call(this,t("Kii323"))},{"./_stream_duplex":38,Kii323:96,buffer:86,"core-util-is":43,inherits:44,stream:114}],43:[function(t,e,n){(function(t){function e(t){return Array.isArray(t)}function r(t){return"boolean"==typeof t}function i(t){return null===t}function o(t){return null==t}function s(t){return"number"==typeof t}function a(t){return"string"==typeof t}function u(t){return"symbol"==typeof t}function c(t){return void 0===t}function h(t){return f(t)&&"[object RegExp]"===m(t)}function f(t){return"object"==typeof t&&null!==t}function l(t){return f(t)&&"[object Date]"===m(t)}function p(t){return f(t)&&("[object Error]"===m(t)||t instanceof Error)}function d(t){return"function"==typeof t}function g(t){return null===t||"boolean"==typeof t||"number"==typeof t||"string"==typeof t||"symbol"==typeof t||"undefined"==typeof t}function v(e){return t.isBuffer(e)}function m(t){return Object.prototype.toString.call(t)}n.isArray=e,n.isBoolean=r,n.isNull=i,n.isNullOrUndefined=o,n.isNumber=s,n.isString=a,n.isSymbol=u,n.isUndefined=c,n.isRegExp=h,n.isObject=f,n.isDate=l,n.isError=p,n.isFunction=d,n.isPrimitive=g,n.isBuffer=v}).call(this,t("buffer").Buffer)},{buffer:86}],44:[function(t,e,n){e.exports="function"==typeof Object.create?function(t,e){t.super_=e,t.prototype=Object.create(e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}})}:function(t,e){t.super_=e
var n=function(){}
n.prototype=e.prototype,t.prototype=new n,t.prototype.constructor=t}},{}],45:[function(t,e,n){e.exports=t(9)},{}],46:[function(t,e,n){function r(t){if(t&&!u(t))throw new Error("Unknown encoding: "+t)}function i(t){return t.toString(this.encoding)}function o(t){this.charReceived=t.length%2,this.charLength=this.charReceived?2:0}function s(t){this.charReceived=t.length%3,this.charLength=this.charReceived?3:0}var a=t("buffer").Buffer,u=a.isEncoding||function(t){switch(t&&t.toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":case"raw":return!0
...
this._put(o,s,e,l)}}p(n)},s.prototype._iterator=function(t){return new o(this,t)},s.destroy=function(t,e){try{Object.keys(localStorage).forEach(function(e){e.substring(0,t.length+1)==t+"!"&&localStorage.removeItem(e)}),e()}catch(n){}},e.exports=s}).call(this,t("Kii323"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{},t("buffer").Buffer)},{"./localstorage":51,Kii323:96,"abstract-leveldown":54,buffer:86,util:117}],51:[function(t,e,n){function r(t){this._partition=t,this._keys=[]
...
for(var e=this._keys.length;e>=0;e--)this._keys[e]===t&&(this._keys.splice(e,1),window.localStorage.removeItem(t))},r.prototype.clear=function(){window.localStorage.clear()},r.prototype.length=function(){return this._keys.length},n.localStorage=r},{}],52:[function(t,e,n){e.exports=t(32)},{Kii323:96}],53:[function(t,e,n){e.exports=t(33)},{Kii323:96}],54:[function(t,e,n){(function(n,r){function i(t){if(!arguments.length||void 0===t)throw new Error("constructor requires at least a location argument")
if("string"!=typeof t)throw new Error("constructor requires a location string argument")
this.location=t}var o=t("xtend"),s=t("./abstract-iterator"),a=t("./abstract-chained-batch")
i.prototype.open=function(t,e){if("function"==typeof t&&(e=t),"function"!=typeof e)throw new Error("open() requires a callback argument")
return"object"!=typeof t&&(t={}),"function"==typeof this._open?this._open(t,e):void n.nextTick(e)},i.prototype.close=function(t){if("function"!=typeof t)throw new Error("close() requires a callback argument")
...
return t=o(t),["start","end","gt","gte","lt","lte"].forEach(function(n){t[n]&&e._isBuffer(t[n])&&0===t[n].length&&delete t[n]}),t.reverse=!!t.reverse,t.reverse&&t.lt&&(t.start=t.lt),t.reverse&&t.lte&&(t.start=t.lte),!t.reverse&&t.gt&&(t.start=t.gt),!t.reverse&&t.gte&&(t.start=t.gte),(t.reverse&&t.lt&&!t.lte||!t.reverse&&t.gt&&!t.gte)&&(t.exclusiveStart=!0),t},i.prototype.iterator=function(t){return"object"!=typeof t&&(t={}),t=this._setupIteratorOptions(t),"function"==typeof this._iterator?this._iterator(t):new s(this)},i.prototype._chainedBatch=function(){return new a(this)},i.prototype._isBuffer=function(t){return r.isBuffer(t)},i.prototype._checkKeyValue=function(t,e){if(null===t||void 0===t)return new Error(e+" cannot be `null` or `undefined`")
if(null===t||void 0===t)return new Error(e+" cannot be `null` or `undefined`")
if(this._isBuffer(t)){if(0===t.length)return new Error(e+" cannot be an empty Buffer")}else if(""===String(t))return new Error(e+" cannot be an empty String")},e.exports.AbstractLevelDOWN=i,e.exports.AbstractIterator=s,e.exports.AbstractChainedBatch=a}).call(this,t("Kii323"),t("buffer").Buffer)},{"./abstract-chained-batch":52,"./abstract-iterator":53,Kii323:96,buffer:86,xtend:56}],55:[function(t,e,n){e.exports=t(17)},{}],56:[function(t,e,n){arguments[4][18][0].apply(n,arguments)},{"./has-keys":55,"object-keys":58}],57:[function(t,e,n){var r=Object.prototype.hasOwnProperty,i=Object.prototype.toString,o=function(t){var e="function"==typeof t&&!(t instanceof RegExp)||"[object Function]"===i.call(t)
return e||"undefined"==typeof window||(e=t===window.setTimeout||t===window.alert||t===window.confirm||t===window.prompt),e}
e.exports=function(t,e){if(!o(e))throw new TypeError("iterator must be a function")
var n,i,s="string"==typeof t,a=t.length,u=arguments.length>2?arguments[2]:null
if(a===+a)for(n=0;a>n;n++)null===u?e(s?t.charAt(n):t[n],n,t):e.call(u,s?t.charAt(n):t[n],n,t)
else for(i in t)r.call(t,i)&&(null===u?e(t[i],i,t):e.call(u,t[i],i,t))}},{}],58:[function(t,e,n){arguments[4][19][0].apply(n,arguments)},{"./shim":60}],59:[function(t,e,n){var r=Object.prototype.toString
e.exports=function i(t){var e=r.call(t),i="[object Arguments]"===e
return i||(i="[object Array]"!==e&&null!==t&&"object"==typeof t&&"number"==typeof t.length&&t.length>=0&&"[object Function]"===r.call(t.callee)),i}},{}],60:[function(t,e,n){!function(){"use strict"
...
o(c,function(e){g&&"constructor"===e||!r.call(t,e)||f.push(e)})}return f},e.exports=n}()},{"./foreach":57,"./isArguments":59}],61:[function(t,e,n){var r=t("events").EventEmitter,i=t("level-sublevel"),o=t("weak-type-wizard"),s=t("noddity-retrieval"),a=t("extend"),u=t("./lib/reflect.js"),c=t("./lib/index_manager.js"),h=t("./lib/post_manager.js"),f=new o({postMetadata:"metadata",string:["content","filename"],"default":{content:"",filename:""},cast:{postMetadata:new o({date:"date",markdown:"boolean"})}})
e.exports=function(t,e,n){function o(t,e){"function"==typeof t&&(e=t),"object"!=typeof t&&(t={})
var n=t.local||!1,r="number"==typeof t.mostRecent?-t.mostRecent:void 0,i=n?y.getLocalPosts:y.getPosts
i(r,void 0,e)}function l(){m.stop(),y.stop()}var p="string"==typeof t?new s(t):t,d=i(e),g=new r
n=a({},n)
var v=Object.create(g),m=new h(p,d.sublevel("posts",{valueEncoding:f.getLevelUpEncoding()}),{refreshEvery:n.refreshEvery,checkToSeeIfItemsNeedToBeRefreshedEvery:n.cacheCheckIntervalMs}),y=new c(p,m,d.sublevel("index",{valueEncoding:"json"}),{refreshEvery:n.refreshEvery,checkToSeeIfItemsNeedToBeRefreshedEvery:n.cacheCheckIntervalMs})
return u("change",m,g,"post changed"),u("post added",m,g),u("change",y,g,"index changed"),y.on("change",y.getPosts),v.getPost=m.getPost,v.getPosts=o,v.allPostsAreLoaded=y.allPostsAreLoaded,v.stop=l,v.refreshPost=m.refresh,v}},{"./lib/index_manager.js":62,"./lib/post_manager.js":63,"./lib/reflect.js":64,events:90,extend:66,"level-sublevel":12,"noddity-retrieval":70,"weak-type-wizard":72}],62:[function(t,e,n){function r(t,e){var n=t&&e&&t.metadata&&e.metadata&&t.metadata.date&&e.metadata.date
return n&&t.metadata.date!=e.metadata.date?t.metadata.date<e.metadata.date?-1:1:0}function i(t,e){return t.length===e.length&&t.every(function(t,n){return e[n]===t})}function o(t,e,n,o){function h(t,e,n,i){"function"==typeof e&&(i=e),p(function(o,s){o?i(o):t(s,function(t,o){t||(o=o.sort(r),"number"==typeof e&&(o=o.slice(e,n))),i(t,o)})})}o=a({refreshEvery:6e5,comparison:i},o)
var f=Object.create(new u),l=s(n,function(e,n){t.getIndex(n)},o)
l.on("change",function(t,e){f.emit("change",e)})
var p=l.get.bind(l,c)
p()
var d=h.bind(null,e.getPosts),g=h.bind(null,e.getLocalPosts)
return f.getPosts=d,f.getLocalPosts=g,f.allPostsAreLoaded=function(t){p(function(e,n){e?t(!1,!1):g(function(e,r){t(e,e||r.length===n.length)})})},f.stop=l.stop,f}var s=t("levelup-cache"),a=t("extend"),u=t("events").EventEmitter,c="index"
e.exports=o},{events:90,extend:66,"levelup-cache":67}],63:[function(t,e,n){function r(t,e){return"undefined"!=typeof e&&h(t)?t.toString()===e.toString():t===e}function i(t,e){return t.content===e.content&&t.metadata.length===e.metadata.length&&t.filename===e.filename&&Object.keys(t.metadata).every(function(n){return r(t.metadata[n],e.metadata[n])})}function o(t,e,n){function r(t,e){d.get(t,e)}function o(t,e){var n=[],i=!1,o=s(),a=t.map(function(t,e){return function(o){r(t,function(t,r){!i&&t?i=t:i||(n[e]=r),o()})}})
o.gate.apply(o,a).then(function(){e(i,n)})}function h(t,e){var n=[],r=!1,i=s(),o=t.map(function(t){return function(e){d.getLocal(t,function(t,o){r||(t?t.notFound||(r=t,i.abort()):n.push(o)),e()})}})
i.gate.apply(i,o).then(function(t){e(r,n),t()})}n=n||{}
var l=Object.create(new u),p=c({refreshEvery:432e5},n,{comparison:i}),d=new a(e,t.getPost,p)
return f("change",d,l),l.getPost=r,l.getPosts=o,l.getLocalPosts=h,l.stop=d.stop,l.refresh=d.refresh,l}var s=t("asynquence"),a=t("levelup-cache"),u=t("events").EventEmitter,c=t("extend"),h=t("util").isDate,f=t("./reflect.js")
e.exports=o},{"./reflect.js":64,asynquence:65,events:90,extend:66,"levelup-cache":67,util:117}],64:[function(t,e,n){e.exports=function(t,e,n,r){"string"==typeof t&&(t=[t]),t.forEach(function(t){e.on(t,n.emit.bind(n,r||t))})}},{}],65:[function(t,e,n){!function(t,n,r){"undefined"!=typeof e&&e.exports?e.exports=r():"function"==typeof define&&define.amd?define(r):n[t]=r(t,n)}("ASQ",this,function(t,e){function n(t){return"undefined"!=typeof setImmediate?setImmediate(t):setTimeout(t,0)}function r(){function t(){function t(){clearTimeout(d),d=null,y.length=0,b.length=0,w.length=0,E.length=0}function e(){return v?r():void(d||(d=n(r)))}function r(){var n,r
if(d=null,v)t()
...
return i=r(),i.noConflict=function(){return e&&(e[t]=o),i},i})},{}],66:[function(t,e,n){function r(t){if(!t||"[object Object]"!==o.call(t)||t.nodeType||t.setInterval)return!1
var e=i.call(t,"constructor"),n=i.call(t.constructor.prototype,"isPrototypeOf")
if(t.constructor&&!e&&!n)return!1
var r
for(r in t);return void 0===r||i.call(t,r)}var i=Object.prototype.hasOwnProperty,o=Object.prototype.toString
e.exports=function s(){var t,e,n,i,o,a,u=arguments[0]||{},c=1,h=arguments.length,f=!1
for("boolean"==typeof u&&(f=u,u=arguments[1]||{},c=2),"object"!=typeof u&&"function"!=typeof u&&(u={});h>c;c++)if(null!=(t=arguments[c]))for(e in t)n=u[e],i=t[e],u!==i&&(f&&i&&(r(i)||(o=Array.isArray(i)))?(o?(o=!1,a=n&&Array.isArray(n)?n:[]):a=n&&r(n)?n:{},u[e]=s(f,a,i)):void 0!==i&&(u[e]=i))
return u}},{}],67:[function(t,e,n){var r=t("stringmap"),i=t("level-sublevel"),o=t("asynquence"),s=t("events").EventEmitter,a=t("expire-unused-keys"),u=t("extend")
e.exports=function(t,e,n){function c(){v.stop(),g.stop()}function h(t){d.del(t),v.forget(t)
var e=m.get(t)
e&&(e.abort(),m.remove(t))}function f(t,r){var i=m.get(t)
v.touch(t),i||(i=o(function(r){e(t,function(e,i){d.get(t,function(o,s){!e&&m.has(t)&&d.put(t,i,function(){y.emit("load",t,i),(o&&o.notFound||!n.comparison(s,i))&&y.emit("change",t,i,s)}),r(e,i)})})}),m.set(t,i),i.then(function(e,n,r){m.remove(t),e(n,r)})),"function"==typeof r&&i.then(function(t,e,n){r(e,n),t(e,n)})}function l(t,e){return function(n,r){g.touch(t),"function"==typeof e&&e(n,r)}}n=n||{},n=u({refreshEvery:432e5,checkToSeeIfItemsNeedToBeRefreshedEvery:1e3,ttl:6048e5,comparison:function(t,e){return t===e}},n)
var p=i(t),d=p.sublevel("items"),g=new a(n.ttl,p.sublevel("item-expirations",{valueEncoding:"utf8"}),n.checkToSeeIfItemsNeedToBeRefreshedEvery),v=new a(n.refreshEvery,p.sublevel("refresh",{valueEncoding:"utf8"}),n.checkToSeeIfItemsNeedToBeRefreshedEvery),m=new r,y=Object.create(new s)
return v.on("expire",f),g.on("expire",h),y.stop=c,y.get=function(t,e){d.get(t,function(n,r){n&&n.notFound?f(t,l(t,e)):e&&l(t,e)(n,r)})},y.getLocal=function(t,e){d.get(t,l(t,e))},y.refresh=function(t,e){f(t,l(t,e))},y}},{asynquence:65,events:90,"expire-unused-keys":68,extend:66,"level-sublevel":12,stringmap:69}],68:[function(t,e,n){function r(t){function e(){n=!1}var n=!1
return function(){n||(n=!0,t(e))}}var i=t("events").EventEmitter
e.exports=function(t,e,n){function o(t){return t.filter(function(t){return-1===a.indexOf(t)})}var s=new i,a=[],u=r(function(n){var r=(new Date).getTime(),i=[]
...
return c.unref&&c.unref(),s.touch=s.emit.bind(s,"touch"),s.forget=s.emit.bind(s,"forget"),s.stop=function(){clearInterval(c)},s}},{events:90}],69:[function(t,e,n){var r=function(){"use strict"
...
"undefined"!=typeof e&&"undefined"!=typeof e.exports&&(e.exports=r)},{}],70:[function(t,e,n){var r=t("http"),i=t("url"),o=t("text-metadata-parser")
e.exports=function(t){var e=function(e,n,o){var s="",a=i.resolve(t,e)
r.get(i.parse(a),function(t){var e="function"!=typeof t.setEncoding
e||t.setEncoding("utf8"),t.on("data",function(t){null!==s&&(s+=t)}),t.on("error",function(t){s=null,n(t)}),t.on("end",function(e){if(null!==s)if("undefined"!=typeof e&&(s+=e),200!==t.statusCode)n(new Error("Lookup of "+a+" returned status "+t.statusCode+"\n========\n"+s))
else{var r=null
try{r=o(s)}catch(i){n(new Error("Error parsing file with contents:\n"+s+"\n==========\n"+i.message))}null!==r&&n(!1,r)}})}).on("error",function(t){n(new Error("Lookup of "+a+" failed\n========\n"+t.message))})}
return{getIndex:function(t){e("index.json",t,JSON.parse)},getPost:function(t,n){e(t,n,function(e){var n=o(e,{date:"date","boolean":"markdown"})
return n.filename=t,n})}}}},{http:91,"text-metadata-parser":71,url:115}],71:[function(t,e,n){function r(t){for(var e=t.split("\n"),n=!1,r=!1,i={content:"",metadata:{}},o=0;o<e.length&&!r;o++)if(n)r||(r=!/^\s*$/.test(e[o]))
else{var s=/^([^:]+):\s*([^\r\n]+)\s*$/.exec(e[o])
if(s&&3===s.length){var a=s[1].trim()
i.metadata[a]=s[2]}else{if(0===o)return{content:t,metadata:{}}
n=!0}}return i.content=e.slice(o-1).join("\n"),i}function i(t,e){var n=r(e)
return n.metadata=t(n.metadata),n}function o(t,e,n){var r="string"!=typeof e
"undefined"==typeof n&&"string"!=typeof e&&(n=e)
var s="object"==typeof n?t.extend(n):t
return r?o.bind(null,s):i(s,e)}var s=t("weak-type-wizard")
e.exports=o.bind(null,new s({}))},{"weak-type-wizard":72}],72:[function(t,e,n){function r(t){return Object.keys(t).reduce(function(e,n){return a(!0,e,i(t[n],n))},{})}function i(t,e){return"string"==typeof t?i([t],e):Array.isArray(t)?t.reduce(function(t,n){return t[n]=e,t},{}):{}}function o(t,e,n){return Object.keys(e).filter(function(e){return"undefined"!=typeof t[e]}).forEach(function(r){var i=n[t[r]]
"function"==typeof i&&(e[r]=i(e[r]))}),e}function s(t,e,n){var i=function(r){var i=a(!0,{},e,r)
return o(t,i,n)}
...
delete i.cast
var h=r(i)
return new s(a(!0,{},t,h),a(!0,{},e,o),a(!0,{},u,n,c))},i.getLevelUpEncoding=function(){return{buffer:!1,type:"weak-type-wizard",encode:JSON.stringify,decode:function(t){return i(JSON.parse(t))}}},i}var a=t("extend"),u={"boolean":function(t){return"false"!==t.toString().toLowerCase()&&!(/^\d+$/.test(t)&&0!==parseInt(t))},number:function(t){return parseFloat(t)},string:function(t){return t.toString()},date:function(t){return new Date(t)}},c=new s({},{})
e.exports=function(t){return c.extend(t)}},{extend:66}],73:[function(t,e,n){function r(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
return n}function i(t,e,n){return n.replace(/\[\[([\w.-]+)(?:\|([^\]>\n]+))?\]\]/gm,function(n,i,o,s,a){var u=r("<code",a.substr(0,s)),c=r("</code",a.substr(0,s))
return u!==c?n:(o=o||i,t.emit("link",i),'<a href="'+e+i+'">'+o+"</a>")})}var o=t("events").EventEmitter
e.exports=function(t){var e=Object.create(new o)
return e.linkify=i.bind(null,e,t),e}},{events:90}],74:[function(t,e,n){function r(t,e){function n(t){u.mixinHtml(t),u.parseTemplate(t),u.mixinChildPosts(t),u.mixinRenderedHtmlEmitter(t),t.on("all child posts fetched",function(t){t.templateElements.forEach(n)})}function r(t,e){var r=u.makeNewMixinObject(t)
...
return n.ractive=e,u.mixinHtml(n),u.parseTemplate(n),u.updateEmitterMixin(n),u.mixinTeardownChildren(n),u.mixinChildPosts(n),s(n),n.on("child post fetched",function(t){n.torndown||(o(t),n.children.push(t))}),e.set({html:n.html,metadata:t.metadata,current:t.filename}),n.change}var u=i(t,e)
return{populateRootRactive:a,renderPost:r}}var i=t("./mixins")
e.exports=r},{"./mixins":75}],75:[function(t,e,n){(function(n){function r(t){try{return new d({el:null,data:t.data,template:t.renderedHtml||t.html,preserveWhitespace:!0}).toHTML()}catch(e){return t.emit("error",e),e.message}}function i(t){var e=Object.create(new p)
...
e.exports=function(e,n){return{mixinHtml:a.bind(null,n),makeNewMixinObject:i,mixinRenderedHtmlEmitter:u,parseTemplate:t("./parseTemplate"),mixinChildPosts:s.bind(null,e.getPost),updateEmitterMixin:g(e),mixinTemplateRactive:c,mixinTeardownChildren:h}}}).call(this,t("Kii323"))},{"./parseTemplate":78,"./templateToolbox.js":79,"./updateEmitterMixin.js":80,Kii323:96,events:90,ractive:76}],76:[function(t,e,n){!function(t){"use strict"
...
f=i.adapt[h]=t[f]}if(f.filter(a,s,i))return l=i._wrapped[s]=f.wrap(i,a,s,o(s)),l.value=a,a}return u||(i.magic?r.filter(a,s,i)?i._wrapped[s]=r.wrap(i,a,s):n.filter(a,s,i)&&(i._wrapped[s]=n.wrap(i,a,s)):i.modifyArrays&&e.filter(a,s,i)&&(i._wrapped[s]=e.wrap(i,a,s))),a}}(j,W,z,K),H=function(){function t(t,e){var n,r,i
...
i=n+"="+r,s=t.bindings,s[i]||(s[i]=!0,o=t.instance,a=t.parentFragment.priority,c=new u(e,n,o,r,a),s.push(c),o.twoway&&(h=new u(o,r,e,n,1),s.push(h),c.counterpart=h,h.counterpart=c))}}(w,R,L,d,H,G),J=function(t,e,n){function r(t,r,i,o,s){n(r,o,s,!0),e(r.component,t,i,o)}var i
...
return a=i.split("."),u=a.pop(),c=a.join("."),h=s(t,c),(p=t._wrapped[c])&&(h=p.get()),null!==h&&void 0!==h?((f=t._cacheMap[c])?-1===f.indexOf(i)&&f.push(i):t._cacheMap[c]=[i],"object"!=typeof h||u in h?(d=!e.call(h,u),l=d?n(h[u]):h[u],l=r(t,i,l,!1),t._cache[i]=l,l):t._cache[i]=o):void 0}return t.get=s,s}(w,k,I,$,J,Q),Z=function(){return"undefined"!=typeof console&&"function"==typeof console.warn&&"function"==typeof console.warn.apply?function(){console.warn.apply(console,arguments)}:function(){}}(),tt=function(){var t=Object.prototype.toString
return function(e){return"object"==typeof e&&"[object Object]"===t.call(e)}}(),et=function(t,e,n,r,i){var o,s,a
...
return 0!==t&&"string"!=typeof t||0!==e&&"string"!=typeof e?null:(n=a.exec(t),r=a.exec(e),i=n?n[2]:"",o=r?r[2]:"",i&&o&&i!==o?null:(c=i||o,s=n?+n[1]:0,u=r?+r[1]:0,h=u-s,h?function(t){return s+t*h+c}:function(){return s+c}))}}}(w,k,L,tt,f),nt=function(t,e,n){function r(t){return function(){return t}}var i=function(t,i,o,s){if(t===i)return r(i)
...
return t.interpolate=i,i}(w,Z,et),rt=function(t,e,n,r){var i=function(t){var e
...
this.running=!1,e=this.root._animations.indexOf(this),-1===e&&t("Animation was not found"),this.root._animations.splice(e,1)}},i}(Z,R,nt,U),it=function(t,e,n,r,i,o){function s(e,s,a,c){var h,f,l,p
...
y&&y.stop()}}}return r=r||{},r.complete&&i.then(r.complete),r.complete=o,c=s(this,t,n,r),i.stop=function(){c.stop()},i}}(d,g,v,C,X,rt),ot=function(){return this.fragment.detach()},st=function(t){return this.el?this.fragment.find(t):null},at=function(t,e,n){var r,i,o,s,a,u,c
...
return!1}}}(u,m,a),ut=function(t){return function(e,n){var r=this._isComponentQuery?!this.selector||e.name===this.selector:t(e.node,this.selector)
return r?(this.push(e.node||e.instance),n||this._makeDirty(),!0):void 0}}(at),ct=function(){var t,e,n
t=this._root[this._isComponentQuery?"liveComponentQueries":"liveQueries"],e=this.selector,n=t.indexOf(e),-1!==n&&(t.splice(n,1),t[e]=null)},ht=function(){function t(t){var e
...
throw new Error("An unexpected condition was met while comparing the position of two components. Please file an issue at https://github.com/RactiveJS/Ractive/issues - thanks!")}}(),ft=function(t){return function(e,n){var r
return e.compareDocumentPosition?(r=e.compareDocumentPosition(n),2&r?1:-1):t(e,n)}}(ht),lt=function(t,e){return function(){this.sort(this._isComponentQuery?e:t),this._dirty=!1}}(ft,ht),pt=function(t){return function(){this._dirty||(t.addLiveQuery(this),this._dirty=!0)}}(R),dt=function(t){var e=this.indexOf(this._isComponentQuery?t.instance:t);-1!==e&&this.splice(e,1)},gt=function(t,e,n,r,i,o){return function(s,a,u,c){var h=[]
return t(h,{selector:{value:a},live:{value:u},_isComponentQuery:{value:c},_test:{value:e}}),u?(t(h,{cancel:{value:n},_root:{value:s},_sort:{value:r},_makeDirty:{value:i},_remove:{value:o},_dirty:{value:!1,writable:!0}}),h):h}}(h,ut,ct,lt,pt,dt),vt=function(t){return function(e,n){var r,i
return this.el?(n=n||{},r=this._liveQueries,(i=r[e])?n&&n.live?i:i.slice():(i=t(this,e,!!n.live,!1),i.live&&(r.push(e),r[e]=i),this.fragment.findAll(e,i),i)):[]}}(gt),mt=function(t){return function(e,n){var r,i
return n=n||{},r=this._liveComponentQueries,(i=r[e])?n&&n.live?i:i.slice():(i=t(this,e,!!n.live,!0),i.live&&(r.push(e),r[e]=i),this.fragment.findAllComponents(e,i),i)}}(gt),yt=function(t){return this.fragment.findComponent(t)},bt=function(t){var e,n,r,i=this._subs[t]
if(i)for(e=Array.prototype.slice.call(arguments,1),n=0,r=i.length;r>n;n+=1)i[n].apply(this,e)},wt=function(t,e,n,r){var i,o={}
...
r(t,this.ref),t._unresolvedImplicitDependencies[this.ref]=!1,e(t._unresolvedImplicitDependencies,this)},teardown:function(){n.removeUnresolved(this)}},s}(w,E,R,A),Et=function(t,e,n){var r={isTopLevel:!0}
return function(i){var o
return i=t(i),o=e(this,i,r),this._captured&&this._captured[i]!==!0&&(this._captured.push(i),this._captured[i]=!0,void 0===o&&this._unresolvedImplicitDependencies[i]!==!0&&new n(this,i)),o}}(v,X,wt),_t=function(t){var e
return"undefined"!=typeof window&&document&&t?t.nodeType?t:"string"==typeof t&&(e=document.getElementById(t),!e&&document.querySelector&&(e=document.querySelector(t)),e&&e.nodeType)?e:t[0]&&t[0].nodeType?t[0]:null:null},xt=function(t){return function(e,n){if(e=t(e),n=t(n)||null,!e)throw new Error("You must specify a valid target to insert into")
e.insertBefore(this.detach(),n),this.fragment.pNode=this.el=e}}(_t),kt=function(t,e){var n,r,i,o
return n={},r=0,i=t.map(function(t,i){var s,a,u
a=r,u=e.length
do{if(s=e.indexOf(t,a),-1===s)return o=!0,-1
a=s+1}while(n[s]&&u>a)
return s===r&&(r+=1),s!==i&&(o=!0),n[s]=!0,s}),i.unchanged=!o,i},St=function(t,e){return function(n,r,i,o){var s
...
e&&e.forEach(s)}),o||e(n,r+".length",!0)}}(F,A),Tt=function(t,e,n,r,i,o,s){function a(t){return JSON.stringify(t)}function u(t){if(t===!0)return a
...
return v=o(l,p),m=new r(function(t){y=t}),t.start(this,y),i(this,a,c,!0),s(this,a,v,g),t.end(),h&&h.complete&&m.then(h.complete),m}}(R,Z,L,g,U,kt,St),Ot=function(t,e,n){var r=function(t,e,n,r){var i=this
...
if(t=this.value,r=n(this.root,this.keypath),this.value=r,!this.updating){if(this.updating=!0,!e(r,t)||!this.ready)try{this.callback.call(this.context,r,t,this.keypath)}catch(i){if(this.debug||this.root.debug)throw i}this.updating=!1}}},r}(R,d,X),At=function(t){return function(e,n){var r,i,o,s,a,u,c
...
return o={},s.forEach(function(t){o[t]=e.get(t)}),o}}(L),Nt=function(t,e,n,r){var i,o=/\*/
...
return this.proxies[t]||(this.proxies[t]={update:function(){e.reallyUpdate(t)}}),this.proxies[t]}},i}(R,d,X,At),Rt=function(t,e,n,r,i){var o=/\*/,s={}
...
l&&(t=a._patternObservers.indexOf(f),-1!==t&&a._patternObservers.splice(t,1)),n(f)}}}}(v,H,G,Ot,Nt),Ct=function(t,e){return function(n,r,i){var o,s,a,u
if(t(n)){i=r,s=n,o=[]
...
return{cancel:function(){for(;o.length;)o.pop().cancel()}}}}(tt,Rt),Lt=function(t,e){var n,r
if(!e)if(t)this._subs[t]=[]
else for(t in this._subs)delete this._subs[t]
n=this._subs[t],n&&(r=n.indexOf(e),-1!==r&&n.splice(r,1))},It=function(t,e){var n,r,i=this
if("object"==typeof t){n=[]
for(r in t)t.hasOwnProperty(r)&&n.push(this.on(r,t[r]))
return{cancel:function(){for(var t;t=n.pop();)t.cancel()}}}return this._subs[t]?this._subs[t].push(e):this._subs[t]=[e],{cancel:function(){i.off(t,e)}}},jt=function(){var t
try{Object.create(null),t=Object.create}catch(e){t=function(){var t=function(){}
return function(e,n){var r
return null===e?{}:(t.prototype=e,r=new t,n&&Object.defineProperties(r,n),r)}}()}return t}(),Pt=function(t,e){return function(n,r){var i,o,s,a,u
...
for(u in a)n.indexRefs[u]=a[u]}for(n.priority=s?s.priority+1:1,r.indexRef&&(n.indexRefs||(n.indexRefs={}),n.indexRefs[r.indexRef]=r.index),n.items=[],i=r.descriptor?r.descriptor.length:0,o=0;i>o;o+=1)n.items[n.items.length]=n.createItem({parentFragment:n,pElement:r.pElement,descriptor:r.descriptor[o],index:o})}}(F,jt),Mt=function(t,e){return t.substr(0,e.length+1)===e+"."},Ft=function(t){return function(e,n){return e===n||t(e,n)}}(Mt),Bt=function(t){return function(e,n,r){return e===n?r:t(e,n)?e.replace(n+".",r+"."):void 0}}(Mt),Dt=function(t,e){return function(n,r,i,o){n[r]&&!t(n[r],o)&&(n[r]=e(n[r],i,o))}}(Ft,Bt),Ut=function(t){return function(e,n,r,i){void 0===this.html&&(t(this,"context",r,i),this.indexRefs&&void 0!==this.indexRefs[e]&&this.indexRefs[e]!==n&&(this.indexRefs[e]=n),this.items.forEach(function(t){t.reassign(e,n,r,i)}))}}(Dt),Vt=function(t,e){return{init:t,reassign:e}}(Pt,Ut),qt=function(t,e){function n(t){return o[t]||(o[t]=e(t))}var r,i,o={}
...
return h}}(s,a),Wt=function(){var t,e=this.node
return e&&(t=e.parentNode)?(t.removeChild(e),e):void 0},zt=function(t,e){var n,r,i
return r=/</g,i=/>/g,n=function(e,n){this.type=t.TEXT,this.descriptor=e.descriptor,n&&(this.node=document.createTextNode(e.descriptor),n.appendChild(this.node))},n.prototype={detach:e,reassign:function(){},teardown:function(t){t&&this.detach()},firstNode:function(){return this.node},toString:function(){return(""+this.descriptor).replace(r,"&lt;").replace(i,"&gt;")}},n}(F,Wt),Kt=function(t,e){return function(n){n.keypath?e(n):t.removeUnresolved(n)}}(R,G),$t=function(t){var e=function(e,n,r,i){this.root=e,this.ref=n,this.parentFragment=r,this.resolve=i,t.addUnresolved(this)}
return e.prototype={teardown:function(){t.removeUnresolved(this)}},e}(R),Ht=function(t,e,n,r,i){function o(t,e,r){var i,o,s
...
"function"!=typeof t||t._nowrap||(t=o(t,this.root,this.evaluator)),e(t,this.value)||(this.evaluator.values[this.argNum]=t,this.evaluator.bubble(),this.value=t)},teardown:function(){i(this)}},s}(F,d,c,H,G),Gt=function(t,e,n){var r=function(t,n,r){this.root=t,this.keypath=n,this.priority=r.priority,this.evaluator=r,e(this)}
return r.prototype={update:function(){var e=this.root.get(this.keypath)
t(e,this.value)||(this.evaluator.bubble(),this.value=e)},teardown:function(){n(this)}},r}(d,H,G),Yt=function(t,e,n,r,i,o,s,a){function u(t,e){var n,r
...
this.selfUpdating=this.refs.length+this.softRefs.length<=1}},c}(R,Z,d,B,A,$,Ht,Gt),Jt=function(t,e,n,r,i){function o(t,e){return t.replace(/\$\{([0-9]+)\}/g,function(t,n){return e[n]?e[n].value||e[n].keypath:"undefined"})}function s(t){return"${"+t.replace(/[\.\[\]]/g,"-")+"}"}var a=function(r,i,o,s){var a,u,c,h=this
...
s.keypath&&(a=i(s.keypath,n,r))?(s.keypath=a,o=!0):s.indexRef===t&&(s.value=e,o=!0)}),o&&this.bubble()}},a}(E,T,$t,Yt,Bt),Qt=function(t,e,n,r,i,o,s){var a=function(i,o,a){var c,h,f,l,p,d=this
...
this.keypath=r,e(this),this.update()}}}(F,H,G),ee=function(t){return function(e,n,r,i){var o,s
if(this.resolver?this.resolver.reassign(e,n,r,i):this.keypath?(o=t(this.keypath,r,i),o&&this.resolve(o)):void 0!==e&&this.indexRef===e&&(this.value=n,this.render(n)),this.fragments)for(s=this.fragments.length;s--;)this.fragments[s].reassign(e,n,r,i)}}(Bt),ne=function(t,e,n,r){return{init:t,update:e,resolve:n,reassign:r}}(Xt,Zt,te,ee),re=function(t,e,n,r){var i,o,s
...
return t.replace(o,"&lt;").replace(s,"&gt;")}},i}(F,Kt,ne,Wt),ie=function(){var t=[]
...
c=n.findNextNode(this),n.pNode.insertBefore(this.docFrag,c)}}}(),oe=function(t,e){function n(t,e,n){var r,i,o
...
return s.descriptor.n?void o(s,a,!0,u):void(t(a)?n(s,a,u):e(a)||"function"==typeof a?s.descriptor.i?r(s,a,u):i(s,u):o(s,a,!1,u))}}(L,tt),se=function(t,e){return function(n){var r,i;(i=this.root._wrapped[this.keypath])&&(n=i.get()),this.rendering||(this.rendering=!0,e(this,n),this.rendering=!1,(!this.docFrag||this.docFrag.childNodes.length)&&!this.initialising&&t&&(r=this.parentFragment.findNextNode(this),r&&r.parentNode===this.parentFragment.pNode?this.parentFragment.pNode.insertBefore(this.docFrag,r):this.parentFragment.pNode.appendChild(this.docFrag)))}}(u,oe),ae=function(t,e,n,r){var i,o,s,a,u
for(s=t.descriptor.i,i=e;n>i;i+=1)o=t.fragments[i],a=t.keypath+"."+(i-r),u=t.keypath+"."+i,o.index=i,o.reassign(s,i,a,u)},ue=function(t){function e(t){t.teardown(!0)}function n(t,e,n){var r,i,o
...
s=o+r.removed,a=o+r.added,u=[s,0],u.length+=i,c.fragments.splice.apply(c.fragments,u),t(c,a,c.length,i),n(c,s,a)}}}(ae),ce=function(t,e,n,r,i,o,s){var a,u
...
for(r=this.fragments.length,n=0;r>n;n+=1)this.fragments[n].findAllComponents(t,e)}},a}(F,ne,ie,se,ue,Kt,w),he=function(t,e,n,r,i){var o=function(e,r){this.type=t.TRIPLE,r&&(this.nodes=[],this.docFrag=document.createDocumentFragment()),this.initialising=!0,n.init(this,e),r&&r.appendChild(this.docFrag),this.initialising=!1}
...
for(i=this.nodes.length,r=0;i>r;r+=1)if(o=this.nodes[r],1===o.nodeType&&(e(o,t)&&n.push(o),s=o.querySelectorAll(t)))for(a=s.length,u=0;a>u;u+=1)n.push(s[u])}},o}(F,at,ne,qt,Kt),fe=function(t){return function(e,n){return e.a&&e.a.xmlns?e.a.xmlns:"svg"===e.e?t.svg:n.namespaceURI||t.html}}(s),le=function(){var t,e,n,r
...
else if(r=r.substring(i+1),n.name=e(r),n.lcName=n.name.toLowerCase(),n.namespace=t[o.toLowerCase()],!n.namespace)throw'Unknown namespace ("'+o+'")'}}(s,le),de=function(t){return function(e,n){var r,i=null===n.value?"":n.value;(r=n.pNode)&&(e.namespace?r.setAttributeNS(e.namespace,n.name,i):"style"===n.name&&r.style.setAttribute?r.style.setAttribute("cssText",i):"class"!==n.name||r.namespaceURI&&r.namespaceURI!==t.html?r.setAttribute(n.name,i):r.className=i,"id"===e.name&&(n.root.nodes[n.value]=r),"value"===e.name&&(r._ractive.value=n.value)),e.value=n.value}}(s),ge=function(t){var e={"accept-charset":"acceptCharset",accesskey:"accessKey",bgcolor:"bgColor","class":"className",codebase:"codeBase",colspan:"colSpan",contenteditable:"contentEditable",datetime:"dateTime",dirname:"dirName","for":"htmlFor","http-equiv":"httpEquiv",ismap:"isMap",maxlength:"maxLength",novalidate:"noValidate",pubdate:"pubDate",readonly:"readOnly",rowspan:"rowSpan",tabindex:"tabIndex",usemap:"useMap"}
return function(n,r){var i
!n.pNode||n.namespace||r.pNode.namespaceURI&&r.pNode.namespaceURI!==t.html||(i=e[n.name]||n.name,void 0!==r.pNode[i]&&(n.propertyName=i),("boolean"==typeof r.pNode[i]||"value"===i)&&(n.useProperty=!0))}}(s),ve=function(t){return function(e){var n,r
return n=e.fragment.items,1===n.length&&(r=n[0],r.type===t.INTERPOLATOR&&(r.keypath||r.ref))?r:void 0}}(F),me=function(t){return function(e,n){var r
if(!t(e)||!t(n))return!1
if(e.length!==n.length)return!1
for(r=e.length;r--;)if(e[r]!==n[r])return!1
return!0}}(L),ye=function(t,e,n,r,i,o){var s,a,u,c,h,f,l,p,d,g,v,m,y,b,w='For two-way binding to work, attribute value must be a single interpolator (e.g. value="{{foo}}")',E="You cannot set up two-way binding against an expression "
...
"id"===this.lcName&&(void 0!==this.value&&(this.root.nodes[this.value]=void 0),this.root.nodes[e]=t),t.setAttribute(this.name,e),this.value=e}return this},r}(R,s,L),we=function(t){var e
return e=this.str.substr(this.pos,t.length),e===t?(this.pos+=t.length,t):null},Ee=function(){var t=/^\s+/
return function(){var e=t.exec(this.remaining())
return e?(this.pos+=e[0].length,e[0]):null}}(),_e=function(t){return function(e){var n=t.exec(e.str.substring(e.pos))
return n?(e.pos+=n[0].length,n[1]||n[0]):null}},xe=function(t){var e,n,r
...
return s+='"',JSON.parse(s)}}}(_e),ke=function(t){return t('"')}(xe),Se=function(t){return t("'")}(xe),Te=function(t,e,n){return function(r){var i,o
return i=r.pos,r.getStringMatch('"')?(o=n(r),r.getStringMatch('"')?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):r.getStringMatch("'")?(o=e(r),r.getStringMatch("'")?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):null}}(F,ke,Se),Oe=function(t,e){var n=e(/^(?:[+-]?)(?:(?:(?:0|[1-9]\d*)?\.\d+)|(?:(?:0|[1-9]\d*)\.)|(?:0|[1-9]\d*))(?:[eE][+-]?\d+)?/)
return function(e){var r
return(r=n(e))?{t:t.NUMBER_LITERAL,v:r}:null}}(F,_e),Ae=function(t){return t(/^[a-zA-Z_$][a-zA-Z_$0-9]*/)}(_e),Ne=function(t,e,n){var r=/^[a-zA-Z_$][a-zA-Z_$0-9]*$/
return function(i){var o
return(o=t(i))?r.test(o.v)?o.v:'"'+o.v.replace(/"/g,'\\"')+'"':(o=e(i))?o.v:(o=n(i))?o:void 0}}(Te,Oe,Ae),Re=function(t,e,n,r){function i(t){var e,n,i
...
return n.result?{value:n.result.v,remaining:n.remaining()}:null}}(we,Ee,Te,Ne),Ce=function(t,e,n){function r(t){return"string"==typeof t?t:JSON.stringify(t)}var i=function(e){this.type=t.INTERPOLATOR,n.init(this,e)}
return i.prototype={update:n.update,resolve:n.resolve,reassign:n.reassign,render:function(t){this.value=t,this.parentFragment.bubble()},teardown:function(){e(this)},toString:function(){return void 0==this.value?"":r(this.value)}},i}(F,Kt,ne),Le=function(t,e,n,r,i){var o,s
...
this.length=0},bubble:function(){this.value=this.fragments.join(""),this.parentFragment.bubble()},render:function(t){var e;(e=this.root._wrapped[this.keypath])&&(t=e.get()),n(this,t),this.parentFragment.bubble()},createFragment:function(t){return new s(t)},toString:function(){return this.fragments.join("")}},o}(F,ne,oe,Kt,w),Ie=function(t){var e=function(e){this.type=t.TEXT,this.text=e}
return e.prototype={toString:function(){return this.text},reassign:function(){},teardown:function(){}},e}(F),je=function(t,e){return function(){var n,r,i,o,s,a,u
...
t(s),this.argsList=[i]}this.dirty=!1}return this.argsList}}(Z,Re),Pe=function(t,e,n,r,i,o,s,a){var u=function(t){n.init(this,t)}
...
if("value"!==this.name||"select"!==this.element.lcName)return"name"===this.name&&"input"===this.element.lcName&&(e=this.interpolator)?"name={{"+(e.keypath||e.ref)+"}}":this.fragment?(t=this.fragment.toString(),this.name+"="+JSON.stringify(t)):this.name+"="+JSON.stringify(this.value)}},c}(R,F,pe,de,ge,ve,ye,be,Pe),Fe=function(t){return function(e,n,r){var i=new t({element:e,name:n,value:r,root:e.root,pNode:e.node})
e.attributes.push(e.attributes[n]=i),"name"!==n&&i.update()}}(Me),Be=function(t){return function(e,n){var r
e.attributes=[]
for(r in n)n.hasOwnProperty(r)&&t(e,r,n[r])
return e.attributes}}(Fe),De=function(t){for(var e=[],n=t.length;n--;)e[n]=t[n]
return e},Ue=function(t){return function(e,n){return e.matchingStaticNodes[n]||(e.matchingStaticNodes[n]=t(e.node.querySelectorAll(n))),e.matchingStaticNodes[n]}}(De),Ve=function(t,e,n,r,i){function o(t){var e,n,i,o,s,a,u
i=t.node,e=t.root
...
this.actual=t,this.ready=!0},update:function(){this.actual.update?this.actual.update.apply(this.root,this.params):(this.actual.teardown(!0),this.init())},teardown:function(t){this.actual.teardown(),!t&&this.fragment&&this.fragment.teardown()}},n}(Z,Pe),We=function(t,e){return function(n,r,i){var o=new e(n,r,i)
o.fn&&(i.decorator=o,t.addDecorator(i.decorator))}}(R,qe),ze=function(t,e){var n,r,i,o,s,a,u,c,h
...
e.index=n.index,e.keypath=n.keypath,e.context=n.root.get(n.keypath),n.events[t].fire(e)}},n}(Z,Pe),Ke=function(t){return function(e,n){var r,i,o
for(i in n)if(n.hasOwnProperty(i))for(o=i.split("-"),r=o.length;r--;)t(e,o[r],n[i])}}(ze),$e=function(t){var e,n,r,i,o
e=t.root
do for(n=e._liveQueries,r=n.length;r--;)i=n[r],o=n[i],o._test(t)&&(t.liveQueries||(t.liveQueries=[])).push(o)
while(e=e._parent)},He=function(){if(this._inited)throw new Error("Cannot initialize a transition more than once")
this._inited=!0,this._fn.apply(this.root,[this].concat(this.params))},Ge=function(t,e,n){var r,i
...
break}return r[t]}}(u,m,a),Ye=function(t,e,n,r){var i
...
return i}}(r,u,L,Ge),Je=function(t){return function(e,n){var r
if("string"==typeof e)this.node.style[t(e)]=n
else for(r in e)e.hasOwnProperty(r)&&(this.node.style[t(r)]=e[r])
return this}}(Ge),Qe=function(t){return t.replace(/-([a-zA-Z])/g,function(t,e){return e.toUpperCase()})},Xe=function(t,e,n){function r(t){return t}var i=function(i){var o
...
return this.running?t>this.end?(this.step&&this.step(1),this.complete&&this.complete(1),!1):(e=t-this.start,n=this.easing(e/this.duration),this.step&&this.step(n),!0):!1},stop:function(){this.abort&&this.abort(),this.running=!1}},i}(Z,b,C),Ze=function(t){var e=new RegExp("^-(?:"+t.join("|")+")-")
return function(t){return t.replace(e,"")}}(m),tn=function(t){var e=new RegExp("^(?:"+t.join("|")+")([A-Z])")
return function(t){var n
return t?(e.test(t)&&(t="-"+t),n=t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})):""}}(m),en=function(t,e,n,r,i,o,s,a,u){var c,h,f,l,p,d,g,v={},m={}
...
for(r=y.length;r--;)n=y[r],t.node.style[n.name]=n.interpolator(e)},complete:function(){w=!0,_()}}):w=!0,h.length||(t.node.removeEventListener(f,l,!1),E=!0,_())},0)},c.delay||0)}}(u,Z,a,Qe,nt,Xe,Ge,Ze,tn),nn=function(t,e,n,r,i,o){var s
...
return a&&(n("t.animateStyle returns a Promise as of 0.4.0. Transition authors should do t.animateStyle(...).then(callback)"),h.then(a)),h}}(r,u,Z,g,Ge,en),rn=function(t,e){var n
for(n in e)!e.hasOwnProperty(n)||n in t||(t[n]=e[n])
return t},on=function(t){return function(e,n){return"number"==typeof e?e={duration:e}:"string"==typeof e?e="slow"===e?{duration:600}:"fast"===e?{duration:200}:{duration:400}:e||(e={}),t(e,n)}}(rn),sn=function(){this.originalStyle?this.node.setAttribute("style",this.originalStyle):(this.node.getAttribute("style"),this.node.removeAttribute("style"))},an=function(t,e,n,r,i,o,s,a){var u
...
return void t(u)}},u.prototype={init:n,getStyle:r,setStyle:i,animateStyle:o,processParams:s,resetStyle:a},u}(Z,Pe,He,Ye,Je,nn,on,sn),un=function(t,e){return function(n,r,i,o){var s,a,u
!r.transitionsEnabled||r._parent&&!r._parent.transitionsEnabled||(s=new e(n,r,i,o),s._fn&&(a=s.node,(u=a._ractive.transition)&&u.complete(),a._ractive.transition=s,t.addTransition(s)))}}(R,an),cn=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v){function m(t){do if("select"===t.lcName)return t
...
for(a in s.events)for(u=s.events[a].proxies,o=u.length;o--;)c=u[o],"object"==typeof c.n&&c.a.reassign(e,n,r,i),c.d&&c.d.reassign(e,n,r,i);(h=s.binding)&&h.keypath.substr(0,r.length)===r&&(f=s.root._twowayBindings[h.keypath],f.splice(f.indexOf(h),1),h.keypath=h.keypath.replace(r,i),f=s.root._twowayBindings[h.keypath]||(s.root._twowayBindings[h.keypath]=[]),f.push(h))}if(this.fragment&&this.fragment.reassign(e,n,r,i),l=this.liveQueries)for(p=this.root,o=l.length;o--;)l[o]._makeDirty()}}(Dt),ln="area base br col command doctype embed hr img input keygen link meta param source track wbr".split(" "),pn=function(t,e){function n(t){var n,r,i,o,s
...
return"option"===this.lcName&&n(this)&&(e+=" selected"),"input"===this.lcName&&r(this)&&(e+=" checked"),e+=">",this.html?e+=this.html:this.fragment&&(e+=this.fragment.toString()),-1===t.indexOf(this.descriptor.e)&&(e+="</"+this.descriptor.e+">"),this.stringifying=!1,e}}(ln,L),dn=function(t){return function(e){var n
return t(this.node,e)?this.node:this.html&&(n=this.node.querySelector(e))?n:this.fragment&&this.fragment.find?this.fragment.find(e):void 0}}(at),gn=function(t){return function(e,n){var r,i
n._test(this,!0)&&n.live&&(this.liveQueries||(this.liveQueries=[])).push(n),this.html&&(r=t(this,e),n.push.apply(n,r),n.live&&!i&&(this.liveQueries||(this.liveQueries=[])).push(n)),this.fragment&&this.fragment.findAll(e,n)}}(Ue),vn=function(t){return this.fragment?this.fragment.findComponent(t):void 0},mn=function(t,e){this.fragment&&this.fragment.findAllComponents(t,e)},yn=function(){var t=this.attributes
...
if(t.checked&&t.checked.bind())return}if(t.value&&t.value.bind())return}},bn=function(t,e,n,r,i,o,s,a,u,c,h){var f=function(t,e){n(this,t,e)}
...
t.end()}},teardown:r,reassign:i,firstNode:function(){return this.node},findNextNode:function(){return null},bubble:function(){},toString:o,find:s,findAll:a,findComponent:u,findAllComponents:c,bind:h},f}(R,_,cn,hn,fn,pn,dn,gn,vn,mn,yn),wn={missingParser:"Missing Ractive.parse - cannot parse template. Either preparse or use the version that includes the parser"},En={},_n=function(t){var e,n,r
...
r+=t.substr(0,e),t=t.substring(n+3)}return r},xn=function(t){return function(e){var n,r,i,o,s,a
...
return e}}(F),kn=function(t){return function(e){var n,r,i,o
...
return e}}(F),Sn=function(t){var e=t(/^[^\s=]+/)
return function(t){var n,r,i
return t.getStringMatch("=")?(n=t.pos,t.allowWhitespace(),(r=e(t))?(t.allowWhitespace(),(i=e(t))?(t.allowWhitespace(),t.getStringMatch("=")?[r,i]:(t.pos=n,null)):(t.pos=n,null)):(t.pos=n,null)):null}}(_e),Tn=function(t){var e={"#":t.SECTION,"^":t.INVERTED,"/":t.CLOSING,">":t.PARTIAL,"!":t.COMMENT,"&":t.TRIPLE}
return function(t){var n=e[t.str.charAt(t.pos)]
return n?(t.pos+=1,n):null}}(F),On=function(t,e,n){function r(e){for(var n=[];e.t===t.MEMBER&&e.r.t===t.REFINEMENT;)n.unshift(e.r),e=e.x
...
return h.t===t.REFERENCE?u.ref=h.n:h.t===t.NUMBER_LITERAL&&o.test(h.v)?u.ref=h.v:(g=r(h))?u.keypathExpression=g:u.expression=h,f=i(e),null!==f&&(u.indexRef=f),u}}(F,_e,Tn),An=function(t,e,n){function r(r,i){var o,s,a=r.pos
...
return r(this,t)||r(this,!t)}}(F,Sn,On),Nn=function(t){return function(){var e,n,r
if(!this.getStringMatch("<!--"))return null
if(n=this.remaining(),r=n.indexOf("-->"),-1===r)throw new Error('Unexpected end of input (expected "-->" to close comment)')
return e=n.substr(0,r),this.pos+=r+3,{type:t.COMMENT,content:e}}}(F),Rn=function(t,e){var n,r,i
for(n=e.length;n--;){if(r=t.indexOf(e[n]),!r)return 0;-1!==r&&(!i||i>r)&&(i=r)}return i||-1},Cn=function(t,e,n){var r,i,o,s,a,u,c,h,f,l,p,d,g
...
return o?(e.pos+=o,{type:t.TEXT,value:s.substr(0,o)}):null},r}(F,_e,Rn),Ln=function(t,e){return function(){var n,r,i
return r=this.remaining(),i=this.inside?"</"+this.inside:"<",(n=this.inside&&!this.interpolate[this.inside]?r.indexOf(i):e(r,[i,this.delimiters[0],this.tripleDelimiters[0]]))?(-1===n&&(n=r.length),this.pos+=n,{type:t.TEXT,value:r.substr(0,n)}):null}}(F,Rn),In=function(t){return function(e){var n=e.remaining()
return"true"===n.substr(0,4)?(e.pos+=4,{t:t.BOOLEAN_LITERAL,v:"true"}):"false"===n.substr(0,5)?(e.pos+=5,{t:t.BOOLEAN_LITERAL,v:"false"}):null}}(F),jn=function(t,e){return function(n){var r,i,o
return r=n.pos,n.allowWhitespace(),i=e(n),null===i?(n.pos=r,null):(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),o=n.getExpression(),null===o?(n.pos=r,null):{t:t.KEY_VALUE_PAIR,k:i,v:o}):(n.pos=r,null))}}(F,Ne),Pn=function(t){return function e(n){var r,i,o,s
return r=n.pos,o=t(n),null===o?null:(i=[o],n.getStringMatch(",")?(s=e(n),s?i.concat(s):(n.pos=r,null)):i)}}(jn),Mn=function(t,e){return function(n){var r,i
return r=n.pos,n.allowWhitespace(),n.getStringMatch("{")?(i=e(n),n.allowWhitespace(),n.getStringMatch("}")?{t:t.OBJECT_LITERAL,m:i}:(n.pos=r,null)):(n.pos=r,null)}}(F,Pn),Fn=function di(t){var e,n,r,i
if(e=t.pos,t.allowWhitespace(),r=t.getExpression(),null===r)return null
if(n=[r],t.allowWhitespace(),t.getStringMatch(",")){if(i=di(t),null===i)return t.pos=e,null
n=n.concat(i)}return n},Bn=function(t,e){return function(n){var r,i
return r=n.pos,n.allowWhitespace(),n.getStringMatch("[")?(i=e(n),n.getStringMatch("]")?{t:t.ARRAY_LITERAL,m:i}:(n.pos=r,null)):(n.pos=r,null)}}(F,Fn),Dn=function(t,e,n,r,i){return function(o){var s=t(o)||e(o)||n(o)||r(o)||i(o)
return s}}(Oe,In,Te,Mn,Bn),Un=function(t,e,n){var r,i,o,s
...
for(;f=r(e)||i(e);)h+=f
return e.getStringMatch("(")&&(l=h.lastIndexOf("."),-1!==l?(h=h.substr(0,l),e.pos=o+h.length):e.pos-=1),{t:t.REFERENCE,n:h}}}(F,_e,Ae),Vn=function(t){return function(e){var n,r
return n=e.pos,e.getStringMatch("(")?(e.allowWhitespace(),(r=e.getExpression())?(e.allowWhitespace(),e.getStringMatch(")")?{t:t.BRACKETED,x:r}:(e.pos=n,null)):(e.pos=n,null)):null}}(F),qn=function(t,e,n){return function(r){return t(r)||e(r)||n(r)}}(Dn,Un,Vn),Wn=function(t,e){return function(n){var r,i,o
if(r=n.pos,n.allowWhitespace(),n.getStringMatch(".")){if(n.allowWhitespace(),i=e(n))return{t:t.REFINEMENT,n:i}
n.expected("a property name")}return n.getStringMatch("[")?(n.allowWhitespace(),o=n.getExpression(),o||n.expected("an expression"),n.allowWhitespace(),n.getStringMatch("]")||n.expected('"]"'),{t:t.REFINEMENT,x:o}):null}}(F,Ae),zn=function(t,e,n,r){return function(i){var o,s,a,u
...
break}s={t:t.INVOCATION,x:s},u&&(s.o=u)}return s}}(F,qn,Fn,Wn),Kn=function(t,e){var n,r
...
n=a}(),n}(F,zn),$n=function(t,e){var n,r
...
n=a}(),n}(F,Kn),Hn=function(t,e){return function(n){var r,i,o,s
return(i=e(n))?(r=n.pos,n.allowWhitespace(),n.getStringMatch("?")?(n.allowWhitespace(),(o=n.getExpression())?(n.allowWhitespace(),n.getStringMatch(":")?(n.allowWhitespace(),s=n.getExpression(),s?{t:t.CONDITIONAL,o:[i,o,s]}:(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):(n.pos=r,i)):null}}(F,$n),Gn=function(t){return function(){return t(this)}}(Hn),Yn=function(t,e,n,r,i,o,s){var a
...
return e=t.replace(i,function(t,e){return n[e]?String.fromCharCode(n[e]):t}),e=e.replace(o,function(t,e){return String.fromCharCode(a(parseInt(e,16)))}),e=e.replace(s,function(t,e){return String.fromCharCode(a(e))})},c=/\s+/g,e}(F),Xn=function(t,e){return function(n,r){return n.type===t.TEXT?(this.pos+=1,new e(n,r)):null}}(F,Qn),Zn=function(t){var e
return e=function(t){this.content=t.content},e.prototype={toJSON:function(){return{t:t.COMMENT,f:this.content}},toString:function(){return"<!--"+this.content+"-->"}},e}(F),tr=function(t,e){return function(n){return n.type===t.COMMENT?(this.pos+=1,new e(n,this.preserveWhitespace)):null}}(F,Zn),er=function(t,e){function n(t){return JSON.stringify(String(t))}function r(n,i){var o,s
...
return o.prototype={toJSON:function(){return this.json||(this.json={r:this.refs,s:this.str}),this.json}},o}(F,tt),nr=function(t,e){function n(n){return n.n?n.n:n.x.t===t.STRING_LITERAL||n.x.t===t.NUMBER_LITERAL?n.x.v:n.x.t===t.REFERENCE?n.x:new e(n.x).toJSON()}var r
return r=function(t){this.json={r:t.r,m:t.m.map(n)}},r.prototype={toJSON:function(){return this.json}},r}(F,er),rr=function(t,e,n){var r=function(r,i){this.type=r.type===t.TRIPLE?t.TRIPLE:r.mustacheType,r.ref&&(this.ref=r.ref),r.keypathExpression&&(this.keypathExpr=new e(r.keypathExpression)),r.expression&&(this.expr=new n(r.expression)),i.pos+=1}
return r.prototype={toJSON:function(){var t
return this.json?this.json:(t={t:this.type},this.ref&&(t.r=this.ref),this.keypathExpr&&(t.kx=this.keypathExpr.toJSON()),this.expr&&(t.x=this.expr.toJSON()),this.json=t,t)},toString:function(){return!1}},r}(F,nr,er),ir=function(t){var e,n,r,i=""
if(!t)return""
for(n=0,r=t.length;r>n;n+=1){if(e=t[n].toString(),e===!1)return!1
i+=e}return i},or=function(t){return function(e,n,r){var i,o
return r||n||(i=t(e),i===!1)?o=e.map(function(t){return t.toJSON(n)}):i}}(ir),sr=function(t,e,n,r,i){function o(t,n){var r=t.ref,i=e(n.ref.trim())
...
return this.json?this.json:(r={t:t.SECTION},this.ref&&(r.r=this.ref),this.indexRef&&(r.i=this.indexRef),this.inverted&&(r.n=!0),this.expr&&(r.x=this.expr.toJSON()),this.keypathExpr&&(r.kx=this.keypathExpr.toJSON()),this.items.length&&(r.f=n(this.items,e)),this.json=r,r)},toString:function(){return!1}},s}(F,v,or,nr,er),ar=function(t,e,n){return function(r){return r.type===t.MUSTACHE||r.type===t.TRIPLE?r.mustacheType===t.SECTION||r.mustacheType===t.INVERTED?new n(r,this):new e(r,this):void 0}}(F,rr,sr),ur={li:["li"],dt:["dt","dd"],dd:["dt","dd"],p:"address article aside blockquote dir div dl fieldset footer form h1 h2 h3 h4 h5 h6 header hgroup hr menu nav ol p pre section table ul".split(" "),rt:["rt","rp"],rp:["rp","rt"],optgroup:["optgroup"],option:["option","optgroup"],thead:["tbody","tfoot"],tbody:["tbody","tfoot"],tr:["tr"],td:["td","th"],th:["td","th"]},cr=function(t){function e(n){var r,i
...
return i.attrs=n,i.proxies=r,i}}(L),hr=function(t,e){return function(n){var r,i,o,s,a,u,c,h
...
return c=c.concat(i),r.name=1===u.length&&u[0].type===t.TEXT?u[0].value:u,c.length&&(1===c.length&&c[0].type===t.TEXT?(h=e("["+c[0].value+"]"),r.args=h?h.value:c[0].value):r.dynamicArgs=c),r}}(F,Re),fr=function(t,e){var n
...
return t?this.getText(t)||this.getMustache(t):null},getText:t,getMustache:e,next:function(){return this.tokens[this.pos]}},n}(Xn,ar),lr=function(t,e,n){var r
return r=function(e){var n=new t(e)
this.stubs=n.result},r.prototype={toJSON:function(t){var e
return this["json_"+t]?this["json_"+t]:e=this["json_"+t]=n(this.stubs,t)},toString:function(){return void 0!==this.str?this.str:(this.str=e(this.stubs),this.str)}},r}(fr,ir,or),pr=function(t){return function(e){var n,r
if("string"==typeof e.name){if(!e.args&&!e.dynamicArgs)return e.name
r=e.name}else r=new t(e.name).toJSON()
return n={n:r},e.args?(n.a=e.args,n):(e.dynamicArgs&&(n.d=new t(e.dynamicArgs).toJSON()),n)}}(lr),dr=function(t,e,n){return function(r){var i,o,s,a,u,c,h
...
return this.intro&&(i.t1=n(this.intro)),this.outro&&(i.t2=n(this.outro)),this.decorator&&(i.o=n(this.decorator)),this["json_"+r]=i,i}}(F,or,pr),gr=function(t,e){var n
...
""!==u&&(s+="=",s+=/[\s"'=<>`]/.test(u)?'"'+u.replace(/"/g,"&quot;")+'"':u)}r+=s}return this.selfClosing&&!h?(r+="/>",this.str=r):(r+=">",h?this.str=r:(r+=c,r+="</"+this.tag+">",this.str=r))}}(ir,ln),vr=function(t,e,n,r,i,o,s,a,u){var c,h,f,l,p,d=/^\s+/,g=/\s+$/
...
return e},c}(F,ln,Z,ur,cr,hr,dr,gr,lr),mr=function(t){return function(e){return this.options.sanitize&&this.options.sanitize.elements&&-1!==this.options.sanitize.elements.indexOf(e.name.toLowerCase())?null:new t(e,this,this.preserveWhitespace)}}(vr),yr=function(t,e,n,r,i){var o
...
return e?this.getText(e,this.preserveWhitespace||t)||this.getComment(e)||this.getMustache(e)||this.getElement(e):null},getText:t,getComment:e,getMustache:n,getElement:r,next:function(){return this.tokens[this.pos]}},o}(Xn,tr,ar,mr,or),br=function(t,e,n){var r,i,o,s,a
...
if(r(t)){n[e]=t.main
for(i in t.partials)t.partials.hasOwnProperty(i)&&(n[i]=t.partials[i])}else n[e]=t},h=function(t){return 1===t.length&&"string"==typeof t[0]?t[0]:t},a}(wn,u,Z,tt,En,br,wr),_r=function(t,e){var n
return e?n=t.split("\n").map(function(t,n){return n?e+t:t}).join("\n"):t},xr=function(t,e,n,r){var i,o
...
return e=this.fragment.toString(),r=this.parentFragment.items[this.index-1],r&&r.type===t.TEXT?(i=r.descriptor.split("\n").pop(),(o=/^\s+$/.exec(i))?n(e,o[0]):e):e},find:function(t){return this.fragment.find(t)},findAll:function(t,e){return this.fragment.findAll(t,e)},findComponent:function(t){return this.fragment.findComponent(t)},findAllComponents:function(t,e){return this.fragment.findAllComponents(t,e)}},i}(F,Er,_r,w),kr=function(t,e){var n=function(t,n,r){this.parentFragment=t.parentFragment,this.component=t,this.key=n,this.fragment=new e({descriptor:r,root:t.root,owner:this}),this.selfUpdating=this.fragment.isSimple(),this.value=this.fragment.getValue()}
...
this.component.instance.set(this.key,t),this.value=t},teardown:function(){this.fragment.teardown()}},n}(R,Pe),Sr=function(t,e,n,r,i){function o(o,s,a,u){var c,h,f,l,p,d
...
return i}}(F,Re,T,X,kr),Tr=function(){function t(t,e){var n,r,i
...
return a=e.parentFragment,c=e.root,u={content:o||[]},h=t(c,n.defaults.adapt,n.adaptors),s=new n({el:a.pNode,append:!0,data:r,partials:u,magic:c.magic||n.defaults.magic,modifyArrays:c.modifyArrays,_parent:c,_component:e,adapt:h}),i&&(s.insert(i),s.fragment.pNode=s.el=a.pNode),s}}(),Or=function(t,e,n){return function(r,i){i.forEach(function(i){var o,s
t(r,r.root,i.parentKeypath,i.childKeypath),o=e(r.instance,i.childKeypath),s=e(r.root,i.parentKeypath),void 0!==o&&void 0===s&&n(r.root,i.parentKeypath,o)})}}(Y,X,U),Ar=function(t){function e(e,r,i,o){if("string"!=typeof o){if(r.debug)throw new Error(n)
...
for(r in n)n.hasOwnProperty(r)&&e(t.instance,t.root,r,n[r])}}(Z),Nr=function(t){var e,n
for(e=t.root;e;)(n=e._liveComponentQueries[t.name])&&n.push(t.instance),e=e._parent},Rr=function(t,e,n,r,i,o,s){return function(a,u,c){var h,f,l,p,d
...
d=[],p=n(a,l.data||{},u.descriptor.a,d),r(a,l,p,c,u.descriptor.f),i(a,d),o(a,u.descriptor.v),(u.descriptor.t1||u.descriptor.t2||u.descriptor.o)&&e('The "intro", "outro" and "decorator" directives have no effect on components'),s(a)}}(F,Z,Sr,Tr,Or,Ar,Nr),Cr=function(t,e){function n(t){var e,n
e=t.root
...
return e}},l.DomFragment=p,p}(F,at,Vt,qt,zt,re,ce,he,bn,xr,Cr,Lr,w),jr=function(t,e,n){function r(t){for(var e;e=t._childInitQueue.pop();)e.instance.init&&e.instance.init(e.options),r(e.instance)}return function(i,o){if(this._rendering=!0,t.start(this,o),!this._initing)throw new Error("You cannot call ractive.render() directly!")
this.constructor.css&&e.add(this.constructor),this.fragment=new n({descriptor:this.template,root:this,owner:this,pNode:i}),i&&i.appendChild(this.fragment.docFrag),this._parent&&this._parent._rendering||r(this),delete this._rendering,t.end()}}(R,_,Ir),Pr=function(t){return function(){return t("renderHTML() has been deprecated and will be removed in a future version. Please use toHTML() instead"),this.toHTML()}}(Z),Mr=function(t,e,n,r){return function(i,o){var s,a,u
...
return s=new t(function(t){a=t}),o&&s.then(o),e.start(this,a),(u=this._wrapped[""])&&u.reset?u.reset(i)===!1&&(this.data=i):this.data=i,n(this,""),r(this,""),e.end(),this.fire("reset",i),s}}(g,R,B,A),Fr=function(t,e,n,r,i){return function(o,s,a){var u,c,h
...
return t.end(),a&&c.then(a.bind(this)),c}}(R,tt,v,g,U),Br=function(t){return function(e,n){return t(this,e,void 0===n?-1:-n)}}(l),Dr=function(t,e,n,r,i){return function(o){var s,a,u,c,h,f,l,p
...
return n.end(),o&&a.then(o.bind(this)),a}}(F,_,R,g,B),Ur=function(){return this.fragment.toString()},Vr=function(t,e){var n
{if("string"==typeof t)return n=this.get(t),this.set(t,!n,e)
if(this.debug)throw new Error("Bad arguments")}},qr=function(t,e,n,r){return function(i,o){var s,a
return"function"==typeof i?(o=i,i=""):i=i||"",s=new e(function(t){a=t}),t.start(this,a),n(this,i),r(this,i),t.end(),this.fire("update",i),o&&s.then(o.bind(this)),s}}(R,g,B,A),Wr=function(t,e,n){function r(t,i,o,s,a){var u,c,h,f,l,p
...
this.set(i)}}(x,me,d),zr=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v,m,y,b,w,E,_,x){return{add:t,animate:e,detach:n,find:r,findAll:i,findAllComponents:o,findComponent:s,fire:a,get:u,insert:c,merge:h,observe:f,off:l,on:p,render:d,renderHTML:g,reset:v,set:m,subtract:y,teardown:b,toHTML:w,toggle:E,update:_,updateModel:x}}(p,it,ot,st,vt,mt,yt,bt,Et,xt,Tt,Ct,Lt,It,jr,Pr,Mr,Fr,Br,Dr,Ur,Vr,qr,Wr),Kr={},$r={linear:function(t){return t},easeIn:function(t){return Math.pow(t,3)},easeOut:function(t){return Math.pow(t-1,3)+1},easeInOut:function(t){return(t/=.5)<1?.5*Math.pow(t,3):.5*(Math.pow(t-2,3)+2)}},Hr=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(t){var e,n
return e=16*Math.random()|0,n="x"==t?e:3&e|8,n.toString(16)})},Gr=function(t){for(var e,n,r=Array.prototype.slice.call(arguments,1);n=r.shift();)for(e in n)n.hasOwnProperty(e)&&(t[e]=n[e])
return t},Yr=["adaptors","components","decorators","easing","events","interpolators","partials","transitions","data"],Jr=function(){function t(t){return t.trim?t.trim():t.replace(/^\s+/,"").replace(/\s+$/,"")}function e(t){return t.str}var n=/(?:^|\})?\s*([^\{\}]+)\s*\{/g,r=/\/\*.*?\*\//g,i=/((?:(?:\[[^\]+]\])|(?:[^\s\+\>\~:]))+)((?::[^\s\+\>\~]+)?\s*[\s\+\>\~]?)\s*/g
...
return r=n.split(",").map(t),i=r.map(u).join(", ")+" ",e.replace(n,i)})}}(),Qr=function(t,e,n,r){return function(i,o){t.forEach(function(t){o[t]&&(i[t]=e(o[t]))}),n(i,"defaults",{value:e(o.defaults)}),o.css&&n(i,"css",{value:o.defaults.noCssTransform?o.css:r(o.css,i._guid)})}}(Yr,jt,c,Jr),Xr=function(t,e){return/_super/.test(t)?function(){var n,r=this._super
return this._super=e,n=t.apply(this,arguments),this._super=r,n}:t},Zr=function(t,e){var n
for(n in e)e.hasOwnProperty(n)&&(t[n]=e[n])
return t},ti=function(t,e,n,r,i,o){var s={}
...
u.css&&n(a,"css",{value:a.defaults.noCssTransform?u.css:o(u.css,a._guid)})}}(i,Yr,c,Xr,Zr,Jr),ei=function(t,e){return function(n,r){t(n.defaults.template)&&(n.partials||(n.partials={}),e(n.partials,n.defaults.template.partials),r.partials&&e(n.partials,r.partials),n.defaults.template=n.defaults.template.main)}}(tt,Zr),ni=function(t,e,n){return function(r){var i
...
r.defaults.template=n(i.innerHTML,r)}else r.defaults.template=n(r.defaults.template,r.defaults)}}}(wn,u,br),ri=function(t,e){return function(n){var r
...
n.partials[r]=e(n.partials[r],n)}}}(wn,br),ii=function(){function t(t){var n="var __ractive=this;return("+t.replace(e,function(t,e){return'__ractive.get("'+e+'")'})+")"
return new Function(n)}var e=/\$\{([^\}]+)\}/g
return function(e){return"function"==typeof e?{get:e}:"string"==typeof e?{get:t(e)}:("object"==typeof e&&"string"==typeof e.get&&(e={get:t(e.get),set:e.set}),e)}}(),oi=function(t,e,n){var r=function(t,n){this.root=t.ractive,this.keypath=n,this.priority=0,this.computation=t,e(this)}
return r.prototype={update:function(){var e
e=this.root.get(this.keypath),t(e,this.value)||this.computation.bubble()},teardown:function(){n(this)}},r}(d,H,G),si=function(t,e,n,r){function i(t,e,n){var i,o,s
...
try{o=this.getter.call(e)}catch(a){e.debug&&t('Failed to compute "'+this.key+'": '+a.message||a),s=!0}i(this,this.watchers,e._captured),e._captured=r,s||(this.setting=!0,this.value=o,n(e,this.key,o),this.setting=!1),this.deferred=!1},bubble:function(){this.watchers.length<=1?this.update():this.deferred||(e.addComputation(this),this.deferred=!0)}},o}(Z,R,U,oi),ai=function(t,e){return function(n,r){var i,o
for(i in r)o=t(r[i]),n._computations[i]=new e(n,i,o)}}(ii,si),ui=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v){var m=["adapt","modifyArrays","magic","twoway","lazy","debug","isolated"]
...
h(x)&&(a(y.partials,x.partials),x=x.main),x&&1===x.length&&"string"==typeof x[0]&&(x=x[0]),y.template=x,s(y.partials,b.partials),y.parseOptions={preserveWhitespace:b.preserveWhitespace,sanitize:b.sanitize,stripComments:b.stripComments},y.transitionsEnabled=b.noIntro?!1:b.transitionsEnabled,t&&!y.el&&(y.el=document.createDocumentFragment()),y.el&&!b.append&&(y.el.innerHTML=""),k=new p(function(t){S=t}),y.render(y.el,S),b.complete&&k.then(b.complete.bind(y)),y.transitionsEnabled=b.transitionsEnabled,y._initing=!1}}(u,wn,i,Yr,Z,jt,Gr,rn,h,_t,tt,L,Hr,g,z,br,ai),ci=function(t,e,n){return function(r,i,o){t.keys.forEach(function(t){var n=o[t],r=i.defaults[t]
"function"==typeof n&&"function"==typeof r&&(o[t]=e(n,r))}),r.beforeInit&&r.beforeInit(o),n(r,o),o._parent&&o._parent._rendering?o._parent._childInitQueue.push({instance:r,options:o}):r.init&&r.init(o)}}(i,Xr,ui),hi=function(t,e,n,r,i,o,s,a,u,c,h){var f
...
return"undefined"!=typeof window&&window.Node&&!window.Node.prototype.contains&&window.HTMLElement&&window.HTMLElement.prototype.contains&&(window.Node.prototype.contains=window.HTMLElement.prototype.contains),t}(fi,w,r)
"undefined"!=typeof e&&e.exports?e.exports=li:"function"==typeof define&&define.amd&&define(function(){return li}),t.Ractive=li,li.noConflict=function(){return t.Ractive=n,li}}("undefined"!=typeof window?window:this)},{}],77:[function(t,e,n){e.exports=function(t,e){for(var n=0,r=e.indexOf(t);-1!==r;)n++,r=e.indexOf(t,r+1)
return n}},{}],78:[function(t,e,n){function r(){return Object.create(new u)}function i(t,e){var n=Object.create(t),r=0
return e.forEach(function(t){var e,i,o=t.split("=")
o.length>1?(e=o[0],i=o[1]):(r++,e=r,i=o[0]),n[e]=i}),n}function o(t){var e=t.data
return e||(e=t.ractive?t.ractive.get():{}),t.templateElements=[],t.html=t.html.replace(/::([^:]+)::/gm,function(n,o,u,c){var h=a("<code",c.substr(0,u)),f=a("</code",c.substr(0,u))
if(h!==f)return n
var l=r(),p=o.split("|")
return l.postName=p.shift(0),l.elementId=s.generateId(l.postName),l.data=i(e,p),t.templateElements.push(l),s.generatePostDiv(l.elementId)}),t}var s=t("./templateToolbox"),a=t("./numberOfOccurrances"),u=t("events").EventEmitter
e.exports=o},{"./numberOfOccurrances":77,"./templateToolbox":79,events:90}],79:[function(t,e,n){function r(t){return t.metadata.markdown!==!1?f.makeHtml(t.content):t.content}function i(){return"xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g,function(t){var e=16*Math.random()|0,n="x"==t?e:3&e|8
return n.toString(16)})}function o(t){return"noddity_post_"+t+"_"+i()}function s(t){var e=l.exec(t)
return null!==e?e[1]:void 0}function a(t){return l.test(t)}function u(t){return'<span class="noddity-template" id="'+t+'"></span>'}function c(t,e){var n=Object.create(e),r=0
return t.forEach(function(t){var e,i,o=t.split("=")
o.length>1?(e=o[0],i=o[1]):(r++,e=r,i=o[0]),n[e]=i}),n}var h=t("pagedown").Converter,f=new h,l=/noddity_post_(.+)_[\da-z]{12}4[\da-z]{19}/
e.exports={generateId:o,getPostName:s,generatePostDiv:u,isAPostDiv:a,getTemplateDataObject:c,htmlify:r}},{pagedown:83}],80:[function(t,e,n){e.exports=function(t){var e={}
return t.on("post changed",function(t,n,r){e[t]&&e[t].forEach(function(t){t.emit("post changed",n)})}),function(t){"undefined"==typeof e[t.postName]&&(e[t.postName]=[]),e[t.postName].push(t),t.ractive.on("teardown",function(){e[t.postName]=e[t.postName].filter(function(e){return e!==t})})}}},{}],81:[function(t,e,n){var r
r="object"==typeof n&&"function"==typeof t?n:{},function(){function t(t){return t}function e(t){return!1}function n(){}function i(){}n.prototype={chain:function(e,n){var r=this[e]
if(!r)throw new Error("unknown hook "+e)
this[e]=r===t?n:function(t){var e=Array.prototype.slice.call(arguments,0)
return e[0]=r.apply(null,e),n.apply(null,e)}},set:function(t,e){if(!this[t])throw new Error("unknown hook "+t)
...
return r=b(A(r)),r=N(r),r=r.replace(/^\n+/g,""),r=r.replace(/\n+$/g,""),r="<pre><code>"+r+"\n</code></pre>","\n\n"+r+"\n\n"+i}),t=t.replace(/~0/,"")}function m(t){return t=t.replace(/(^\n+|\n+$)/g,""),"\n\n~K"+(M.push(t)-1)+"K\n\n"}function y(t){return t=t.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm,function(t,e,n,r,i){var o=r
return o=o.replace(/^([ \t]*)/g,""),o=o.replace(/[ \t]*$/g,""),o=b(o),o=o.replace(/:\/\//g,"~P"),e+"<code>"+o+"</code>"})}function b(t){return t=t.replace(/&/g,"&amp;"),t=t.replace(/</g,"&lt;"),t=t.replace(/>/g,"&gt;"),t=C(t,"*_{}[]\\",!1)}function w(t){return t=t.replace(/([\W_]|^)(\*\*|__)(?=\S)([^\r]*?\S[\*_]*)\2([\W_]|$)/g,"$1<strong>$3</strong>$4"),t=t.replace(/([\W_]|^)(\*|_)(?=\S)([^\r\*_]*?\S)\2([\W_]|$)/g,"$1<em>$3</em>$4")}function E(t){return t=t.replace(/((^[ \t]*>[ \t]?.+\n(.+\n)*\n*)+)/gm,function(t,e){var n=e
...
return i=r.pos,r.matchString('"')?(o=n(r),r.matchString('"')?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):r.matchString("'")?(o=e(r),r.matchString("'")?{t:t.STRING_LITERAL,v:o}:(r.pos=i,null)):null}}(z,J,Q),Z={name:/^[a-zA-Z_$][a-zA-Z_$0-9]*/},tt=function(t,e,n){var r=/^[a-zA-Z_$][a-zA-Z_$0-9]*$/
return function(i){var o
return(o=t(i))?r.test(o.v)?o.v:'"'+o.v.replace(/"/g,'\\"')+'"':(o=e(i))?o.v:(o=i.matchPattern(n.name))?o:void 0}}(X,H,Z),et=function(t,e){return function(n){var r,i,o
return r=n.pos,n.allowWhitespace(),i=e(n),null===i?(n.pos=r,null):(n.allowWhitespace(),n.matchString(":")?(n.allowWhitespace(),o=n.readExpression(),null===o?(n.pos=r,null):{t:t.KEY_VALUE_PAIR,k:i,v:o}):(n.pos=r,null))}}(z,tt),nt=function(t){return function e(n){var r,i,o,s
return r=n.pos,o=t(n),null===o?null:(i=[o],n.matchString(",")?(s=e(n),s?i.concat(s):(n.pos=r,null)):i)}}(et),rt=function(t,e){return function(n){var r,i
return r=n.pos,n.allowWhitespace(),n.matchString("{")?(i=e(n),n.allowWhitespace(),n.matchString("}")?{t:t.OBJECT_LITERAL,m:i}:(n.pos=r,null)):(n.pos=r,null)}}(z,nt),it=function(t){return function e(n){function r(t){o.push(t)}var i,o,s,a
return i=n.pos,n.allowWhitespace(),s=n.readExpression(),null===s?null:(o=[s],n.allowWhitespace(),n.matchString(",")&&(a=e(n),null===a&&n.error(t.expectedExpression),a.forEach(r)),o)}}($),ot=function(t,e){return function(n){var r,i
return r=n.pos,n.allowWhitespace(),n.matchString("[")?(i=e(n),n.matchString("]")?{t:t.ARRAY_LITERAL,m:i}:(n.pos=r,null)):(n.pos=r,null)}}(z,it),st=function(t,e,n,r,i){return function(o){var s=t(o)||e(o)||n(o)||r(o)||i(o)
return s}}(H,G,X,rt,ot),at=function(t,e){var n,r,i,o,s
...
return r.matchString("(")&&(p=f.lastIndexOf("."),-1!==p?(f=f.substr(0,p),r.pos=a+f.length):r.pos-=1),{t:t.REFERENCE,n:f.replace(/^this\./,"./").replace(/^this$/,".")}}}(z,Z),ut=function(t,e){return function(n){var r,i
return r=n.pos,n.matchString("(")?(n.allowWhitespace(),i=n.readExpression(),i||n.error(e.expectedExpression),n.allowWhitespace(),n.matchString(")")||n.error(e.expectedParen),{t:t.BRACKETED,x:i}):null}}(z,$),ct=function(t,e,n){return function(r){return t(r)||e(r)||n(r)}}(st,at,ut),ht=function(t,e,n){return function(r){var i,o,s
if(i=r.pos,r.allowWhitespace(),r.matchString(".")){if(r.allowWhitespace(),o=r.matchPattern(n.name))return{t:t.REFINEMENT,n:o}
r.error("Expected a property name")}return r.matchString("[")?(r.allowWhitespace(),s=r.readExpression(),s||r.error(e.expectedExpression),r.allowWhitespace(),r.matchString("]")||r.error("Expected ']'"),{t:t.REFINEMENT,x:s}):null}}(z,$,Z),ft=function(t,e,n,r,i){return function(o){var s,a,u,c
if(a=e(o),!a)return null
for(;a;)if(s=o.pos,u=r(o))a={t:t.MEMBER,x:a,r:u}
else{if(!o.matchString("("))break
o.allowWhitespace(),c=n(o),o.allowWhitespace(),o.matchString(")")||o.error(i.expectedParen),a={t:t.INVOCATION,x:a},c&&(a.o=c)}return a}}(z,ct,it,ht,$),lt=function(t,e,n){var r,i
...
r=a}(),r}(z,$,ft),pt=function(t,e){var n,r
return r=function(e,n){return function(r){var i,o,s
if(o=n(r),!o)return null
...
o={t:t.INFIX_OPERATOR,s:e,o:[o,s]}}}},function(){var t,i,o,s,a
for(s="* / % + - << >> >>> < <= > >= in instanceof == != === !== & ^ | && ||".split(" "),a=e,t=0,i=s.length;i>t;t+=1)o=r(s[t],a),a=o
n=a}(),n}(z,lt),dt=function(t,e,n){return function(r){var i,o,s,a
return(o=e(r))?(i=r.pos,r.allowWhitespace(),r.matchString("?")?(r.allowWhitespace(),s=r.readExpression(),s||r.error(n.expectedExpression),r.allowWhitespace(),r.matchString(":")||r.error('Expected ":"'),r.allowWhitespace(),a=r.readExpression(),a||r.error(n.expectedExpression),{t:t.CONDITIONAL,o:[o,s,a]}):(r.pos=i,o)):null}}(z,pt,$),gt=function(t,e){function n(t){return JSON.stringify(String(t))}function r(n,i){var o,s
if(n.t===t.REFERENCE&&-1===i.indexOf(n.n)&&i.unshift(n.n),s=n.o||n.m)if(e(s))r(s,i)
else for(o=s.length;o--;)r(s[o],i)
...
return r(t,n),e={r:n,s:i(this,t,n)}}}(z,u),vt=function(t,e,n,r,i){var o,s,a=/^\s+/
...
return r.extend=o.extend,r},t.Parser=o,o}(o,K,s,dt,gt),mt=function(){var t=/^[^\s=]+/,e=/^\s+/
return function(n){var r,i,o
return n.matchString("=")?(r=n.pos,n.allowWhitespace(),(i=n.matchPattern(t))?n.matchPattern(e)?(o=n.matchPattern(t))?(n.allowWhitespace(),n.matchString("=")?[i,o]:(n.pos=r,null)):(n.pos=r,null):null:(n.pos=r,null)):null}}(),yt=[{delimiters:"delimiters",isTriple:!1,isStatic:!1},{delimiters:"tripleDelimiters",isTriple:!0,isStatic:!1},{delimiters:"staticDelimiters",isTriple:!1,isStatic:!0},{delimiters:"staticTripleDelimiters",isTriple:!0,isStatic:!0}],bt=function(t){var e={"#":t.SECTION,"^":t.INVERTED,"/":t.CLOSING,">":t.PARTIAL,"!":t.COMMENT,"&":t.TRIPLE}
return function(t){var n=e[t.str.charAt(t.pos)]
return n?(t.pos+=1,n):null}}(z),wt=function(t){return{"if":t.SECTION_IF,unless:t.SECTION_UNLESS,"with":t.SECTION_WITH,each:t.SECTION_EACH}}(z),Et=null,_t=function(t,e,n){function r(e,n,r){var o
...
n.pos=u}}return r(n,p,h),h.contextPartialExpression&&(h.contextPartialExpression=[r(n,h.contextPartialExpression,{t:t.PARTIAL})]),(d=n.matchPattern(a))&&(h.i=d),h}}(z,bt,wt,Et),xt=function(t,e,n,r,i){function o(t){var e
...
return f=o}(z,mt,yt,_t,wt),kt=function(t){var e="<!--",n="-->"
return function(r){var i,o,s,a,u
return i=r.pos,r.matchString(e)?(s=r.remaining(),a=s.indexOf(n),-1===a&&r.error("Illegal HTML - expected closing comment sequence ('-->')"),o=s.substr(0,a),r.pos+=a+3,u={t:t.COMMENT,c:o},r.includeLinePositions&&(u.p=r.getLinePos(i)),u):null}}(z),St=function(){var t=/^(?:area|base|br|col|command|doctype|embed|hr|img|input|keygen|link|meta|param|source|track|wbr)$/i
return t}(),Tt=function(t,e){var n,r,i
for(n=e.length;n--;){if(r=t.indexOf(e[n]),!r)return 0;-1!==r&&(!i||i>r)&&(i=r)}return i||-1},Ot=function(t){return function(e){var n,r,i,o
return r=e.remaining(),o=e.inside?"</"+e.inside:"<",e.inside&&!e.interpolate[e.inside]?n=r.indexOf(o):(i=[o,e.delimiters[0],e.tripleDelimiters[0],e.staticDelimiters[0],e.staticTripleDelimiters[0]],e.inAttribute===!0?i.push('"',"'","=",">","`"):e.inAttribute&&i.push(e.inAttribute),n=t(r,i)),n?(-1===n&&(n=r.length),e.pos+=n,r.substr(0,n)):null}}(Tt),At=function(t){var e=/^([a-zA-Z]{1,}:?[a-zA-Z0-9\-]*)\s*\>/
return function(n){var r
return n.matchString("</")?(r=n.matchPattern(e))?{t:t.CLOSING_TAG,e:r}:(n.pos-=2,void n.error("Illegal closing tag")):null}}(z),Nt=function(){function t(t){return t?10===t?32:128>t?t:159>=t?r[t-128]:55296>t?t:57343>=t?65533:65535>=t?t:65533:65533}var e,n,r,i
...
return i="#"!==r[0]?n[r]:"x"===r[1]?parseInt(r.substring(2),16):parseInt(r.substring(1),10),i?String.fromCharCode(t(i)):e})}}(Et),Rt=function(t,e,n){function r(t){var e,n,r
...
return c=r}(Tt,xt,Nt),Ct=function(t,e,n){function r(t){var e,r,i
...
return n.result}}(vt,X,tt),Lt=function(t,e,n,r){var i,o=/^([a-zA-Z_$][a-zA-Z_$0-9]*)\(/
...
return l=l.concat(t),l.length||"string"!=typeof f?(e={n:1===f.length&&"string"==typeof f[0]?f[0]:f},1===l.length&&"string"==typeof l[0]?(p=r("["+l[0]+"]"),e.a=p?p.value:l[0].trim()):e.d=l):e=f,e}}(vt,dt,gt,Ct),It=function(t,e,n,r,i,o,s,a){function u(n){var r,i,o,u,h,l,w,E,_,x,k
...
return f=[n,r,u,i,o],l={li:["li"],dt:["dt","dd"],dd:["dt","dd"],p:"address article aside blockquote div dl fieldset footer form h1 h2 h3 h4 h5 h6 header hgroup hr main menu nav ol p pre section table ul".split(" "),rt:["rt","rp"],rp:["rt","rp"],optgroup:["optgroup"],option:["option","optgroup"],thead:["tbody","tfoot"],tbody:["tbody","tfoot"],tfoot:["tbody"],tr:["tr","tbody"],td:["td","th","tr"],th:["td","th","tr"]},h=u}(z,St,xt,kt,Ot,At,Rt,Lt),jt=function(){var t=/^[ \t\f\r\n]+/,e=/[ \t\f\r\n]+$/
return function(n,r,i){var o
r&&(o=n[0],"string"==typeof o&&(o=o.replace(t,""),o?n[0]=o:n.shift())),i&&(o=n[n.length-1],"string"==typeof o&&(o=o.replace(e,""),o?n[n.length-1]=o:n.pop()))}}(),Pt=function(t){function e(t){return"string"==typeof t}function n(e){return e.t===t.COMMENT||e.t===t.DELIMCHANGE}function r(e){return(e.t===t.SECTION||e.t===t.INVERTED)&&e.f}var i,o=/^\s*\r?\n/,s=/\r?\n\s*$/
...
return t}}(z),Mt=function(){var t=/[-\/\\^$*+?.()|[\]{}]/g
return function(e){return e.replace(t,"\\$&")}}(),Ft=function(t,e,n,r,i,o,s,a,u){function c(e,n,r,i,o,u){var h,f,l,p,y,b,w,E,_
...
return f}(W,A,Ft,K,Dt),Vt=function(t,e){function n(t){var e,n=t._config.template
...
return s}(Ut,Ft),qt=function(t){function e(t,e){this.name=t,this.useDefaults=e}function n(t,e){var r,i
...
return n(t,function(t){return t[r.name][e]?t:void 0})}},e}(K,Et),Wt=function(t,e){var n=["adaptors","components","computed","decorators","easing","events","interpolators","partials","transitions"],r=t(n,function(t){return new e(t,"computed"===t)})
return r}(Bt,qt),zt=function(){},Kt=function(t){function e(e,n){var r
if(n in e){var i=e[n]
...
return l.keys=Object.keys(n).concat(o.map(function(t){return t.name})).concat(["css"]),l.parseOptions=i,l.registries=o,l.extend=function(t,e,n){c("extend",t,e,n)},l.init=function(t,e,n){c("init",t,e,n),e._config&&(e._config.options=n)},l.reset=function(t){return l.filter(function(e){return e.reset&&e.reset(t)}).map(function(t){return t.name})},l}(U,q,r,Vt,Dt,Wt,Kt,$t),Gt=function(t,e,n,r){function i(t){return function(){return t}}var o,s=function(t,o,s,a){if(t===o)return i(o)
...
return t.interpolate=s,o=s}(o,B,h,Ht),Yt=function(t,e,n){var r=function(t){var e
this.startTime=Date.now()
for(e in t)t.hasOwnProperty(e)&&(this[e]=t[e])
...
this.running=!1,e=this.root._animations.indexOf(this),-1===e&&t("Animation was not found"),this.root._animations.splice(e,1)}},r}(B,_,Gt),Jt=function(t,e,n,r,i){function o(e,o,s,a){var c,h,f,l
...
y&&y.stop()},i}return r=r||{},r.complete&&i.then(r.complete),r.complete=s,c=o(this,t,n,r),i.stop=function(){c.stop()},i}}(y,g,I,F,Yt),Qt=function(t){return function(){return this.detached?this.detached:(this.el&&t(this.el.__ractive_instances__,this),this.detached=this.fragment.detach(),this.detached)}}(d),Xt=function(t){return this.el?this.fragment.find(t):null},Zt=function(t,e,n){var r,i,o,s,a,u,c,h
...
return r}(A,j,O),te=function(t){return function(e,n){var r=this._isComponentQuery?!this.selector||e.name===this.selector:t(e.node,this.selector)
return r?(this.push(e.node||e.instance),n||this._makeDirty(),!0):void 0}}(Zt),ee=function(){var t,e,n
t=this._root[this._isComponentQuery?"liveComponentQueries":"liveQueries"],e=this.selector,n=t.indexOf(e),-1!==n&&(t.splice(n,1),t[e]=null)},ne=function(){function t(t){var e
return(e=t.parentFragment)?e.owner:t.component&&(e=t.component.parentFragment)?e.owner:void 0}function e(e){var n,r
for(n=[e],r=t(e);r;)n.push(r),r=t(r)
return n}var n
...
if(o=o.component||o,s=s.component||s,f=o.parentFragment,l=s.parentFragment,f===l)return u=f.items.indexOf(o),c=l.items.indexOf(s),u-c||r.length-i.length
if(h=a.fragments)return u=h.indexOf(f),c=h.indexOf(l),u-c||r.length-i.length
throw new Error("An unexpected condition was met while comparing the position of two components. Please file an issue at https://github.com/RactiveJS/Ractive/issues - thanks!")}}(),re=function(t){return function(e,n){var r
return e.compareDocumentPosition?(r=e.compareDocumentPosition(n),2&r?1:-1):t(e,n)}}(ne),ie=function(t,e){return function(){this.sort(this._isComponentQuery?e:t),this._dirty=!1}}(re,ne),oe=function(t){return function(){var e=this
this._dirty||(this._dirty=!0,t.scheduleTask(function(){e._sort()}))}}(_),se=function(t){var e=this.indexOf(this._isComponentQuery?t.instance:t);-1!==e&&this.splice(e,1)},ae=function(t,e,n,r,i,o){return function(s,a,u,c){var h=[]
return t(h,{selector:{value:a},live:{value:u},_isComponentQuery:{value:c},_test:{value:e}}),u?(t(h,{cancel:{value:n},_root:{value:s},_sort:{value:r},_makeDirty:{value:i},_remove:{value:o},_dirty:{value:!1,writable:!0}}),h):h}}(R,te,ee,ie,oe,se),ue=function(t){return function(e,n){var r,i
return this.el?(n=n||{},r=this._liveQueries,(i=r[e])?n&&n.live?i:i.slice():(i=t(this,e,!!n.live,!1),i.live&&(r.push(e),r["_"+e]=i),this.fragment.findAll(e,i),i)):[]}}(ae),ce=function(t){return function(e,n){var r,i
return n=n||{},r=this._liveComponentQueries,(i=r[e])?n&&n.live?i:i.slice():(i=t(this,e,!!n.live,!0),i.live&&(r.push(e),r["_"+e]=i),this.fragment.findAllComponents(e,i),i)}}(ae),he=function(t){return this.fragment.findComponent(t)},fe=function(t){return function(e){var n={args:Array.prototype.slice.call(arguments,1)}
t(this,e,n)}}(p),le=function(t){var e={capture:!0}
return function(n){return n=t(n),this.viewmodel.get(n,e)}}(I),pe=function(t){var e
if(t&&"boolean"!=typeof t)return"undefined"!=typeof window&&document&&t?t.nodeType?t:"string"==typeof t&&(e=document.getElementById(t),!e&&document.querySelector&&(e=document.querySelector(t)),e&&e.nodeType)?e:t[0]&&t[0].nodeType?t[0]:null:null},de=function(t){return function(e,n){if(!this.rendered)throw new Error("The API has changed - you must call `ractive.render(target[, anchor])` to render your Ractive instance. Once rendered you can use `ractive.insert()`.")
if(e=t(e),n=t(n)||null,!e)throw new Error("You must specify a valid target to insert into")
e.insertBefore(this.detach(),n),this.el=e,(e.__ractive_instances__||(e.__ractive_instances__=[])).push(this),this.detached=null}}(pe),ge=function(t,e,n){return function(r,i,o){var s,a
return r=n(r),s=this.viewmodel.get(r),e(s)&&e(i)?(a=t.start(this,!0),this.viewmodel.merge(r,s,i,o),t.end(),o&&o.complete&&a.then(o.complete),a):this.set(r,i,o&&o.complete)}}(_,a,I),ve=function(t,e){var n=function(t,e,n,r){this.root=t,this.keypath=e,this.callback=n,this.defer=r.defer,this.priority=0,this.context=r&&r.context?r.context:t}
...
e(n,this.value)||(this.value=n,this.defer&&this.ready?t.scheduleTask(function(){return r.update()}):this.update())},update:function(){this.updating||(this.updating=!0,this.callback.call(this.context,this.value,this.oldValue,this.keypath),this.oldValue=this.value,this.updating=!1)}},n}(_,y),me=function(t){return function(e,n){function r(n,r){var i,o,s
...
return a}}(a),ye=function(t){return function(e,n){var r,i
return r=t(e,n),i={},r.forEach(function(t){i[t]=e.get(t)}),i}}(me),be=function(t,e,n){var r,i=/\*/,o=Array.prototype.slice
...
return this.proxies[t]||(this.proxies[t]={update:function(){e.reallyUpdate(t)}}),this.proxies[t]}},r}(_,y,ye),we=function(t,e,n){var r=/\*/,i={}
...
f||(h?(t=o.viewmodel.patternObservers.indexOf(c),o.viewmodel.patternObservers.splice(t,1),o.viewmodel.unregister(s,c,"patternObservers")):o.viewmodel.unregister(s,c,"observers"),f=!0)}}}}(I,ve,be),Ee=function(t,e){return function(n,r,i){var o,s,a,u
if(t(n)){i=r,s=n,o=[]
for(n in s)s.hasOwnProperty(n)&&(r=s[n],o.push(this.observe(n,r,i)))
return{cancel:function(){for(;o.length;)o.pop().cancel()}}}if("function"==typeof n)return i=r,r=n,n="",e(this,n,r,i)
if(a=n.split(" "),1===a.length)return e(this,n,r,i)
for(o=[],u=a.length;u--;)n=a[u],n&&o.push(e(this,n,r,i))
return{cancel:function(){for(;o.length;)o.pop().cancel()}}}}(u,we),_e=function(t){return t.trim()},xe=function(t){return""!==t},ke=function(t,e){return function(n,r){var i,o=this
...
return this}}(_e,xe),Se=function(t,e){return function(n,r){var i,o,s,a=this,u=this
if("object"==typeof n){i=[]
for(o in n)n.hasOwnProperty(o)&&i.push(this.on(o,n[o]))
return{cancel:function(){for(var t;t=i.pop();)t.cancel()}}}return s=n.split(" ").map(t).filter(e),s.forEach(function(t){(a._subs[t]||(a._subs[t]=[])).push(r)}),{cancel:function(){u.off(n,r)}}}}(_e,xe),Te=function(t,e,n){switch(e){case"splice":return n
case"sort":case"reverse":return null
case"pop":return t.length?[-1]:null
case"push":return[t.length,0].concat(n)
case"shift":return[0,1]
case"unshift":return[0,0].concat(n)}},Oe=function(t,e){var n,r,i,o,s,a
return e?(n=+(e[0]<0?t.length+e[0]:e[0]),0>n?n=0:n>t.length&&(n=t.length),o=Math.max(0,e.length-2),s=void 0!==e[1]?e[1]:t.length-n,s=Math.min(s,t.length-n),a=o-s,i=t.length+a,r=a?Math.max(t.length,i):n+o,{rangeStart:n,rangeEnd:r,balance:a,added:o,removed:s}):null},Ae=function(t,e,n,r){var i=Array.prototype
...
return u=n(a,o,p),c=r(a,u),f=c?i.splice.apply(a,u):i[o].apply(a,p),h=e.start(this,!0),c?this.viewmodel.splice(s,c):this.viewmodel.mark(s),e.end(),("splice"===o||"pop"===o||"shift"===o)&&(h=h.then(function(){return f})),h}}}(a,_,Te,Oe),Ne=function(t){return t("pop")}(Ae),Re=function(t){return t("push")}(Ae),Ce=function(t,e,n){var r,i,o,s,a,u,c,h="/* Ractive.js component styles */\n",f={},l=[]
...
return o=n(o)||this.el,s=n(s)||this.anchor,this.el=o,this.anchor=s,this.constructor.css&&e.add(this.constructor),o&&((c=o.__ractive_instances__)?c.push(this):o.__ractive_instances__=[this],s?o.insertBefore(this.fragment.render(),s):o.appendChild(this.fragment.render())),this._hasInited||(this._hasInited=!0,this._parent&&a[this._parent._guid]?i(this._parent).push(this):r(this)),a[this._guid]=!1,t.end(),this.rendered=!0,this.transitionsEnabled=h,this.complete&&u.then(function(){return f.complete()}),u}}(_,Ce,pe),Ie=function(){this.dirtyValue=this.dirtyArgs=!0,this.bound&&"function"==typeof this.owner.bubble&&this.owner.bubble()},je=function(){var t
return 1===this.items.length?this.items[0].detach():(t=document.createDocumentFragment(),this.items.forEach(function(e){t.appendChild(e.detach())}),t)},Pe=function(t){var e,n,r,i
if(this.items){for(n=this.items.length,e=0;n>e;e+=1)if(r=this.items[e],r.find&&(i=r.find(t)))return i
return null}},Me=function(t,e){var n,r,i
if(this.items)for(r=this.items.length,n=0;r>n;n+=1)i=this.items[n],i.findAll&&i.findAll(t,e)
return e},Fe=function(t,e){var n,r,i
if(this.items)for(r=this.items.length,n=0;r>n;n+=1)i=this.items[n],i.findAllComponents&&i.findAllComponents(t,e)
return e},Be=function(t){var e,n,r,i
if(this.items){for(e=this.items.length,n=0;e>n;n+=1)if(r=this.items[n],r.findComponent&&(i=r.findComponent(t)))return i
return null}},De=function(t){var e,n=t.index
return e=this.items[n+1]?this.items[n+1].firstNode():this.owner===this.root?this.owner.component?this.owner.component.findNextNode():null:this.owner.findNextNode(this)},Ue=function(){return this.items&&this.items[0]?this.items[0].firstNode():null},Ve=function(){var t=this
do if(t.pElement)return t.pElement.node
while(t=t.parent)
return this.root.detached||this.root.el},qe=function(t){function e(t,n,r,i){return i=i||0,t.map(function(t){var o,s,a
...
void 0===n&&(n=r)
var i,o,s,a,u,c,h
return i=n.args,u=i?"argsList":"value",c=i?"dirtyArgs":"dirtyValue",this[c]&&(s=e(this.items,o={},this.root._guid),a=t(i?"["+s+"]":s,o),h=a?a.value:i?[this.toString()]:this.toString(),this[u]=h,this[c]=!1),this[u]}}(Ct),We=function(){var t=/</g,e=/>/g
return function(n){return n.replace(t,"&lt;").replace(e,"&gt;")}}(),ze=function(t){return t&&t.parentNode&&t.parentNode.removeChild(t),t},Ke=function(t){return function(){return t(this.node)}}(ze),$e=function(t,e,n,r){var i=function(e){this.type=t.TEXT,this.text=e.template}
return i.prototype={detach:n,firstNode:function(){return this.node},render:function(){return this.node||(this.node=document.createTextNode(r(this.text))),this.node},toString:function(t){return t?e(this.text):this.text},unrender:function(t){return t?this.detach():void 0}},i}(z,We,Ke,Nt),He=function(t){return function(){this.keypath?this.root.viewmodel.unregister(this.keypath,this):t.removeUnresolved(this),this.resolver&&this.resolver.unbind()}}(_),Ge=function(){return this.value},Ye=function(t){var e=function(e,n,r,i){this.root=e,this.ref=n,this.parentFragment=r,this.resolve=i,t.addUnresolved(this)}
return e.prototype={unbind:function(){t.removeUnresolved(this)}},e}(_),Je=function(t,e){return t&&e&&t.substr(0,e.length+1)===e+"."},Qe=function(t){return function(e,n,r){return e===n?void 0!==r?r:null:t(e,n)?null===r?r:e.replace(n+".",r+"."):void 0}}(Je),Xe=function(t,e){function n(t){var n=e[t.message]||t.message||""
...
return i}(B,W),Ze=function(){var t={}
return function(e,n){var r,i
if(t[e])return t[e]
for(i=[];n--;)i[n]="_"+n
return r=new Function(i.join(","),"return("+e+")"),t[e]=r,r}}(),tn=function(t,e,n){var r,i
...
t.dependencies=n.slice()},en=function(t,e,n,r,i){function o(t,e){var r,i,o
...
this.explicitDependencies.concat(this.dependencies).forEach(function(e){return t.viewmodel.unregister(e,t,"computed")}),this.root.viewmodel.evaluators[this.keypath]=null}},a=u}(Xe,y,N,Ze,tn,Et),nn=function(t,e,n,r,i){function o(t,e){return t.replace(/_([0-9]+)/g,function(t,n){var r=e[n]
...
this.args.forEach(function(s){var a
s&&(s.keypath&&(a=i(s.keypath,n,r))?(s.keypath=a,o=!0):s.indexRef&&s.indexRef===t&&(s.value=e,o=!0))}),o&&this.bubble()}},a=u}(d,w,Ye,en,Qe),rn=function(t,e,n,r,i){var o=function(r,o,s){var a,u,c,h,f,l=this
...
c=n(o.root,u,o.parentFragment),void 0!==c?o.resolve(c):(o.ref=u,e.addUnresolved(o))}s.template.x&&(o.resolver=new i(o,l,s.template.x,a)),s.template.rx&&(o.resolver=new r(o,s.template.rx,a)),o.template.n!==t.SECTION_UNLESS||o.hasOwnProperty("value")||o.setValue(void 0)}}(z,_,w,on,nn),an=function(t){var e,n,r
void 0!=this.keypath&&(this.root.viewmodel.unregister(this.keypath,this),e=!0),this.keypath=t,void 0!=t&&(n=this.root.viewmodel.get(t),this.root.viewmodel.register(t,this)),this.setValue(n),e&&(r=this.twowayBinding)&&r.rebound()},un=function(t){return function(e,n,r,i){var o
this.fragments&&this.fragments.forEach(function(t){return t.rebind(e,n,r,i)}),this.resolver&&this.resolver.rebind(e,n,r,i),void 0!==this.keypath?(o=t(this.keypath,r,i),void 0!==o&&this.resolve(o)):void 0!==e&&this.indexRef===e&&this.setValue(n)}}(Qe),cn=function(t,e,n,r){return{getValue:t,init:e,resolve:n,rebind:r}}(Ge,sn,an,un),hn=function(t,e,n,r,i,o,s,a){var u=function(e){this.type=t.INTERPOLATOR,s.init(this,e)}
...
return t?n(e):e}},u}(z,_,We,ze,y,He,cn,Ke),fn=function(){this.parentFragment.bubble()},ln=function(){var t
return 1===this.fragments.length?this.fragments[0].detach():(t=document.createDocumentFragment(),this.fragments.forEach(function(e){t.appendChild(e.detach())}),t)},pn=function(t){var e,n,r
for(n=this.fragments.length,e=0;n>e;e+=1)if(r=this.fragments[e].find(t))return r
return null},dn=function(t,e){var n,r
for(r=this.fragments.length,n=0;r>n;n+=1)this.fragments[n].findAll(t,e)},gn=function(t,e){var n,r
for(r=this.fragments.length,n=0;r>n;n+=1)this.fragments[n].findAllComponents(t,e)},vn=function(t){var e,n,r
for(n=this.fragments.length,e=0;n>e;e+=1)if(r=this.fragments[e].findComponent(t))return r
return null},mn=function(t){return this.fragments[t.index+1]?this.fragments[t.index+1].firstNode():this.parentFragment.findNextNode(this)},yn=function(){var t,e,n
if(t=this.fragments.length)for(e=0;t>e;e+=1)if(n=this.fragments[e].firstNode())return n
return this.parentFragment.findNextNode(this)},bn=function(t,e){var n
...
c=n.findNextNode(this),this.parentFragment.getNode().insertBefore(this.docFrag,c)}}}(_,o),wn=function(){var t
return t=this.docFrag=document.createDocumentFragment(),this.update(),this.rendered=!0,t},En=function(t,e,n,r,i){function o(r,i){var o={template:r.template.f,root:r.root,pElement:r.parentFragment.pElement,owner:r}
...
n.context=i.keypath+"."+t,n.index=t,e=new p(n),i.fragmentsToRender.push(i.fragments[t]=e)}),this.fragmentsToCreate.length=0):o(this,t)&&(this.bubble(),this.rendered&&r.addView(this)),this.value=t,this.updating=!1)}}(z,a,u,_,o),_n=function(t,e){function n(t){t.unbind()}function r(t,e){var n,r=[]
...
a=s+e.removed,u=s+e.added,c=[a,0],c.length+=o,h.fragments.splice.apply(h.fragments,c),i(h,u,h.length,o),h.fragmentsToCreate=r(a,u)}}}(_,o),xn=function(t){var e,n,r
for(e="",n=0,r=this.length,n=0;r>n;n+=1)e+=this.fragments[n].toString(t)
return e},kn=function(t){function e(t){t.unbind()}var n
return n=function(){this.fragments.forEach(e),t.call(this),this.length=0,this.unbound=!0}}(He),Sn=function(){function t(t){t.unrender(!0)}function e(t){t.unrender(!1)}var n
return n=function(n){this.fragments.forEach(n?t:e)}}(),Tn=function(){for(var t,e,n,r,i;t=this.fragmentsToUnrender.pop();)t.unrender(!0)
...
this.rendered&&this.docFrag.childNodes.length&&(r=this.parentFragment.findNextNode(this),i.insertBefore(this.docFrag,r))}},On=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v,m){var y=function(n){this.type=t.SECTION,this.subtype=n.template.n,this.inverted=this.subtype===t.SECTION_UNLESS,this.pElement=n.pElement,this.fragments=[],this.fragmentsToCreate=[],this.fragmentsToRender=[],this.fragmentsToUnrender=[],this.length=0,e.init(this,n)}
return y.prototype={bubble:n,detach:r,find:i,findAll:o,findAllComponents:s,findComponent:a,findNextNode:u,firstNode:c,getValue:e.getValue,merge:h,rebind:e.rebind,render:f,resolve:e.resolve,setValue:l,splice:p,toString:d,unbind:g,unrender:v,update:m},y}(z,cn,fn,ln,pn,dn,gn,vn,mn,yn,bn,wn,En,_n,xn,kn,Sn,Tn),An=function(){var t,e
if(this.docFrag){for(t=this.nodes.length,e=0;t>e;e+=1)this.docFrag.appendChild(this.nodes[e])
return this.docFrag}},Nn=function(t){return function(e){var n,r,i,o
for(r=this.nodes.length,n=0;r>n;n+=1)if(i=this.nodes[n],1===i.nodeType){if(t(i,e))return i
if(o=i.querySelector(e))return o}return null}}(Zt),Rn=function(t){return function(e,n){var r,i,o,s,a,u
for(i=this.nodes.length,r=0;i>r;r+=1)if(o=this.nodes[r],1===o.nodeType&&(t(o,e)&&n.push(o),s=o.querySelectorAll(e)))for(a=s.length,u=0;a>u;u+=1)n.push(s[u])}}(Zt),Cn=function(){return this.rendered&&this.nodes[0]?this.nodes[0]:this.parentFragment.findNextNode(this)},Ln=function(t,e){function n(t){return s[t]||(s[t]=e(t))}var r,i,o,s={}
...
if(i&&"SELECT"===r.tagName)for(f=l.length;f--;)l[f]!==c&&(l[f].selected=!1)}return l}}(T,O),In=function(t){for(var e=[],n=t.length;n--;)e[n]=t[n]
return e},jn=function(t){function e(t){return t.selected}var n
return n=function(n){var r,i,o
n&&"select"===n.name&&n.binding&&(r=t(n.node.options).filter(e),n.getAttribute("multiple")?o=r.map(function(t){return t.value}):(i=r[0])&&(o=i.value),void 0!==o&&n.binding.setValue(o),n.bubble())}}(In),Pn=function(t,e){return function(){if(this.rendered)throw new Error("Attempted to render an item that was already rendered")
return this.docFrag=document.createDocumentFragment(),this.nodes=t(this.value,this.parentFragment.getNode(),this.docFrag),e(this.pElement),this.rendered=!0,this.docFrag}}(Ln,jn),Mn=function(t){return function(e){var n;(n=this.root.viewmodel.wrapped[this.keypath])&&(e=n.get()),e!==this.value&&(this.value=e,this.parentFragment.bubble(),this.rendered&&t.addView(this))}}(_),Fn=function(t){return function(){return void 0!=this.value?t(""+this.value):""}}(Nt),Bn=function(t){return function(e){this.rendered&&e&&(this.nodes.forEach(t),this.rendered=!1)}}(ze),Dn=function(t,e){return function(){var n,r
if(this.rendered){for(;this.nodes&&this.nodes.length;)n=this.nodes.pop(),n.parentNode.removeChild(n)
r=this.parentFragment.getNode(),this.nodes=t(this.value,r,this.docFrag),r.insertBefore(this.docFrag,this.parentFragment.findNextNode(this)),e(this.pElement)}}}(Ln,jn),Un=function(t,e,n,r,i,o,s,a,u,c,h,f){var l=function(n){this.type=t.TRIPLE,e.init(this,n)}
return l.prototype={detach:n,find:r,findAll:i,firstNode:o,getValue:e.getValue,rebind:e.rebind,render:s,resolve:e.resolve,setValue:a,toString:u,unbind:f,unrender:c,update:h},l}(z,cn,An,Nn,Rn,Cn,Pn,Mn,Fn,Bn,Dn,He),Vn=function(){this.parentFragment.bubble()},qn=function(){var t,e=this.node
return e?((t=e.parentNode)&&t.removeChild(e),e):void 0},Wn=function(t){return function(e){return t(this.node,e)?this.node:this.fragment&&this.fragment.find?this.fragment.find(e):void 0}}(Zt),zn=function(t,e){e._test(this,!0)&&e.live&&(this.liveQueries||(this.liveQueries=[])).push(e),this.fragment&&this.fragment.findAll(t,e)},Kn=function(t,e){this.fragment&&this.fragment.findAllComponents(t,e)},$n=function(t){return this.fragment?this.fragment.findComponent(t):void 0},Hn=function(){return null},Gn=function(){return this.node},Yn=function(t){return this.attributes&&this.attributes[t]?this.attributes[t].value:void 0},Jn=function(){var t,e,n,r
return t="altGlyph altGlyphDef altGlyphItem animateColor animateMotion animateTransform clipPath feBlend feColorMatrix feComponentTransfer feComposite feConvolveMatrix feDiffuseLighting feDisplacementMap feDistantLight feFlood feFuncA feFuncB feFuncG feFuncR feGaussianBlur feImage feMerge feMergeNode feMorphology feOffset fePointLight feSpecularLighting feSpotLight feTile feTurbulence foreignObject glyphRef linearGradient radialGradient textPath vkern".split(" "),e="attributeName attributeType baseFrequency baseProfile calcMode clipPathUnits contentScriptType contentStyleType diffuseConstant edgeMode externalResourcesRequired filterRes filterUnits glyphRef gradientTransform gradientUnits kernelMatrix kernelUnitLength keyPoints keySplines keyTimes lengthAdjust limitingConeAngle markerHeight markerUnits markerWidth maskContentUnits maskUnits numOctaves pathLength patternContentUnits patternTransform patternUnits pointsAtX pointsAtY pointsAtZ preserveAlpha preserveAspectRatio primitiveUnits refX refY repeatCount repeatDur requiredExtensions requiredFeatures specularConstant specularExponent spreadMethod startOffset stdDeviation stitchTiles surfaceScale systemLanguage tableValues targetX targetY textLength viewBox viewTarget xChannelSelector yChannelSelector zoomAndPan".split(" "),n=function(t){for(var e={},n=t.length;n--;)e[t[n].toLowerCase()]=t[n]
return e},r=n(t.concat(e)),function(t){var e=t.toLowerCase()
return r[e]||e}}(),Qn=function(t){return function(){var e=this.fragment.getValue()
e!==this.value&&("id"===this.name&&this.value&&delete this.root.nodes[this.value],this.value=e,"value"===this.name&&this.node&&(this.node._ractive.value=e),this.rendered&&t.addView(this))}}(_),Xn=function(){var t=/^(allowFullscreen|async|autofocus|autoplay|checked|compact|controls|declare|default|defaultChecked|defaultMuted|defaultSelected|defer|disabled|draggable|enabled|formNoValidate|hidden|indeterminate|inert|isMap|itemScope|loop|multiple|muted|noHref|noResize|noShade|noValidate|noWrap|open|pauseOnExit|readOnly|required|reversed|scoped|seamless|selected|sortable|translate|trueSpeed|typeMustMatch|visible)$/i
return t}(),Zn=function(t,e){return function(n,r){var i,o
if(i=r.indexOf(":"),-1===i||(o=r.substr(0,i),"xmlns"===o))n.name=n.element.namespace!==t.html?e(r):r
else if(r=r.substring(i+1),n.name=e(r),n.namespace=t[o.toLowerCase()],!n.namespace)throw'Unknown namespace ("'+o+'")'}}(T,Jn),tr=function(t){return function(e){var n=e.fragment.items
if(1===n.length)return n[0].type===t.INTERPOLATOR?n[0]:void 0}}(z),er=function(t,e){var n={"accept-charset":"acceptCharset",accesskey:"accessKey",bgcolor:"bgColor","class":"className",codebase:"codeBase",colspan:"colSpan",contenteditable:"contentEditable",datetime:"dateTime",dirname:"dirName","for":"htmlFor","http-equiv":"httpEquiv",ismap:"isMap",maxlength:"maxLength",novalidate:"noValidate",pubdate:"pubDate",readonly:"readOnly",rowspan:"rowSpan",tabindex:"tabIndex",usemap:"useMap"}
return function(r,i){var o
!r.pNode||r.namespace||i.pNode.namespaceURI&&i.pNode.namespaceURI!==t.html||(o=n[r.name]||r.name,void 0!==i.pNode[o]&&(r.propertyName=o),(e.test(o)||"value"===o)&&(r.useProperty=!0))}}(T,Xn),nr=function(t,e,n,r,i,o){var s
return o.push(function(){s=o.Fragment}),function(o){return this.type=t.ATTRIBUTE,this.element=o.element,this.root=o.root,n(this,o.name),o.value&&"string"!=typeof o.value?(this.parentFragment=this.element.parentFragment,this.fragment=new s({template:o.value,root:this.root,owner:this}),this.value=this.fragment.getValue(),this.interpolator=r(this),this.isBindable=!!this.interpolator&&!this.interpolator.isStatic,i(this,o),void(this.ready=!0)):void(this.value=e.test(this.name)?!0:o.value||"")}}(z,Xn,Zn,tr,er,o),rr=function(t,e,n,r){this.fragment&&this.fragment.rebind(t,e,n,r)},ir=function(t,e){var n={"accept-charset":"acceptCharset",accesskey:"accessKey",bgcolor:"bgColor","class":"className",codebase:"codeBase",colspan:"colSpan",contenteditable:"contentEditable",datetime:"dateTime",dirname:"dirName","for":"htmlFor","http-equiv":"httpEquiv",ismap:"isMap",maxlength:"maxLength",novalidate:"noValidate",pubdate:"pubDate",readonly:"readOnly",rowspan:"rowSpan",tabindex:"tabIndex",usemap:"useMap"}
return function(r){var i
this.node=r,r.namespaceURI&&r.namespaceURI!==t.html||(i=n[this.name]||this.name,void 0!==r[i]&&(this.propertyName=i),(e.test(i)||"value"===i)&&(this.useProperty=!0),"value"===i&&(this.useProperty=!0,r._ractive.value=this.value)),this.rendered=!0,this.update()}}(T,Xn),or=function(t){function e(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var n
return n=function(){var n=(o=this).name,r=o.value,i=o.interpolator,o=o.fragment
if(("value"!==n||"select"!==this.element.name&&"textarea"!==this.element.name)&&("value"!==n||void 0===this.element.getAttribute("contenteditable")))return"name"===n&&"input"===this.element.name&&i?"name={{"+(i.keypath||i.ref)+"}}":t.test(n)?r?n:"":(o&&(r=o.toString()),r?n+'="'+e(r)+'"':n)}}(Xn),sr=function(){this.fragment&&this.fragment.unbind()},ar=function(){var t,e,n,r,i=this.value
...
break}},ur=function(t,e){for(var n=0,r=t.length;r>n;n++)if(t[n]==e)return!0
return!1},cr=function(t,e){return function(){var n,r,i,o,s=this.value
for(e(s)||(s=[s]),n=this.node.options,r=n.length;r--;)i=n[r],o=i._ractive?i._ractive.value:i.value,i.selected=t(s,o)}}(ur,a),hr=function(){var t=(e=this).node,e=e.value
t.checked=e==t._ractive.value},fr=function(t){return function(){var e,n,r,i,o=this.node
...
if(n.element.node.checked)return t.addViewmodel(n.root.viewmodel),n.handleChange()}t.addViewmodel(n.root.viewmodel),this.root.viewmodel.set(n.keypath,void 0)}}}(_),lr=function(t){return function(){var e,n
e=this.node,n=this.value,e.checked=t(n)?-1!==n.indexOf(e._ractive.value):n==e._ractive.value}}(a),pr=function(){var t,e
t=this.node,e=this.value,void 0===e&&(e=""),t.className=e},dr=function(){var t,e
t=this.node,e=this.value,void 0!==e&&(this.root.nodes[e]=void 0),this.root.nodes[e]=t,t.id=e},gr=function(){var t,e
t=this.node,e=this.value,void 0===e&&(e=""),t.style.setAttribute("cssText",e)},vr=function(){var t=this.value
void 0===t&&(t=""),this.locked||(this.node.innerHTML=t)},mr=function(){var t=(e=this).node,e=e.value
t._ractive.value=e,this.locked||(t.value=void 0==e?"":e)},yr=function(){this.locked||(this.node[this.propertyName]=this.value)},br=function(t){return function(){var e=(o=this).node,n=o.namespace,r=o.name,i=o.value,o=o.fragment
n?e.setAttributeNS(n,r,(o||i).toString()):t.test(r)?i?e.setAttribute(r,""):e.removeAttribute(r):e.setAttribute(r,(o||i).toString())}}(Xn),wr=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p){return function(){var d,g,v=(y=this).name,m=y.element,y=y.node
"id"===v?g=u:"value"===v?"select"===m.name&&"value"===v?g=m.getAttribute("multiple")?r:n:"textarea"===m.name?g=f:null!=m.getAttribute("contenteditable")?g=h:"input"===m.name&&(d=m.getAttribute("type"),g="file"===d?e:"radio"===d&&m.binding&&"name"===m.binding.name?o:f):this.twoway&&"name"===v?"radio"===y.type?g=i:"checkbox"===y.type&&(g=s):"style"===v&&y.style.setAttribute?g=c:"class"!==v||y.namespaceURI&&y.namespaceURI!==t.html?this.useProperty&&(g=l):g=a,g||(g=p),this.update=g,this.update()}}(T,zt,ar,cr,hr,fr,lr,pr,dr,gr,vr,mr,yr,br),Er=function(t,e,n,r,i,o,s){var a=function(t){this.init(t)}
return a.prototype={bubble:t,init:e,rebind:n,render:r,toString:i,unbind:o,update:s},a}(Qn,nr,rr,ir,or,sr,wr),_r=function(t){return function(e,n){var r,i,o=[]
for(r in n)n.hasOwnProperty(r)&&(i=new t({element:e,name:r,value:n[r],root:e.root}),o.push(o[r]=i))
return o}}(Er),xr=function(t){for(var e,n,r=Array.prototype.slice,i=r.call(arguments,1);n=i.shift();)for(e in n)n.hasOwnProperty(e)&&(t[e]=n[e])
return t},kr=function(t,e,n,r,i){var o=function(t){var n,r,i
...
return e=function(t){o.call(this,t),this.init&&this.init()},e.prototype=n(i.prototype),r(e.prototype,t),e.extend=o.extend,e},o}(_,B,K,xr,d),Sr=function(){this._ractive.binding.handleChange()},Tr=function(t,e){var n=t.extend({getInitialValue:function(){return this.element.fragment?this.element.fragment.toString():""},render:function(){var t=this.element.node
...
return n}(kr,Sr),Or=function(){var t={}
return function(e,n,r){var i=e+n+r
return t[i]||(t[i]=[])}}(),Ar=function(t,e,n,r,i){var o=n.extend({name:"checked",init:function(){this.siblings=r(this.root._guid,"radio",this.element.getAttribute("name")),this.siblings.push(this)},render:function(){var t=this.element.node
...
return i}(d,kr,Sr,Or),Rr=function(t,e,n,r,i){function o(t){return t.isChecked}function s(t){return t.element.getAttribute("value")}var a=n.extend({name:"name",getInitialValue:function(){return this.noInitialValue=!0,[]},init:function(){var e,n,i
...
return a}(a,d,kr,Or,Sr),Cr=function(t,e){var n=t.extend({name:"checked",render:function(){var t=this.element.node
...
return n}(kr,Sr),Lr=function(t,e,n){var r=e.extend({getInitialValue:function(){var t,e,n,r,i=this.element.options
...
return r}(_,kr,Sr),Ir=function(t){return function(e,n){var r
if(!t(e)||!t(n))return!1
if(e.length!==n.length)return!1
for(r=e.length;r--;)if(e[r]!==n[r])return!1
return!0}}(a),jr=function(t,e,n,r){var i=n.extend({getInitialValue:function(){return this.element.options.filter(function(t){return t.getAttribute("selected")}).map(function(t){return t.getAttribute("value")})},render:function(){var t
...
return i}(_,Ir,Lr,Sr),Pr=function(t,e){var n=t.extend({render:function(){this.element.node.addEventListener("change",e,!1)},unrender:function(){this.element.node.removeEventListener("change",e,!1)},getValue:function(){return this.element.node.files}})
return n}(kr,Sr),Mr=function(t,e){function n(){var t
...
t.removeEventListener("change",e,!1),t.removeEventListener("input",e,!1),t.removeEventListener("keyup",e,!1),t.removeEventListener("blur",n,!1)}}),r=i}(kr,Sr),Fr=function(t){return t.extend({getInitialValue:function(){return void 0},getValue:function(){var t=parseFloat(this.element.node.value)
return isNaN(t)?void 0:t}})}(Mr),Br=function(t,e,n,r,i,o,s,a,u,c,h){function f(t){return t&&t.isBindable}var l
return l=function(l){var p,d,g,v,m=l.attributes
return l.binding&&(l.binding.teardown(),l.binding=null),l.getAttribute("contenteditable")&&f(m.value)?d=e:"input"===l.name?(p=l.getAttribute("type"),"radio"===p||"checkbox"===p?(g=f(m.name),v=f(m.checked),g&&v&&t.error({message:"badRadioInputBinding"}),g?d="radio"===p?r:i:v&&(d="radio"===p?n:o)):"file"===p&&f(m.value)?d=u:f(m.value)&&(d="number"===p||"range"===p?c:h)):"select"===l.name&&f(m.value)?d=l.getAttribute("multiple")?a:s:"textarea"===l.name&&f(m.value)&&(d=h),d?new d(l):void 0}}(Xe,Tr,Ar,Nr,Rr,Cr,Lr,jr,Pr,Fr,Mr),Dr=function(){var t=this.getAction()
t&&!this.hasListener?this.listen():!t&&this.hasListener&&this.unrender()},Ur=function(t){return function(e){t(this.root,this.getAction(),{event:e})}}(p),Vr=function(){return this.action.toString().trim()},qr=function(t,e,n,r,i,o,s){function a(t){var e,n,r
...
return g&&void 0!==(o=g[e])?void(d[i]={indexRef:e,value:o}):(a=p.exec(e))?void(d[i]={eventObject:!0,refinements:a[1]?a[1].split("."):[]}):(s=n(v,e,m))?void(d[i]={keypath:s}):(d[i]=null,u=new r(v,e,m,function(e){y.resolve(i,e),t(y.unresolved,u)}),void y.unresolved.push(u))}),this.fire=a):(l=h.n||h,"string"!=typeof l&&(l=new f({template:l,root:this.root,owner:this})),this.action=l,h.d?(this.dynamicParams=new f({template:h.d,root:this.root,owner:this.element}),this.fire=c):h.a&&(this.params=h.a,this.fire=u))}}(d,Ze,w,Ye,o,p,Xe),Wr=function(t){var e,n
e=this._ractive,n=e.events[t.type],n.fire({node:this,original:t,index:e.index,keypath:e.keypath,context:e.root.get(e.keypath)})},zr=function(t,e,n){function r(t){return o[t]||(o[t]=function(e){var n=e.node._ractive
...
this.invalid||((i=t.registries.events.find(this.root,o))?this.custom=i(this.node,r(o)):("on"+o in this.node||window&&"on"+o in window||n.error({debug:this.root.debug,message:"missingPlugin",args:{plugin:"event",name:o}}),this.node.addEventListener(o,e,!1)),this.hasListener=!0)}}(Ht,Wr,Xe),Kr=function(t){return function(e,n,r,i){return this.method?void this.args.forEach(function(o){o.indexRef&&o.indexRef===e&&(o.value=n),o.keypath&&(i=t(o.keypath,r,i))&&(o.keypath=i)}):("string"!=typeof this.action&&this.action.rebind(e,n,r,i),void(this.dynamicParams&&this.dynamicParams.rebind(e,n,r,i)))}}(Qe),$r=function(){this.node=this.element.node,this.node._ractive.events[this.name]=this,(this.method||this.getAction())&&this.listen()},Hr=function(t,e){this.args[t]={keypath:e}},Gr=function(){function t(t){t.teardown()}var e
return e=function(){return this.method?void this.unresolved.forEach(t):("string"!=typeof this.action&&this.action.unbind(),void(this.dynamicParams&&this.dynamicParams.unbind()))}}(),Yr=function(t){return function(){this.custom?this.custom.teardown():this.node.removeEventListener(this.name,t,!1),this.hasListener=!1}}(Wr),Jr=function(t,e,n,r,i,o,s,a,u,c){var h=function(t,e,n){this.init(t,e,n)}
return h.prototype={bubble:t,fire:e,getAction:n,init:r,listen:i,rebind:o,render:s,resolve:a,unbind:u,unrender:c},h}(Dr,Ur,Vr,qr,zr,Kr,$r,Hr,Gr,Yr),Qr=function(t){return function(e,n){var r,i,o,s,a=[]
for(i in n)if(n.hasOwnProperty(i))for(o=i.split("-"),r=o.length;r--;)s=new t(e,o[r],n[i]),a.push(s)
return a}}(Jr),Xr=function(t,e,n){var r,i,o
...
r.actual=e,r.ready=!0},update:function(){this.actual.update?this.actual.update.apply(this.root,this.params):(this.actual.teardown(!0),this.init())},rebind:function(t,e,n,r){this.fragment&&this.fragment.rebind(t,e,n,r)},teardown:function(t){this.actual.teardown(),!t&&this.fragment&&this.fragment.unbind()}},o}(Xe,o,Ht),Zr=function(t){function e(t,e){for(var n=t.length;n--;)if(t[n]==e)return!0}var n
...
n=t._ractive?t._ractive.value:t.value,r=o?e(i,n):i==n,r&&(a=!0),t.selected=r}),a||(s[0]&&(s[0].selected=!0),n.binding&&n.binding.forceUpdate())):n.binding&&n.binding.forceUpdate())}}(In),ti=function(t,e){return function(){var n=this
this.dirty||(this.dirty=!0,t.scheduleTask(function(){e(n),n.dirty=!1})),this.parentFragment.bubble()}}(_,Zr),ei=function(t){do if("select"===t.name)return t
while(t=t.parent)},ni=function(t){return function(e,n){e.select=t(e.parent),e.select&&(e.select.options.push(e),n.a||(n.a={}),n.a.value||n.a.hasOwnProperty("disabled")||(n.a.value=n.f),"selected"in n.a&&void 0!==e.select.getAttribute("value")&&delete n.a.selected)}}(ei),ri=function(t,e,n,r,i,o,s,a,u){var c
return u.push(function(){c=u.Fragment}),function(u){var h,f,l,p,d
this.type=t.ELEMENT,h=this.parentFragment=u.parentFragment,f=this.template=u.template,this.parent=u.pElement||h.pElement,this.root=l=h.root,this.index=u.index,this.name=e(f.e),"option"===this.name&&a(this,f),"select"===this.name&&(this.options=[],this.bubble=s),this.attributes=n(this,f.a),f.f&&(this.fragment=new c({template:f.f,root:l,owner:this,pElement:this})),l.twoway&&(p=r(this,f.a))&&(this.binding=p,d=this.root._twowayBindings[p.keypath]||(this.root._twowayBindings[p.keypath]=[]),d.push(p)),f.v&&(this.eventHandlers=i(this,f.v)),f.o&&(this.decorator=new o(this,f.o)),this.intro=f.t0||f.t1,this.outro=f.t0||f.t2}}(z,Jn,_r,Br,Qr,Xr,ti,ni,o),ii=function(t){return function(e,n){return e===n||t(e,n)}}(Je),oi=function(t,e){return function(n,r,i,o){var s=n[r]
s&&!t(s,o)&&t(s,i)&&(n[r]=e(s,i,o))}}(ii,Qe),si=function(t){return function(e,n,r,i){function o(t){t.rebind(e,n,r,i)}var s,a,u,c
...
this.node&&(a=this.node._ractive)&&(t(a,"keypath",r,i),void 0!=e&&(a.index[e]=n))}}(oi),ai=function(t){var e;(t.attributes.width||t.attributes.height)&&t.node.addEventListener("load",e=function(){var n=t.getAttribute("width"),r=t.getAttribute("height")
void 0!==n&&t.node.setAttribute("width",n),void 0!==r&&t.node.setAttribute("height",r),t.node.removeEventListener("load",e,!1)},!1)},ui=function(t,e,n){var r,i={}
return n.push(function(){r=n.Fragment}),function(n,o,s){var a,u,c,h=this
return h.element=n,h.root=a=n.root,h.isIntro=s,u=o.n||o,"string"!=typeof u&&(c=new r({template:u,root:a,owner:n}),u=c.toString(),c.unbind()),h.name=u,o.a?h.params=o.a:o.d&&(c=new r({template:o.d,root:a,owner:n}),h.params=c.getValue(i),c.unbind()),h._fn=e.registries.transitions.find(a,u),h._fn?void 0:void t.error({debug:a.debug,message:"missingPlugin",args:{plugin:"transition",name:u}})}}(Xe,Ht,o),ci=function(t){return t.replace(/-([a-zA-Z])/g,function(t,e){return e.toUpperCase()})},hi=function(t,e,n,r){var i,o,s
...
break}return o[t]}):i=null,i}(A,j,O,ci),fi=function(t,e,n,r){var i,o
...
return i}):i=null,i}(Et,A,a,hi),li=function(t){return function(e,n){var r
if("string"==typeof e)this.node.style[t(e)]=n
else for(r in e)e.hasOwnProperty(r)&&(this.node.style[t(r)]=e[r])
return this}}(hi),pi=function(t,e,n){function r(t){return t}var i,o=function(i){var o
this.duration=i.duration,this.step=i.step,this.complete=i.complete,"string"==typeof i.easing?(o=i.root.easing[i.easing],o||(t('Missing easing function ("'+i.easing+'"). You may need to download a plugin from [TODO]'),o=r)):o="function"==typeof i.easing?i.easing:r,this.easing=o,this.start=e(),this.end=this.start+this.duration,this.running=!0,n.add(this)}
return o.prototype={tick:function(t){var e,n
return this.running?t>this.end?(this.step&&this.step(1),this.complete&&this.complete(1),!1):(e=t-this.start,n=this.easing(e/this.duration),this.step&&this.step(n),!0):!1},stop:function(){this.abort&&this.abort(),this.running=!1}},i=o}(B,M,F),di=function(t){var e=new RegExp("^-(?:"+t.join("|")+")-")
return function(t){return t.replace(e,"")}}(j),gi=function(t){var e=new RegExp("^(?:"+t.join("|")+")([A-Z])")
return function(t){var n
return t?(e.test(t)&&(t="-"+t),n=t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})):""}}(j),vi=function(t,e,n,r,i,o,s,a,u){var c,h,f,l,p,d,g,v,m={},y={}
...
return h&&(n("t.animateStyle returns a Promise as of 0.4.0. Transition authors should do t.animateStyle(...).then(callback)"),p.then(h)),p}):a=null,a}(Et,A,B,g,hi,vi,mi),bi=function(t,e){var n
for(n in e)!e.hasOwnProperty(n)||n in t||(t[n]=e[n])
return t},wi=function(t){return function(e,n){return"number"==typeof e?e={duration:e}:"string"==typeof e?e="slow"===e?{duration:600}:"fast"===e?{duration:200}:{duration:400}:e||(e={}),t(e,n)}}(bi),Ei=function(){function t(t,e){e?t.setAttribute("style",e):(t.getAttribute("style"),t.removeAttribute("style"))}var e
return e=function(){var e,n,r=this
return e=r.node=r.element.node,n=e.getAttribute("style"),r.complete=function(i){!i&&r.isIntro&&t(e,n),e._ractive.transition=null,r._manager.remove(r)},r._fn?void r._fn.apply(r.root,[r].concat(r.params)):void r.complete()}}(),_i=function(t,e,n,r,i,o,s){var a,u
return s.push(function(){a=s.Fragment}),u=function(t,e,n){this.init(t,e,n)},u.prototype={init:t,start:o,getStyle:e,setStyle:n,animateStyle:r,processParams:i},u}(ui,fi,li,yi,wi,Ei,o),xi=function(t,e,n,r,i,o,s,a,u,c,h){function f(e){var n,r,i
...
a.registerTransition(m),a.scheduleTask(function(){return m.start()})}return"option"===this.name&&l(this),this.node.autofocus&&a.scheduleTask(function(){return n.node.focus()}),p(this),this.node}}(T,a,B,K,O,N,zt,_,m,ai,_i),ki=function(t,e,n){function r(t){var n,r,i
...
return e="<"+(this.template.y?"!DOCTYPE":this.template.e),e+=this.attributes.map(o).join(""),"option"===this.name&&r(this)&&(e+=" selected"),"input"===this.name&&i(this)&&(e+=" checked"),e+=">","textarea"===this.name&&void 0!==this.getAttribute("value")?e+=n(this.getAttribute("value")):void 0!==this.getAttribute("contenteditable")&&(e+=this.getAttribute("value")),this.fragment&&(s="script"!==this.name&&"style"!==this.name,e+=this.fragment.toString(s)),t.test(this.template.e)||(e+="</"+this.template.e+">"),e}}(St,a,We),Si=function(t){return function(e){e.select&&t(e.select.options,e)}}(d),Ti=function(t){function e(t){t.unbind()}var n
return n=function(){this.fragment&&this.fragment.unbind(),this.binding&&this.binding.unbind(),this.eventHandlers&&this.eventHandlers.forEach(e),"option"===this.name&&t(this),this.attributes.forEach(e)}}(Si),Oi=function(t,e){function n(t){var e,n,r
...
t.registerTransition(s),t.scheduleTask(function(){return s.start()})}this.liveQueries&&n(this),this.node.id&&delete this.root.nodes[this.node.id]}}(_,_i),Ai=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d){var g=function(t){this.init(t)}
return g.prototype={bubble:t,detach:e,find:n,findAll:r,findAllComponents:i,findComponent:o,findNextNode:s,firstNode:a,getAttribute:u,init:c,rebind:h,render:f,toString:l,unbind:p,unrender:d},g}(Vn,qn,Wn,zn,Kn,$n,Hn,Gn,Yn,ri,si,xi,ki,Ti,Oi),Ni=function(){function t(t,e){var n=r.exec(e)[0]
return null===t||n.length<t.length?n:t}var e,n=/^\s*$/,r=/^\s*/
return e=function(e){var r,i,o,s
return r=e.split("\n"),i=r[0],void 0!==i&&n.test(i)&&r.shift(),o=r[r.length-1],void 0!==o&&n.test(o)&&r.pop(),s=r.reduce(t,null),s&&(e=r.map(function(t){return t.replace(s,"")}).join("\n")),e}}(),Ri=function(t,e,n,r){function i(r,i){var o=e.registries.partials,s=o.findInstance(r,i)
...
return e.partials[o]=a.t}return t.error({debug:e.debug,message:"noTemplateForPartial",args:{name:o}}),[]}}(Xe,Ht,Ut,Ni),Ci=function(t,e){var n
return e?n=t.split("\n").map(function(t,n){return n?e+t:t}).join("\n"):t},Li=function(t,e,n,r,i,o,s,a){var u,c
...
"string"==typeof o&&(o=i(n,o)),o._fn=a,s.components[r]=o}return o}}(Ht,Xe,o),ji=function(){return this.instance.fragment.detach()},Pi=function(t){return this.instance.fragment.find(t)},Mi=function(t,e){return this.instance.fragment.findAll(t,e)},Fi=function(t,e){e._test(this,!0),this.instance.fragment&&this.instance.fragment.findAllComponents(t,e)},Bi=function(t){return t&&t!==this.name?this.instance.fragment?this.instance.fragment.findComponent(t):null:this.instance},Di=function(){return this.parentFragment.findNextNode(this)},Ui=function(){return this.rendered?this.instance.fragment.firstNode():null},Vi=function(t,e){var n,r
...
this.component.instance.viewmodel.set(this.key,e),t.addViewmodel(this.component.instance.viewmodel),this.value=e,this.dirty=!1},rebind:function(t,e,n,r){this.fragment.rebind(t,e,n,r)},unbind:function(){this.fragment.unbind()}},r}(_,o),qi=function(t,e){var n=function(n,r,i,o){var s=this
...
return n.prototype={rebind:function(t,e,n,r){this.resolver.rebind(t,e,n,r)},unbind:function(){this.resolver.unbind()}},n}(on,b),Wi=function(t,e,n,r,i){function o(o,s,a,u){var c,h,f,l,p,d
...
return a}}(z,Ct,w,Vi,qi),zi=function(t){return function(e,n,r,i){var o,s,a,u
return s=e.parentFragment,u=e.root,a={content:i||[]},n.defaults.el&&t.warn({debug:u.debug,message:"defaultElSpecified",args:{name:e.name}}),o=new n({el:null,append:!0,data:r,partials:a,magic:u.magic||n.defaults.magic,modifyArrays:u.modifyArrays,_parent:u,_component:e,adapt:u.adapt,"yield":{template:i,instance:u}})}}(Xe),Ki=function(t){return function(e,n){n.forEach(function(n){var r,i
t(e,e.root,n.parentKeypath,n.childKeypath),r=e.instance.viewmodel.get(n.childKeypath),i=e.root.viewmodel.get(n.parentKeypath),void 0!==r&&void 0===i&&e.root.viewmodel.set(n.parentKeypath,r)})}}(b),$i=function(t,e,n){function r(t,r,i,o){"string"!=typeof o&&n.error({debug:r.debug,message:"noComponentEventArguments"}),t.on(i,function(){var t,n
...
for(n in e)e.hasOwnProperty(n)&&r(t.instance,t.root,n,e[n])}}(o,p,Xe),Hi=function(t){var e,n
for(e=t.root;e;)(n=e._liveComponentQueries["_"+t.name])&&n.push(t.instance),e=e._parent},Gi=function(t,e,n,r,i,o,s){return function(a,u){var c,h,f,l
...
l=[],f=n(this,u.defaults.data||{},a.template.a,l),r(this,u,f,a.template.f),i(this,l),o(this,a.template.v),(a.template.t1||a.template.t2||a.template.o)&&e('The "intro", "outro" and "decorator" directives have no effect on components'),s(this)}}(z,B,Wi,zi,Ki,$i,Hi),Yi=function(t,e){return function(n,r,i,o){function s(t){t.rebind(n,r,i,o)}var a,u,c=this.instance,h=c._parent
this.bindings.forEach(function(t){var n
t.root===h&&(n=e(t.keypath,i,o))&&t.rebind(n)}),this.complexParameters.forEach(s),this.yielder&&s(this.yielder),(a=this.indexRefBindings[n])&&(t.addViewmodel(c.viewmodel),c.viewmodel.set(a,r)),(u=this.root._liveComponentQueries["_"+this.name])&&u._makeDirty()}}(_,Qe),Ji=function(){var t=this.instance
return t.render(this.parentFragment.getNode()),this.rendered=!0,t.fragment.detach()},Qi=function(){return this.instance.fragment.toString()},Xi=function(){function t(t){t.unbind()}function e(t){var e,n
e=t.root
do(n=e._liveComponentQueries["_"+t.name])&&n._remove(t)
while(e=e._parent)}var n
return n=function(){this.complexParameters.forEach(t),this.bindings.forEach(t),e(this),this.instance.fragment.unbind()}}(),Zi=function(t){return function(e){t(this.instance,"teardown"),this.shouldDestroy=e,this.instance.unrender()}}(p),to=function(t,e,n,r,i,o,s,a,u,c,h,f,l){var p=function(t,e){this.init(t,e)}
return p.prototype={detach:t,find:e,findAll:n,findAllComponents:r,findComponent:i,findNextNode:o,firstNode:s,init:a,rebind:u,render:c,toString:h,unbind:f,unrender:l},p}(ji,Pi,Mi,Fi,Bi,Di,Ui,Gi,Yi,Ji,Qi,Xi,Zi),eo=function(t,e){var n=function(e){this.type=t.COMMENT,this.value=e.template.c}
return n.prototype={detach:e,firstNode:function(){return this.node},render:function(){return this.node||(this.node=document.createComment(this.value)),this.node},toString:function(){return"<!--"+this.value+"-->"},unrender:function(t){t&&this.node.parentNode.removeChild(this.node)}},n}(z,Ke),no=function(t){var e
...
default:throw new Error("Something very strange happened. Please file an issue at https://github.com/ractivejs/ractive/issues. Thanks!")}}}(z,$e,hn,On,Un,Ai,Li,Ii,to,eo,no),io=function(t,e,n){return function(r){var i,o,s,a=this
...
for(s in o)this.indexRefs[s]=o[s]}this.priority=i?i.priority+1:1,r.indexRef&&(this.indexRefs||(this.indexRefs={}),this.indexRefs[r.indexRef]=r.index),"string"==typeof r.template?r.template=[r.template]:r.template||(r.template=[]),this.items=r.template.map(function(t,e){return n({parentFragment:a,pElement:r.pElement,template:t,index:e})}),this.value=this.argsList=null,this.dirtyArgs=this.dirtyValue=!0,this.bound=!0}}(z,K,ro),oo=function(t){return function(e,n,r,i){t(this,"context",r,i),this.indexRefs&&void 0!==this.indexRefs[e]&&(this.indexRefs[e]=n),this.items.forEach(function(t){t.rebind&&t.rebind(e,n,r,i)})}}(oi),so=function(){var t
return 1===this.items.length?t=this.items[0].render():(t=document.createDocumentFragment(),this.items.forEach(function(e){t.appendChild(e.render())})),this.rendered=!0,t},ao=function(t){return this.items?this.items.map(function(e){return e.toString(t)}).join(""):""},uo=function(){function t(t){t.unbind&&t.unbind()}var e
return e=function(){this.bound&&(this.items.forEach(t),this.bound=!1)}}(),co=function(t){if(!this.rendered)throw new Error("Attempted to unrender a fragment that was not rendered")
this.items.forEach(function(e){return e.unrender(t)}),this.rendered=!1},ho=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v){var m=function(t){this.init(t)}
return m.prototype={bubble:t,detach:e,find:n,findAll:r,findAllComponents:i,findComponent:o,findNextNode:s,firstNode:a,getNode:u,getValue:c,init:h,rebind:f,render:l,toString:p,unbind:d,unrender:g},v.Fragment=m,m}(Ie,je,Pe,Me,Fe,Be,De,Ue,Ve,qe,io,oo,so,ao,uo,co,o),fo=function(t,e,n,r){var i=["template","partials","components","decorators","events"]
...
return t.end(),a&&c.then(a.bind(this)),c}}(_,u,I,me),vo=function(t){return t("shift")}(Ae),mo=function(t){return t("sort")}(Ae),yo=function(t){return t("splice")}(Ae),bo=function(t){return function(e,n){return t(this,e,void 0===n?-1:-n)}}(C),wo=function(t,e,n){return function(r){var i
return t(this,"teardown"),this.fragment.unbind(),this.viewmodel.teardown(),this.rendered&&this.el.__ractive_instances__&&e(this.el.__ractive_instances__,this),this.shouldDestroy=!0,i=this.rendered?this.unrender():n.resolve(),r&&i.then(r.bind(this)),i}}(p,d,g),Eo=function(t){return function(e,n){var r
return"string"!=typeof e&&t.errorOnly({debug:this.debug,messsage:"badArguments",arg:{arguments:e}}),r=this.get(e),this.set(e,!r,n)}}(Xe),_o=function(){return this.fragment.toString(!0)},xo=function(t,e,n,r,i){return function(){var o,s,a=this
...
return this.fragment.unrender(s),this.rendered=!1,t(this.el.__ractive_instances__,this),e.end(),o}}(d,_,Ce,Xe,g),ko=function(t){return t("unshift")}(Ae),So=function(t,e){return function(n,r){var i
return"function"==typeof n?(r=n,n=""):n=n||"",i=e.start(this,!0),this.viewmodel.mark(n),e.end(),t(this,"update",{args:[n]}),r&&i.then(r.bind(this)),i}}(p,_),To=function(t,e){function n(r,i,o,s){var a,u,c,h,f,l,p=[]
...
return"string"!=typeof t&&(t="",e=!0),n(this,t,r={},e),this.set(r)}}(Ir,y),Oo=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g,v,m,y,b,w,E,_,x,k,S,T,O,A,N,R,C){return{add:t,animate:e,detach:n,find:r,findAll:i,findAllComponents:o,findComponent:s,fire:a,get:u,insert:c,merge:h,observe:f,off:l,on:p,pop:d,push:g,render:v,reset:m,resetTemplate:y,reverse:b,set:w,shift:E,sort:_,splice:x,subtract:k,teardown:S,toggle:T,toHTML:O,unrender:A,unshift:N,update:R,updateModel:C}}(L,Jt,Qt,Xt,ue,ce,he,fe,le,de,ge,Ee,ke,Se,Ne,Re,Le,fo,lo,po,go,vo,mo,yo,bo,wo,Eo,_o,xo,ko,So,To),Ao=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(t){var e,n
return e=16*Math.random()|0,n="x"==t?e:3&e|8,n.toString(16)})},No=function(){var t=0
return function(){return"r-"+t++}}(),Ro=function(t,e,n,r){var i=t.root,o=t.keypath
return"sort"===n||"reverse"===n?void i.viewmodel.set(o,e):void(r&&i.viewmodel.splice(o,r))},Co=function(t,e,n,r,i){var o,s,a,u=[],c=["pop","push","reverse","shift","sort","splice","unshift"]
return c.forEach(function(o){var s=function(){var e,s,a,u,c
for(e=n(this,o,Array.prototype.slice.call(arguments)),s=r(this,e),a=Array.prototype[o].apply(this,arguments),this._ractive.setting=!0,c=this._ractive.wrappers.length;c--;)u=this._ractive.wrappers[c],t.start(u.root),i(u,this,o,s),t.end()
return this._ractive.setting=!1,a}
e(u,o,{value:s})}),o={},o.__proto__?(s=function(t){t.__proto__=u},a=function(t){t.__proto__=Array.prototype}):(s=function(t){var n,r
for(n=c.length;n--;)r=c[n],e(t,r,{value:u[r],configurable:!0})},a=function(t){var e
for(e=c.length;e--;)delete t[c[e]]}),s.unpatch=a,s}(_,N,Te,Oe,Ro),Lo=function(t,e,n){var r,i,o
return r={filter:function(t){return e(t)&&(!t._ractive||!t._ractive.setting)},wrap:function(t,e,n){return new i(t,e,n)}},i=function(e,r,i){this.root=e,this.value=r,this.keypath=i,r._ractive||(t(r,"_ractive",{value:{wrappers:[],instances:[],setting:!1},configurable:!0}),n(r)),r._ractive.instances[e._guid]||(r._ractive.instances[e._guid]=0,r._ractive.instances.push(e)),r._ractive.instances[e._guid]+=1,r._ractive.wrappers.push(this)},i.prototype={get:function(){return this.value},teardown:function(){var t,e,r,i,s
if(t=this.value,e=t._ractive,r=e.wrappers,i=e.instances,e.setting)return!1
if(s=r.indexOf(this),-1===s)throw new Error(o)
if(r.splice(s,1),r.length){if(i[this.root._guid]-=1,!i[this.root._guid]){if(s=i.indexOf(this.root),-1===s)throw new Error(o)
i.splice(s,1)}}else delete t._ractive,n.unpatch(this.value)}},o="Something went wrong in a rather interesting way",r}(N,a,Co),Io=function(t,e){var n,r
return t&&(n={filter:function(n,r,i){return t.filter(n,r,i)&&e.filter(n)},wrap:function(t,e,n){return new r(t,e,n)}},r=function(n,r,i){this.value=r,this.magic=!0,this.magicWrapper=t.wrap(n,r,i),this.arrayWrapper=e.wrap(n,r,i)},r.prototype={get:function(){return this.value},teardown:function(){this.arrayWrapper.teardown(),this.magicWrapper.teardown()},reset:function(t){return this.magicWrapper.reset(t)}}),n}(k,Lo),jo=function(t,e,n,r){function i(t,e){var n,r={}
if(!e)return t
e+="."
for(n in t)t.hasOwnProperty(n)&&(r[e+n]=t[n])
return r}function o(t){var e
...
c=f.adapt[u]=l}if(c.filter(s,i,f))return h=this.wrapped[i]=c.wrap(f,s,i,o(i)),h.value=s,s}return f.magic?r.filter(s,i,f)?this.wrapped[i]=r.wrap(f,s,i):n.filter(s,i,f)&&(this.wrapped[i]=n.wrap(f,s,i)):f.modifyArrays&&e.filter(s,i,f)&&(this.wrapped[i]=e.wrap(f,s,i)),s}}(Ht,Lo,k,Io),Po=function(t){var e,n,r,i,o=[""]
for(e=t.length;e--;)for(n=t[e],r=n.split(".");r.length>1;)r.pop(),i=r.join("."),-1===o.indexOf(i)&&o.push(i)
return o},Mo=function(){function t(t){var e,r,i,o,s,a=""
if(!n[t]){for(i=[];a.length<t;)a+=1
for(e=parseInt(a,2),o=function(t){return"1"===t},s=0;e>=s;s+=1){for(r=s.toString(2);r.length<t;)r="0"+r
i[s]=Array.prototype.map.call(r,o)}n[t]=i}return n[t]}var e,n={}
return e=function(e){var n,r,i,o
return n=e.split("."),r=t(n.length),i=function(t,e){return t?"*":n[e]},o=r.map(function(t){return t.map(i).join(".")})}}(),Fo=function(t){function e(e,i,o){var s
...
return i=e}(Mo),Bo=function(t,e){function n(t){t.update()}function r(t,e,n){var r,i;(r=o(t,e,n))&&(i=t.get(e),r.forEach(function(t){return t.setValue(i)}))}function i(t,e,n){function r(t){t.forEach(i),t.forEach(s)}function i(e){var r=o(t,e,n)
...
return a=t(d),this.patternObservers.length&&(a.forEach(function(t){return e(l,t,!0)}),d.forEach(function(t){return e(l,t)})),u.forEach(function(t){l.deps[t]&&(a.forEach(function(e){return r(l,e,t)}),i(l,d,t))}),d.forEach(function(t){g[t]=l.get(t)}),this.implicitChanges={},g}}}(Po,Fo),Do=function(){this.capturing=!0,this.captured=[]},Uo=function(t,e){var n,r,i
if(e||(r=this.wrapped[t])&&r.teardown()!==!1&&(this.wrapped[t]=null),(i=this.computations[t])&&i.compute(),this.cache[t]=void 0,n=this.cacheMap[t])for(;n.length;)this.clearCache(n.pop())},Vo={FAILED_LOOKUP:!0},qo=function(t,e){var n={},r=function(t,r){this.viewmodel=t,this.root=t.ractive,this.ref=r,this.parentFragment=n,t.unresolvedImplicitDependencies[r]=!0,t.unresolvedImplicitDependencies.push(this),e.addUnresolved(this)}
return r.prototype={resolve:function(){this.viewmodel.mark(this.ref),this.viewmodel.unresolvedImplicitDependencies[this.ref]=!1,t(this.viewmodel.unresolvedImplicitDependencies,this)},teardown:function(){e.removeUnresolved(this)}},r}(d,_),Wo=function(t,e){function n(e,n){var r,i,o,s,a,u,c
...
return void 0===f[r]?((a=this.computations[r])?s=a.value:(u=this.wrapped[r])?s=u.value:r?s=(c=this.evaluators[r])?c.value:n(this,r):(this.adapt("",h.data),s=h.data),f[r]=s):s=f[r],o.evaluateWrapped&&(u=this.wrapped[r])&&(s=u.get()),o.capture&&this.capturing&&-1===this.captured.indexOf(r)&&(this.captured.push(r),s===t&&this.unresolvedImplicitDependencies[r]!==!0&&new e(this,r)),s===t?void 0:s}}(Vo,qo),zo=function(t,e){e&&(this.implicitChanges[t]=!0),-1===this.changes.indexOf(t)&&(this.changes.push(t),this.clearCache(t))},Ko=function(t,e){var n,r,i,o
return n={},r=0,i=t.map(function(t,i){var s,a,u
a=r,u=e.length
do{if(s=e.indexOf(t,a),-1===s)return o=!0,-1
a=s+1}while(n[s]&&u>a)
return s===r&&(r+=1),s!==i&&(o=!0),n[s]=!0,s}),i.unchanged=!o,i},$o=function(t,e,n){function r(e){return"function"==typeof e.merge&&(!e.subtype||e.subtype===t.SECTION_EACH)}function i(t){return JSON.stringify(t)}function o(t){if(t===!0)return i
...
f=n(u,c),f.forEach(function(e,n){-1===e&&p.mark(t+"."+n)}),this.set(t,s,!0),(l=this.deps["default"][t])&&l.filter(r).forEach(function(t){return t.merge(f)}),i.length!==s.length&&this.mark(t+".length",!0)}}(z,B,Ko),Ho=function(){function t(t,e,n){var r,i,o,s
...
void 0===r&&(r="default")
var i,o,s
n.isStatic||(i=this.deps[r]||(this.deps[r]={}),o=i[e]||(i[e]=[]),o.push(n),e&&((s=this.evaluators[e])&&(s.dependants||s.wake(),s.dependants+=1),t(this,e,r)))}}(),Go=function(){return this.capturing=!1,this.captured},Yo=function(t,e){return function(n,r,i){var o,s,a,u,c,h,f,l
c=this.computations[n],c&&!c.setting&&(c.set(r),r=c.get()),t(this.cache[n],r)||(h=this.wrapped[n],f=this.evaluators[n],h&&h.reset&&(l=h.reset(r)!==!1,l&&(r=h.get())),f&&(f.value=r),c||f||l||(o=n.split("."),s=o.pop(),a=o.join("."),h=this.wrapped[a],h&&h.set?h.set(s,r):(u=h?h.get():this.get(a),u||(u=e(s),this.set(a,u,!0)),u[s]=r)),i?this.clearCache(n):this.mark(n))}}(y,x),Jo=function(t){function e(e){return e.type===t.SECTION&&(!e.subtype||e.subtype===t.SECTION_EACH)&&e.rendered}var n
return n=function(t,n){var r,i,o=this
for(r=n.rangeStart;r<n.rangeEnd;r+=1)o.mark(t+"."+r)
n.balance&&o.mark(t+".length",!0),(i=o.deps["default"][t])&&i.filter(e).forEach(function(t){return t.splice(n)})}}(z),Qo=function(){var t,e=this
for(Object.keys(this.cache).forEach(function(t){return e.clearCache(t)});t=this.unresolvedImplicitDependencies.pop();)t.teardown()},Xo=function(){function t(t,e,n){var r,i,o,s
...
i.splice(o,1),e&&((s=this.evaluators[e])&&(s.dependants-=1,s.dependants||s.sleep()),t(this,e,r))}}}(),Zo=function(){function t(t){var e="var __ractive=this;return("+t.replace(n,function(t,e){return'__ractive.get("'+e+'")'})+")"
...
this.compute()&&!e(this.value,t)&&this.ractive.viewmodel.mark(this.key)}},r}(Xe,y,tn),es=function(t,e){return function(n,r){var i,o
for(i in r)o=t(r[i]),n.viewmodel.computations[i]=new e(n,i,o)}}(Zo,ts),ns=function(){function t(t){return"string"==typeof t&&(t=[t]),t}var e={lookup:function(t,e){var n,r=t.adapt
...
return e}(),rs=function(t,e,n,r,i,o,s,a,u,c,h,f,l,p,d,g){var v
...
void 0===n&&(n={}),a(e,n),t.init(e.constructor,e,n),e.viewmodel=new i(e),e.viewmodel.compute(),e.template&&(e.fragment=new o({template:e.template,root:e,owner:e})),s(e)}}(Ht,K,pe,No,rs,ho),os=function(t){return function(e,n,r){e.beforeInit&&e.beforeInit(r),t(e,r)}}(is),ss=function(t,e,n,r){function i(e,n,r){for(var i in r)if(!(i in c)&&r.hasOwnProperty(i)){var o=r[i]
...
return p}(r,i,h,f,S,R,Oo,g,xr,as,Ft,is,o)
"undefined"!=typeof e&&e.exports?e.exports=us:"function"==typeof define&&define.amd&&define(function(){return us}),t.Ractive=us,us.noConflict=function(){return t.Ractive=n,us}}("undefined"!=typeof window?window:this)},{}],85:[function(t,e,n){},{}],86:[function(t,e,n){function r(t,e,n){if(!(this instanceof r))return new r(t,e,n)
var i,o=typeof t
...
return i}function c(t,e,n,r){var i=C(N(e),t,n,r,2)
...
return i}function R(t){return I.toByteArray(t)}function C(t,e,n,r,i){i&&(r-=r%i)
for(var o=0;r>o&&!(o+n>=e.length||o>=t.length);o++)e[o+n]=t[o]
return o}function L(t){try{return decodeURIComponent(t)}catch(e){return String.fromCharCode(65533)}}var I=t("base64-js"),j=t("ieee754"),P=t("is-array")
...
if(e>>>=0,n=void 0===n||n===1/0?this.length:n>>>0,t||(t="utf8"),0>e&&(e=0),n>this.length&&(n=this.length),e>=n)return""
...
var s=i-n
if(1e3>s||!r.TYPED_ARRAY_SUPPORT)for(var a=0;s>a;a++)t[a+e]=this[a+n]
...
var F=r.prototype
r._augment=function(t){return t.constructor=r,t._isBuffer=!0,t._get=t.get,t._set=t.set,t.get=F.get,t.set=F.set,t.write=F.write,t.toString=F.toString,t.toLocaleString=F.toString,t.toJSON=F.toJSON,t.equals=F.equals,t.compare=F.compare,t.copy=F.copy,t.slice=F.slice,t.readUInt8=F.readUInt8,t.readUInt16LE=F.readUInt16LE,t.readUInt16BE=F.readUInt16BE,t.readUInt32LE=F.readUInt32LE,t.readUInt32BE=F.readUInt32BE,t.readInt8=F.readInt8,t.readInt16LE=F.readInt16LE,t.readInt16BE=F.readInt16BE,t.readInt32LE=F.readInt32LE,t.readInt32BE=F.readInt32BE,t.readFloatLE=F.readFloatLE,t.readFloatBE=F.readFloatBE,t.readDoubleLE=F.readDoubleLE,t.readDoubleBE=F.readDoubleBE,t.writeUInt8=F.writeUInt8,t.writeUInt16LE=F.writeUInt16LE,t.writeUInt16BE=F.writeUInt16BE,t.writeUInt32LE=F.writeUInt32LE,t.writeUInt32BE=F.writeUInt32BE,t.writeInt8=F.writeInt8,t.writeInt16LE=F.writeInt16LE,t.writeInt16BE=F.writeInt16BE,t.writeInt32LE=F.writeInt32LE,t.writeInt32BE=F.writeInt32BE,t.writeFloatLE=F.writeFloatLE,t.writeFloatBE=F.writeFloatBE,t.writeDoubleLE=F.writeDoubleLE,t.writeDoubleBE=F.writeDoubleBE,t.fill=F.fill,t.inspect=F.inspect,t.toArrayBuffer=F.toArrayBuffer,t}
...
else{if(o===u)return s?0/0:(p?-1:1)*(1/0)
...
for(e=Math.abs(e),isNaN(e)||e===1/0?(a=isNaN(e)?1:0,s=h):(s=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-s))<1&&(s--,u*=2),e+=s+f>=1?l/u:l*Math.pow(2,1-f),e*u>=2&&(s++,u/=2),s+f>=h?(a=0,s=h):s+f>=1?(a=(e*u-1)*Math.pow(2,i),s+=f):(a=e*Math.pow(2,f-1)*Math.pow(2,i),s=0));i>=8;t[n+p]=255&a,p+=d,a/=256,i-=8);for(s=s<<i|a,c+=i;c>0;t[n+p]=255&s,p+=d,s/=256,c-=8);t[n+p-d]|=128*g}},{}],89:[function(t,e,n){var r=Array.isArray,i=Object.prototype.toString
e.exports=r||function(t){return!!t&&"[object Array]"==i.call(t)}},{}],90:[function(t,e,n){function r(){this._events=this._events||{},this._maxListeners=this._maxListeners||void 0}function i(t){return"function"==typeof t}function o(t){return"number"==typeof t}function s(t){return"object"==typeof t&&null!==t}function a(t){return void 0===t}e.exports=r,r.EventEmitter=r,r.prototype._events=void 0,r.prototype._maxListeners=void 0,r.defaultMaxListeners=10,r.prototype.setMaxListeners=function(t){if(!o(t)||0>t||isNaN(t))throw TypeError("n must be a positive number")
...
for(c=n.slice(),r=c.length,u=0;r>u;u++)c[u].apply(this,o)}return!0},r.prototype.addListener=function(t,e){var n
if(!i(e))throw TypeError("listener must be a function")
if(this._events||(this._events={}),this._events.newListener&&this.emit("newListener",t,i(e.listener)?e.listener:e),this._events[t]?s(this._events[t])?this._events[t].push(e):this._events[t]=[this._events[t],e]:this._events[t]=e,s(this._events[t])&&!this._events[t].warned){var n
n=a(this._maxListeners)?r.defaultMaxListeners:this._maxListeners,n&&n>0&&this._events[t].length>n&&(this._events[t].warned=!0,console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.",this._events[t].length),"function"==typeof console.trace&&console.trace())}return this},r.prototype.on=r.prototype.addListener,r.prototype.once=function(t,e){function n(){this.removeListener(t,n),r||(r=!0,e.apply(this,arguments))}if(!i(e))throw TypeError("listener must be a function")
var r=!1
...
return e=this._events&&this._events[t]?i(this._events[t])?[this._events[t]]:this._events[t].slice():[]},r.listenerCount=function(t,e){var n
return n=t._events&&t._events[e]?i(t._events[e])?1:t._events[e].length:0}},{}],91:[function(t,e,n){var r=e.exports,i=(t("events").EventEmitter,t("./lib/request")),o=t("url")
...
var n=new i(new s,t)
return e&&n.on("response",e),n},r.get=function(t,e){t.method="GET"
var n=r.request(t,e)
return n.end(),n},r.Agent=function(){},r.Agent.defaultMaxSockets=4
var s=function(){if("undefined"==typeof window)throw new Error("no window object present")
...
r.STATUS_CODES={100:"Continue",101:"Switching Protocols",102:"Processing",200:"OK",201:"Created",202:"Accepted",203:"Non-Authoritative Information",204:"No Content",205:"Reset Content",206:"Partial Content",207:"Multi-Status",300:"Multiple Choices",301:"Moved Permanently",302:"Moved Temporarily",303:"See Other",304:"Not Modified",305:"Use Proxy",307:"Temporary Redirect",400:"Bad Request",401:"Unauthorized",402:"Payment Required",403:"Forbidden",404:"Not Found",405:"Method Not Allowed",406:"Not Acceptable",407:"Proxy Authentication Required",408:"Request Time-out",409:"Conflict",410:"Gone",411:"Length Required",412:"Precondition Failed",413:"Request Entity Too Large",414:"Request-URI Too Large",415:"Unsupported Media Type",416:"Requested Range Not Satisfiable",417:"Expectation Failed",418:"I'm a teapot",422:"Unprocessable Entity",423:"Locked",424:"Failed Dependency",425:"Unordered Collection",426:"Upgrade Required",428:"Precondition Required",429:"Too Many Requests",431:"Request Header Fields Too Large",500:"Internal Server Error",501:"Not Implemented",502:"Bad Gateway",503:"Service Unavailable",504:"Gateway Time-out",505:"HTTP Version Not Supported",506:"Variant Also Negotiates",507:"Insufficient Storage",509:"Bandwidth Limit Exceeded",510:"Not Extended",511:"Network Authentication Required"}},{"./lib/request":92,events:90,url:115}],92:[function(t,e,n){var r=t("stream"),i=t("./response"),o=t("Base64"),s=t("inherits"),a=e.exports=function(t,e){var n=this
...
try{t.withCredentials=e.withCredentials}catch(r){}if(e.responseType)try{t.responseType=e.responseType}catch(r){}if(t.open(e.method||"GET",n.uri,!0),t.onerror=function(t){n.emit("error",new Error("Network error"))},n._headers={},e.headers)for(var s=u(e.headers),a=0;a<s.length;a++){var c=s[a]
if(n.isSafeRequestHeader(c)){var h=e.headers[c]
n.setHeader(c,h)}}e.auth&&this.setHeader("Authorization","Basic "+o.btoa(e.auth))
var f=new i
...
s(a,r),a.prototype.setHeader=function(t,e){this._headers[t.toLowerCase()]=e},a.prototype.getHeader=function(t){return this._headers[t.toLowerCase()]},a.prototype.removeHeader=function(t){delete this._headers[t.toLowerCase()]},a.prototype.write=function(t){this.body.push(t)},a.prototype.destroy=function(t){this.xhr.__aborted=!0,this.xhr.abort(),this.emit("close")},a.prototype.end=function(t){void 0!==t&&this.body.push(t)
for(var e=u(this._headers),n=0;n<e.length;n++){var r=e[n],i=this._headers[r]
...
else if(c(this.body[0])){for(var s=[],n=0;n<this.body.length;n++)s.push.apply(s,this.body[n])
this.xhr.send(s)}else if(/Array/.test(Object.prototype.toString.call(this.body[0]))){for(var a=0,n=0;n<this.body.length;n++)a+=this.body[n].length
for(var s=new this.body[0].constructor(a),h=0,n=0;n<this.body.length;n++)for(var l=this.body[n],o=0;o<l.length;o++)s[h++]=l[o]
...
this.xhr.send(s)}},a.unsafeHeaders=["accept-charset","accept-encoding","access-control-request-headers","access-control-request-method","connection","content-length","cookie","cookie2","content-transfer-encoding","date","expect","host","keep-alive","origin","referer","te","trailer","transfer-encoding","upgrade","user-agent","via"],a.prototype.isSafeRequestHeader=function(t){return t?-1===h(a.unsafeHeaders,t.toLowerCase()):!1}
var u=Object.keys||function(t){var e=[]
for(var n in t)e.push(n)
return e},c=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)},h=function(t,e){if(t.indexOf)return t.indexOf(e)
for(var n=0;n<t.length;n++)if(t[n]===e)return n
return-1},f=function(t){return"undefined"!=typeof Blob&&t instanceof Blob?!0:"undefined"!=typeof ArrayBuffer&&t instanceof ArrayBuffer?!0:"undefined"!=typeof FormData&&t instanceof FormData?!0:void 0}},{"./response":93,Base64:94,inherits:95,stream:114}],93:[function(t,e,n){function r(t){for(var e=t.getAllResponseHeaders().split(/\r?\n/),n={},r=0;r<e.length;r++){var i=e[r]
if(""!==i){var o=i.match(/^([^:]+):\s*(.*)/)
if(o){var s=o[1].toLowerCase(),a=o[2]
void 0!==n[s]?u(n[s])?n[s].push(a):n[s]=[n[s],a]:n[s]=a}else n[i]=!0}}return n}var i=t("stream"),o=t("util"),s=e.exports=function(t){this.offset=0,this.readable=!0}
o.inherits(s,i)
var a={streaming:!0,status2:!0}
s.prototype.getResponse=function(t){var e=String(t.responseType).toLowerCase()
return"blob"===e?t.responseBlob||t.response:"arraybuffer"===e?t.response:t.responseText},s.prototype.getHeader=function(t){return this.headers[t.toLowerCase()]},s.prototype.handle=function(t){if(2===t.readyState&&a.status2){try{this.statusCode=t.status,this.headers=r(t)}catch(e){a.status2=!1}a.status2&&this.emit("ready")}else if(a.streaming&&3===t.readyState){try{this.statusCode||(this.statusCode=t.status,this.headers=r(t),this.emit("ready"))}catch(e){}try{this._emitData(t)}catch(e){a.streaming=!1}}else 4===t.readyState&&(this.statusCode||(this.statusCode=t.status,this.emit("ready")),this._emitData(t),t.error?this.emit("error",this.getResponse(t)):this.emit("end"),this.emit("close"))},s.prototype._emitData=function(t){var e=this.getResponse(t)
...
var u=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)}},{stream:114,util:117}],94:[function(t,e,n){!function(){function t(t){this.message=t}var e="undefined"!=typeof n?n:this,r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
...
return a})}()},{}],95:[function(t,e,n){e.exports=t(44)},{}],96:[function(t,e,n){function r(){}var i=e.exports={}
i.nextTick=function(){var t="undefined"!=typeof window&&window.setImmediate,e="undefined"!=typeof window&&window.postMessage&&window.addEventListener
...
else r.punycode=b}(this)}).call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],98:[function(t,e,n){"use strict"
function r(t,e){return Object.prototype.hasOwnProperty.call(t,e)}e.exports=function(t,e,n,o){e=e||"&",n=n||"="
var s={}
...
var c=t.length
u>0&&c>u&&(c=u)
for(var h=0;c>h;++h){var f,l,p,d,g=t[h].replace(a,"%20"),v=g.indexOf(n)
v>=0?(f=g.substr(0,v),l=g.substr(v+1)):(f=g,l=""),p=decodeURIComponent(f),d=decodeURIComponent(l),r(s,p)?i(s[p])?s[p].push(d):s[p]=[s[p],d]:s[p]=d}return s}
var i=Array.isArray||function(t){return"[object Array]"===Object.prototype.toString.call(t)}},{}],99:[function(t,e,n){"use strict"
function r(t,e){if(t.map)return t.map(e)
for(var n=[],r=0;r<t.length;r++)n.push(e(t[r],r))
return n}var i=function(t){switch(typeof t){case"string":return t
case"boolean":return t?"true":"false"
case"number":return isFinite(t)?t:""
default:return""}}
e.exports=function(t,e,n,a){return e=e||"&",n=n||"=",null===t&&(t=void 0),"object"==typeof t?r(s(t),function(s){var a=encodeURIComponent(i(s))+n
return o(t[s])?r(t[s],function(t){return a+encodeURIComponent(i(t))}).join(e):a+encodeURIComponent(i(t[s]))}).join(e):a?encodeURIComponent(i(a))+n+encodeURIComponent(i(t)):""}
...
n.decode=n.parse=t("./decode"),n.encode=n.stringify=t("./encode")},{"./decode":98,"./encode":99}],101:[function(t,e,n){e.exports=t("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":102}],102:[function(t,e,n){e.exports=t(38)},{"./_stream_readable":104,"./_stream_writable":106,Kii323:96,"core-util-is":107,inherits:95}],103:[function(t,e,n){e.exports=t(39)},{"./_stream_transform":105,"core-util-is":107,inherits:95}],104:[function(t,e,n){e.exports=t(40)},{Kii323:96,buffer:86,"core-util-is":107,events:90,inherits:95,isarray:108,stream:114,"string_decoder/":109}],105:[function(t,e,n){e.exports=t(41)},{"./_stream_duplex":102,"core-util-is":107,inherits:95}],106:[function(t,e,n){e.exports=t(42)},{"./_stream_duplex":102,Kii323:96,buffer:86,"core-util-is":107,inherits:95,stream:114}],107:[function(t,e,n){e.exports=t(43)},{buffer:86}],108:[function(t,e,n){e.exports=t(9)},{}],109:[function(t,e,n){e.exports=t(46)},{buffer:86}],110:[function(t,e,n){e.exports=t("./lib/_stream_passthrough.js")},{"./lib/_stream_passthrough.js":103}],111:[function(t,e,n){e.exports=t(47)},{"./lib/_stream_duplex.js":102,"./lib/_stream_passthrough.js":103,"./lib/_stream_readable.js":104,"./lib/_stream_transform.js":105,"./lib/_stream_writable.js":106,stream:114}],112:[function(t,e,n){e.exports=t("./lib/_stream_transform.js")},{"./lib/_stream_transform.js":105}],113:[function(t,e,n){e.exports=t("./lib/_stream_writable.js")},{"./lib/_stream_writable.js":106}],114:[function(t,e,n){function r(){i.call(this)}e.exports=r
var i=t("events").EventEmitter,o=t("inherits")
o(r,i),r.Readable=t("readable-stream/readable.js"),r.Writable=t("readable-stream/writable.js"),r.Duplex=t("readable-stream/duplex.js"),r.Transform=t("readable-stream/transform.js"),r.PassThrough=t("readable-stream/passthrough.js"),r.Stream=r,r.prototype.pipe=function(t,e){function n(e){t.writable&&!1===t.write(e)&&c.pause&&c.pause()}function r(){c.readable&&c.resume&&c.resume()}function o(){h||(h=!0,t.end())}function s(){h||(h=!0,"function"==typeof t.destroy&&t.destroy())}function a(t){if(u(),0===i.listenerCount(this,"error"))throw t}function u(){c.removeListener("data",n),t.removeListener("drain",r),c.removeListener("end",o),c.removeListener("close",s),c.removeListener("error",a),t.removeListener("error",a),c.removeListener("end",u),c.removeListener("close",u),t.removeListener("close",u)}var c=this
c.on("data",n),t.on("drain",r),t._isStdio||e&&e.end===!1||(c.on("end",o),c.on("close",s))
var h=!1
...
return n?"["+i.colors[n][0]+"m"+t+"["+i.colors[n][1]+"m":t}function s(t,e){return t}function a(t){var e={}
return t.forEach(function(t,n){e[t]=!0}),e}function u(t,e,r){if(t.customInspect&&e&&T(e.inspect)&&e.inspect!==n.inspect&&(!e.constructor||e.constructor.prototype!==e)){var i=e.inspect(r,t)
...
return t}}).call(this,t("Kii323"),"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./support/isBuffer":116,Kii323:96,inherits:95}]},{},[2])
